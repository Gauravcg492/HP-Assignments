...
template<class TPMGL(T)> class x10_xrx_FinishState__CollectingFinish__closure__23 : public ::x10::lang::Closure {
    ...
    ::x10::xrx::FinishState__RemoteCollectingFinish<TPMGL(T)>* __apply(){
        return ::x10::xrx::FinishState__RemoteCollectingFinish<TPMGL(T)>::_make(_ref,
                                                                                tmpReducer);
...
template<class TPMGL(T)> void x10::xrx::FinishState__CollectingFinish<TPMGL(T)>::_constructor(
    ...
    (this)->::x10::xrx::FinishState__Finish::_constructor(reinterpret_cast< ::x10::xrx::FinishState__RootFinish*>(::x10::xrx::FinishState__RootCollectingFinish<TPMGL(T)>::_make(reducer)));
    
    //#line 1010 "x10/xrx/FinishState.x10"
    
    //#line 1008 "x10/xrx/FinishState.x10"
    this->x10::xrx::template FinishState__CollectingFinish<TPMGL(T)>::__fieldInitializers_x10_xrx_FinishState_CollectingFinish();
...
template<class TPMGL(T)> void x10::xrx::FinishState__CollectingFinish<TPMGL(T)>::_constructor(
                                 ...
                                 ((x10_long)::x10aux::here))))
    {
        ...
        this->FMGL(me) = ((__extension__ ({
            ::x10::lang::GlobalRef< ::x10::xrx::FinishState* > t__151123 =
              this->FMGL(ref);
            if (!((::x10aux::struct_equals(::x10::lang::Place::_make((t__151123)->location),
                                           ::x10::lang::Place::_make(::x10aux::here)))))
            {
                ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::xrx::FinishState__CollectingFinish_Strings::sl__161681))));
            }
            t__151123;
        }))
        )->__apply();
