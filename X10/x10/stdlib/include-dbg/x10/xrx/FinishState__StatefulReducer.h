...
template<class TPMGL(T)> void x10::xrx::FinishState__StatefulReducer<TPMGL(T)>::_constructor(
    ...
    x10_long i__151200min__151225 = ((x10_long)0ll);
    x10_long i__151200max__151226 = (((x10_long)(::x10aux::nullCheck(this->FMGL(resultRail))->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__151227;
        for (i__151227 = i__151200min__151225; ((i__151227) <= (i__151200max__151226));
             i__151227 = ((i__151227) + (((x10_long)1ll))))
        {
            x10_long i__151228 = i__151227;
