...
template<class TPMGL(T)> void x10::compiler::ws::CollectingFinish<TPMGL(T)>::_constructor(
    ...
    this->x10::compiler::ws::template CollectingFinish<TPMGL(T)>::__fieldInitializers_x10_compiler_ws_CollectingFinish();
...
template<class TPMGL(T)> ::x10::compiler::ws::Frame* x10::compiler::ws::CollectingFinish<TPMGL(T)>::realloc(
                                  ...
                                  this->FMGL(exceptions))))
    {
        ...
        ::x10aux::nullCheck(tmp)->FMGL(exceptions) = ::x10::util::GrowableRail< ::x10::lang::CheckedThrowable*>::_make();
        ...
        while (!(::x10aux::nullCheck(this->FMGL(exceptions))->x10::util::template GrowableRail< ::x10::lang::CheckedThrowable*>::isEmpty()))
        {
    ...
    }
    {
        ...
        ::x10::lang::CheckedThrowable* throwable__100902 =
        ...
        catch (::x10::lang::CheckedThrowable* __exc387) {
            {
                ::x10::lang::CheckedThrowable* formal__100903 =
                  __exc387;
                {
                    throwable__100902 = formal__100903;
                }
            }
        }
        if ((!::x10aux::struct_equals(throwable__100902, reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
        {
            if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__100902))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__100902));
            }
        ...
        if ((!::x10aux::struct_equals(throwable__100902, reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
        {
            if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__100902)))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__100902));
            }
