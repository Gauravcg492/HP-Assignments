...
template<class TPMGL(T)> class x10_compiler_Foreach__closure__6 : public ::x10::lang::Closure {
    ...
    TPMGL(T) __apply(x10_long start, x10_long end){
        ...
        x10_long i__100417min__100654 = start;
        x10_long i__100417max__100655 = end;
        {
            x10_long i__100656;
            for (i__100656 = i__100417min__100654; ((i__100656) <= (i__100417max__100655));
                 i__100656 = ((i__100656) + (((x10_long)1ll)))) {
                x10_long i__100657 = i__100656;
...
template<class TPMGL(T)> class x10_compiler_Foreach__closure__10 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        TPMGL(T) myRes__100667 = identity;
        
        //#line 408 "x10/compiler/Foreach.x10"
        {
            x10_long i__100668;
            for (i__100668 = ((min) + (t__100672)); ((i__100668) <= (max));
                 i__100668 = ((i__100668) + (((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)())))))
            {
                
                //#line 409 "x10/compiler/Foreach.x10"
                myRes__100667 = ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>::__apply(::x10aux::nullCheck(reduce), 
                  myRes__100667, ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>::__apply(::x10aux::nullCheck(body), 
                    i__100668));
            }
        }
    ...
    static x10::lang::Reference* _deserialize(::x10aux::deserialization_buffer &buf) {
        ...
        TPMGL(T) that_identity = buf.read<TPMGL(T)>();
        x10_long that_min = buf.read<x10_long>();
        x10_long that_t__100672 = buf.read<x10_long>();
        x10_long that_max = buf.read<x10_long>();
        ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>* that_body = buf.read< ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>*>();
        ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* that_reduce = buf.read< ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>*>();
        ::x10::lang::Rail< TPMGL(T) >* that_results = buf.read< ::x10::lang::Rail< TPMGL(T) >*>();
        x10_compiler_Foreach__closure__10<TPMGL(T) >* this_ = new (storage) x10_compiler_Foreach__closure__10<TPMGL(T) >(that_identity, that_min, that_t__100672, that_max, that_body, that_reduce, that_results);
        return this_;
    }
    
    x10_compiler_Foreach__closure__10(TPMGL(T) identity, x10_long min, x10_long t__100672, x10_long max, ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>* body, ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* reduce, ::x10::lang::Rail< TPMGL(T) >* results) : identity(identity), min(min), t__100672(t__100672), max(max), body(body), reduce(reduce), results(results) { }
...
template<class TPMGL(T)> class x10_compiler_Foreach__closure__13 : public ::x10::lang::Closure {
    ...
    TPMGL(T) __apply(x10_long start, x10_long end){
        ...
        x10_long i__100525min__100681 = start;
        x10_long i__100525max__100682 = end;
        {
            x10_long i__100683;
            for (i__100683 = i__100525min__100681; ((i__100683) <= (i__100525max__100682));
                 i__100683 = ((i__100683) + (((x10_long)1ll)))) {
                x10_long i__100684 = i__100683;
...
template<class TPMGL(T)> class x10_compiler_Foreach__closure__18 : public ::x10::lang::Closure {
    ...
    TPMGL(T) __apply(x10_long min0, x10_long max0, x10_long min1, x10_long max1){
        ...
        x10_long i__100597min__100697 = min0;
        x10_long i__100597max__100698 = max0;
        {
            x10_long i__100699;
            for (i__100699 = i__100597min__100697; ((i__100699) <= (i__100597max__100698));
                 i__100699 = ((i__100699) + (((x10_long)1ll)))) {
                x10_long i__100700 = i__100699;
                
                //#line 755 "x10/compiler/Foreach.x10"
                x10_long i__100579min__100693 = min1;
                x10_long i__100579max__100694 = max1;
                {
                    x10_long i__100695;
                    for (i__100695 = i__100579min__100693; ((i__100695) <= (i__100579max__100694));
                         i__100695 = ((i__100695) + (((x10_long)1ll))))
                    {
                        x10_long j__100696 = i__100695;
...
template<class TPMGL(T)> TPMGL(T) x10::compiler::Foreach::sequentialReduce(
  ...
  ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* reduce, TPMGL(T) identity) {
    ...
    x10_long i__100291min__100626 = min;
    x10_long i__100291max__100627 = max;
    {
        x10_long i__100628;
        for (i__100628 = i__100291min__100626; ((i__100628) <= (i__100291max__100627));
             i__100628 = ((i__100628) + (((x10_long)1ll)))) {
            x10_long i__100629 = i__100628;
...
template<class TPMGL(T)> TPMGL(T) x10::compiler::Foreach::sequentialReduce(
  ...
  TPMGL(T) identity) {
    ...
    x10_long i__100327min__100634 = ::x10aux::nullCheck(space)->FMGL(min0);
    x10_long i__100327max__100635 = ::x10aux::nullCheck(space)->FMGL(max0);
    {
        x10_long i__100636;
        for (i__100636 = i__100327min__100634; ((i__100636) <= (i__100327max__100635));
             i__100636 = ((i__100636) + (((x10_long)1ll))))
        {
            x10_long i__100637 = i__100636;
            
            //#line 141 "x10/compiler/Foreach.x10"
            x10_long i__100309min__100630 = ::x10aux::nullCheck(space)->FMGL(min1);
            x10_long i__100309max__100631 = ::x10aux::nullCheck(space)->FMGL(max1);
            {
                x10_long i__100632;
                for (i__100632 = i__100309min__100630; ((i__100632) <= (i__100309max__100631));
                     i__100632 = ((i__100632) + (((x10_long)1ll))))
                {
                    x10_long j__100633 = i__100632;
  ...
  ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* reduce) {
    ...
    if ((::x10aux::struct_equals(nthreads, ((x10_int)1))))
    {
        ...
        ::x10::lang::Rail< TPMGL(T) >* results = ::x10::lang::Rail< TPMGL(T) >::_makeUnsafe(((x10_long)(nthreads)), false);
        {
            ...
            ::x10::xrx::FinishState* fs__100719 = ::x10::xrx::Runtime::startFinish();
            try {
                {
                    {
                        x10_long t;
                ...
                {
                    ::x10::lang::CheckedThrowable* ct__100717 =
                      __exc320;
                    {
            ...
            ::x10::xrx::Runtime::stopFinish(fs__100719);
        }
        ...
        x10_long i__100399min__100650 = ((x10_long)1ll);
        x10_long i__100399max__100651 = ((((x10_long)(nthreads))) - (((x10_long)1ll)));
        {
            x10_long i__100652;
            for (i__100652 = i__100399min__100650; ((i__100652) <= (i__100399max__100651));
                 i__100652 = ((i__100652) + (((x10_long)1ll))))
            {
                x10_long myT__100653 = i__100652;
  ...
  TPMGL(T) identity) {
    ...
    if ((::x10aux::struct_equals(::x10::xrx::Runtime::FMGL(NTHREADS__get)(),
        ...
        ::x10::lang::Rail< TPMGL(T) >* results = ::x10::lang::Rail< TPMGL(T) >::_makeUnsafe(((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)())), false);
        {
            ...
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__100729 = ::x10::xrx::Runtime::startFinish();
            try {
                {
                    {
                        x10_long t;
                ...
                {
                    ::x10::lang::CheckedThrowable* ct__100727 =
                      __exc326;
                    {
                        ::x10::xrx::Runtime::pushException(
                          ct__100727);
            ...
            ::x10::xrx::Runtime::stopFinish(fs__100729);
        }
        ...
        x10_long i__100435min__100658 = ((x10_long)1ll);
        x10_long i__100435max__100659 = ((((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)()))) - (((x10_long)1ll)));
        {
            x10_long i__100660;
            for (i__100660 = i__100435min__100658; ((i__100660) <= (i__100435max__100659));
                 i__100660 = ((i__100660) + (((x10_long)1ll))))
            {
                x10_long myT__100661 = i__100660;
  ...
  TPMGL(T) identity) {
    ...
    if ((::x10aux::struct_equals(::x10::xrx::Runtime::FMGL(NTHREADS__get)(),
        ...
        ::x10::lang::Rail< TPMGL(T) >* results = ::x10::lang::Rail< TPMGL(T) >::_makeUnsafe(((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)())), false);
        {
            ...
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__100739 = ::x10::xrx::Runtime::startFinish();
            try {
                {
                    x10_long i__100471min__100669 = ((x10_long)0ll);
                    x10_long i__100471max__100670 = ((((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)()))) - (((x10_long)1ll)));
                    {
                        x10_long i__100671;
                        for (i__100671 = i__100471min__100669;
                             ((i__100671) <= (i__100471max__100670));
                             i__100671 = ((i__100671) + (((x10_long)1ll))))
                        {
                            x10_long t__100672 = i__100671;
                            ::x10::xrx::Runtime::runAsync(
                              reinterpret_cast< ::x10::lang::VoidFun_0_0*>((new (::x10aux::alloc< ::x10::lang::VoidFun_0_0>(sizeof(x10_compiler_Foreach__closure__10<TPMGL(T)>)))x10_compiler_Foreach__closure__10<TPMGL(T)>(identity, min, t__100672, max, body, reduce, results))));
                        }
                    }
                ...
                {
                    ::x10::lang::CheckedThrowable* ct__100737 =
                      __exc330;
                    {
                        ::x10::xrx::Runtime::pushException(
                          ct__100737);
            ...
            ::x10::xrx::Runtime::stopFinish(fs__100739);
        }
        ...
        x10_long i__100489min__100673 = ((x10_long)1ll);
        x10_long i__100489max__100674 = ((((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)()))) - (((x10_long)1ll)));
        {
            x10_long i__100675;
            for (i__100675 = i__100489min__100673; ((i__100675) <= (i__100489max__100674));
                 i__100675 = ((i__100675) + (((x10_long)1ll))))
            {
                x10_long myT__100676 = i__100675;
  ...
  ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* reduce) {
    ...
    if (((((end) - (start))) > (grainSize))) {
        ...
        TPMGL(T) syncResult;
        {
            ...
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__100753 = ::x10::xrx::Runtime::startFinish();
            try {
                {
                ...
                {
                    ::x10::lang::CheckedThrowable* ct__100751 =
                      __exc343;
                    {
                        ::x10::xrx::Runtime::pushException(
                          ct__100751);
            ...
            ::x10::xrx::Runtime::stopFinish(fs__100753);
        }
  ...
  ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* reduce) {
                                      ...
                                      ((((e1) - (s1))) <= (g2))))))
    {
        ...
        TPMGL(T) syncResult;
        {
            ...
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__100764 = ::x10::xrx::Runtime::startFinish();
            try {
                {
                ...
                {
                    ::x10::lang::CheckedThrowable* ct__100762 =
                      __exc354;
                    {
                        ::x10::xrx::Runtime::pushException(
                          ct__100762);
            ...
            ::x10::xrx::Runtime::stopFinish(fs__100764);
        }
    ...
    if (((((e1) - (s1))) > (g2))) {
        ...
        TPMGL(T) syncResult;
        {
            ...
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__100769 = ::x10::xrx::Runtime::startFinish();
            try {
                {
                ...
                {
                    ::x10::lang::CheckedThrowable* ct__100767 =
                      __exc355;
                    {
                        ::x10::xrx::Runtime::pushException(
                          ct__100767);
            ...
            ::x10::xrx::Runtime::stopFinish(fs__100769);
        }
