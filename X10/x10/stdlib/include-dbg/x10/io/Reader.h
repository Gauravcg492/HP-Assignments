...
#ifndef X10_IO_READER_H_read_773
#define X10_IO_READER_H_read_773
...
#endif // X10_IO_READER_H_read_773
#ifndef X10_IO_READER_H_read_774
#define X10_IO_READER_H_read_774
...
#endif // X10_IO_READER_H_read_774
#ifndef X10_IO_READER_H_read_775
#define X10_IO_READER_H_read_775
template<class TPMGL(T)> void x10::io::Reader::read(::x10::io::Marshal<TPMGL(T)>* m,
                                                    ::x10::lang::Rail< TPMGL(T) >* a,
                                                    x10_long off,
                                                    x10_long len) {
    ...
    //#line 144 "x10/io/Reader.x10"
    {
        ...
        for (i = off; ((i) < (((off) + (len)))); i = ((i) + (((x10_long)1ll))))
        {
            ...
            ::x10aux::nullCheck(a)->x10::lang::template Rail< TPMGL(T) >::__set(
              i, this->template read< TPMGL(T) >(m));
        }
    }
    
}
#endif // X10_IO_READER_H_read_775
