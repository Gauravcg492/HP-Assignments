...
class Reducible__MinReducer_Strings {
  public:
    static ::x10::lang::String sl__155628;
    static ::x10::lang::String sl__155629;
};
...
template<class TPMGL(T)> void x10::lang::Reducible__MinReducer<TPMGL(T)>::_constructor(
    ...
    (*this)->x10::lang::template Reducible__MinReducer<TPMGL(T)>::__fieldInitializers_x10_lang_Reducible_MinReducer();
...
template<class TPMGL(T)> ::x10::lang::String* x10::lang::Reducible__MinReducer<TPMGL(T)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::lang::Reducible__MinReducer_Strings::sl__155628), (&::x10::lang::Reducible__MinReducer_Strings::sl__155629)), (*this)->FMGL(zeroVal));
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MinReducer<TPMGL(T)>::equals(
  ::x10::lang::Any* other) {
    ...
    return (*this)->x10::lang::template Reducible__MinReducer<TPMGL(T)>::equals(
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MinReducer<TPMGL(T)>::_struct_equals(
  ::x10::lang::Any* other) {
    ...
    return (*this)->x10::lang::template Reducible__MinReducer<TPMGL(T)>::_struct_equals(
             ::x10aux::class_cast< ::x10::lang::Reducible__MinReducer<TPMGL(T)> >(other));
