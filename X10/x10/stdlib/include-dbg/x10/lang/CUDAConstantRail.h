...
class CUDAConstantRail_Strings {
  public:
    static ::x10::lang::String sl__155058;
    static ::x10::lang::String sl__155057;
};
...
template<class TPMGL(T)> void x10::lang::CUDAConstantRail<TPMGL(T)>::_constructor(
    ...
    (*this)->x10::lang::template CUDAConstantRail<TPMGL(T)>::__fieldInitializers_x10_lang_CUDAConstantRail();
...
template<class TPMGL(T)> ::x10::lang::String* x10::lang::CUDAConstantRail<TPMGL(T)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::lang::CUDAConstantRail_Strings::sl__155057), (&::x10::lang::CUDAConstantRail_Strings::sl__155058)), (*this)->FMGL(backing));
...
template<class TPMGL(T)> x10_boolean x10::lang::CUDAConstantRail<TPMGL(T)>::equals(
  ::x10::lang::Any* other) {
    ...
    return (*this)->x10::lang::template CUDAConstantRail<TPMGL(T)>::equals(
...
template<class TPMGL(T)> x10_boolean x10::lang::CUDAConstantRail<TPMGL(T)>::_struct_equals(
  ::x10::lang::Any* other) {
    ...
    return (*this)->x10::lang::template CUDAConstantRail<TPMGL(T)>::_struct_equals(
             ::x10aux::class_cast< ::x10::lang::CUDAConstantRail<TPMGL(T)> >(other));
