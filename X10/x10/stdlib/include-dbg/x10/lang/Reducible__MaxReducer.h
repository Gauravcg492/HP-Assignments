...
template<class TPMGL(T)> void x10::lang::Reducible__MaxReducer<TPMGL(T)>::_constructor(
    ...
    (*this)->x10::lang::template Reducible__MaxReducer<TPMGL(T)>::__fieldInitializers_x10_lang_Reducible_MaxReducer();
...
template<class TPMGL(T)> ::x10::lang::String* x10::lang::Reducible__MaxReducer<TPMGL(T)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::lang::Reducible__MaxReducer_Strings::sl__155674), (&::x10::lang::Reducible__MaxReducer_Strings::sl__155675)), (*this)->FMGL(zeroVal));
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MaxReducer<TPMGL(T)>::equals(
  ::x10::lang::Any* other) {
    ...
    return (*this)->x10::lang::template Reducible__MaxReducer<TPMGL(T)>::equals(
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MaxReducer<TPMGL(T)>::_struct_equals(
  ::x10::lang::Any* other) {
    ...
    return (*this)->x10::lang::template Reducible__MaxReducer<TPMGL(T)>::_struct_equals(
             ::x10aux::class_cast< ::x10::lang::Reducible__MaxReducer<TPMGL(T)> >(other));
