...
class Accumulator_Strings {
  public:
    static ::x10::lang::String sl__154919;
    static ::x10::lang::String sl__154920;
    static ::x10::lang::String sl__154918;
};
...
template<class TPMGL(T)> class x10_lang_Accumulator__closure__1 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        ::x10::lang::Accumulator<TPMGL(T)>* me = saved_this->me();
        {
            ...
            ::x10::lang::CheckedThrowable* throwable__104714 = ::x10aux::class_cast_unchecked< ::x10::lang::CheckedThrowable*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL));
            try {
                {
                ...
                {
                    ::x10::lang::CheckedThrowable* formal__104715 =
                      __exc824;
                    {
                        throwable__104714 = formal__104715;
                    }
                }
            }
            if ((!::x10aux::struct_equals(throwable__104714,
                                          reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
            {
                if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__104714))
                {
                    ::x10aux::throwException(::x10aux::nullCheck(throwable__104714));
                }
            ...
            if ((!::x10aux::struct_equals(throwable__104714,
                                          reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
            {
                if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__104714)))
                {
                    ::x10aux::throwException(::x10aux::nullCheck(throwable__104714));
                }
...
template<class TPMGL(T)> class x10_lang_Accumulator__closure__2 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        ::x10::lang::Accumulator<TPMGL(T)>* me = saved_this->me();
        {
            ...
            ::x10::lang::CheckedThrowable* throwable__104717 = ::x10aux::class_cast_unchecked< ::x10::lang::CheckedThrowable*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL));
            try {
                {
                    ::x10::xrx::Runtime::enterAtomic();
                    {
                ...
                {
                    ::x10::lang::CheckedThrowable* formal__104718 = __exc826;
                    {
                        throwable__104717 = formal__104718;
                    }
                }
            }
            if ((!::x10aux::struct_equals(throwable__104717, reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
            {
                if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__104717))
                {
                    ::x10aux::throwException(::x10aux::nullCheck(throwable__104717));
                }
            ...
            if ((!::x10aux::struct_equals(throwable__104717,
                                          reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
            {
                if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__104717)))
                {
                    ::x10aux::throwException(::x10aux::nullCheck(throwable__104717));
                }
...
template<class TPMGL(T)> class x10_lang_Accumulator__closure__3 : public ::x10::lang::Closure {
    ...
    TPMGL(T) __apply(){
        return ::x10aux::nullCheck(saved_this->me())->localGetResult();
...
template<class TPMGL(T)> void x10::lang::Accumulator<TPMGL(T)>::_constructor(
    ...
    (this)->::x10::lang::Acc::_constructor();
    
    //#line 23 "x10/lang/Accumulator.x10"
    this->x10::lang::template Accumulator<TPMGL(T)>::__fieldInitializers_x10_lang_Accumulator();
...
template<class TPMGL(T)> ::x10::lang::Accumulator<TPMGL(T)>*
  x10::lang::Accumulator<TPMGL(T)>::me() {
    return ::x10aux::class_cast< ::x10::lang::Accumulator<TPMGL(T)>*>(((__extension__ ({
        ::x10::lang::GlobalRef< ::x10::lang::Acc* > t__104702 =
          this->FMGL(root);
        if (!((::x10aux::struct_equals(::x10::lang::Place::_make((t__104702)->location),
                                       ::x10::lang::Place::_make(::x10aux::here)))))
        {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::lang::Accumulator_Strings::sl__154920))));
        }
        t__104702;
    }))
    )->__apply());
