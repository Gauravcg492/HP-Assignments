...
class DistArray_Block_1_Strings {
  public:
    static ::x10::lang::String sl__153937;
    static ::x10::lang::String sl__153938;
};
...
template<class TPMGL(T)> ::x10::array::DenseIterationSpace_1* x10::array::DistArray_Block_1<TPMGL(T)>::reloadLocalIndices(
    ...
    return (!::x10aux::struct_equals(ls, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)))
      ...
      : (::x10::array::DenseIterationSpace_1::_make(((x10_long)0ll),
                                                    ((x10_long)-1ll)));
...
template<class TPMGL(T)> void x10::array::DistArray_Block_1<TPMGL(T)>::_constructor(
    ...
    (this)->::x10::array::DistArray<TPMGL(T)>::_constructor(
      ...
      ::x10::array::DistArray_Block_1<void>::validateSize(
        n));
    
    //#line 53 "x10/array/DistArray_Block_1.x10"
    
    //#line 23 "x10/array/DistArray_Block_1.x10"
    this->x10::array::template DistArray_Block_1<TPMGL(T)>::__fieldInitializers_x10_array_DistArray_Block_1();
    
    //#line 55 "x10/array/DistArray_Block_1.x10"
    this->FMGL(globalIndices) = ::x10::array::DenseIterationSpace_1::_make(((x10_long)0ll),
                                                                           ((n) - (((x10_long)1ll))));
    ...
    this->FMGL(minLocalIndex) = this->x10::array::template DistArray_Block_1<TPMGL(T)>::reloadMinLocalIndex();
    
    //#line 58 "x10/array/DistArray_Block_1.x10"
    this->FMGL(maxLocalIndex) = this->x10::array::template DistArray_Block_1<TPMGL(T)>::reloadMaxLocalIndex();
}
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_1<TPMGL(T)>::__apply(
  x10_long i) {
    ...
    //#line 150 "x10/array/DistArray_Block_1.x10"
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_1<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    return this->x10::array::template DistArray_Block_1<TPMGL(T)>::__apply(
             ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
               ((x10_long)0ll)));
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_1<TPMGL(T)>::__set(
  x10_long i, TPMGL(T) v) {
    ...
    //#line 180 "x10/array/DistArray_Block_1.x10"
    if ((PLACE_CHECK_BOOL || BOUNDS_CHECK_BOOL)) {
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_1<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    return this->x10::array::template DistArray_Block_1<TPMGL(T)>::__set(
             ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
               ((x10_long)0ll)), v);
...
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::array::DistArray_Block_1<TPMGL(T)>::getPatch(
  ::x10::array::IterationSpace* space) {
    ...
    if ((BOUNDS_CHECK_BOOL && !((((this->FMGL(localIndices)->FMGL(min)) <= (::x10aux::nullCheck(r)->FMGL(min))) &&
        ((::x10aux::nullCheck(r)->FMGL(max)) <= (this->FMGL(localIndices)->FMGL(max)))))))
    {
        
        //#line 212 "x10/array/DistArray_Block_1.x10"
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::ArrayIndexOutOfBoundsException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::DistArray_Block_1_Strings::sl__153937), r), (&::x10::array::DistArray_Block_1_Strings::sl__153938)), this->FMGL(localIndices)))));
    }
    ...
    ::x10::lang::Rail< TPMGL(T) >* patch = ::x10::lang::Rail< TPMGL(T) >::_makeUnsafe(::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_1::size(), false);
    
    //#line 217 "x10/array/DistArray_Block_1.x10"
    x10_long patchIndex = ((x10_long)0ll);
    
    //#line 218 "x10/array/DistArray_Block_1.x10"
    ::x10::array::DenseIterationSpace_1* p__96225 = r;
    x10_long i__96175min__96226 = ::x10aux::nullCheck(p__96225)->x10::array::DenseIterationSpace_1::min(
                                    ((x10_long)0ll));
    x10_long i__96175max__96227 = ::x10aux::nullCheck(p__96225)->x10::array::DenseIterationSpace_1::max(
                                    ((x10_long)0ll));
    {
        x10_long i__96228;
        for (i__96228 = i__96175min__96226; ((i__96228) <= (i__96175max__96227));
             i__96228 = ((i__96228) + (((x10_long)1ll))))
        {
            x10_long i__96229 = i__96228;
            
            //#line 219 "x10/array/DistArray_Block_1.x10"
            patch->x10::lang::template Rail< TPMGL(T) >::__set(
              (__extension__ ({
                  x10_long pre__96224 = patchIndex;
