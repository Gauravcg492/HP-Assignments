...
template<class TPMGL(S)> ::x10::array::LocalState_B2<TPMGL(S)>*
  x10::array::LocalState_B2<void>::make(::x10::lang::PlaceGroup* pg,
    ...
    if (dist->FMGL(localIndices)->x10::array::DenseIterationSpace_2::isEmpty())
    {
        ...
        x10_long i__96659min__96691 = low1;
        x10_long i__96659max__96692 = hi1;
        {
            x10_long i__96693;
            for (i__96693 = i__96659min__96691; ((i__96693) <= (i__96659max__96692));
                 i__96693 = ((i__96693) + (((x10_long)1ll))))
            {
                x10_long i__96694 = i__96693;
                
                //#line 290 "x10/array/DistArray_Block_2.x10"
                x10_long i__96641min__96687 = low2;
                x10_long i__96641max__96688 = hi2;
                {
                    x10_long i__96689;
                    for (i__96689 = i__96641min__96687; ((i__96689) <= (i__96641max__96688));
                         i__96689 = ((i__96689) + (((x10_long)1ll))))
                    {
                        x10_long j__96690 = i__96689;
                        
                        //#line 291 "x10/array/DistArray_Block_2.x10"
                        x10_long offset__96686 = ((((j__96690) - (low2))) + (((((i__96694) - (low1))) * (localSize2))));
                        
                        //#line 292 "x10/array/DistArray_Block_2.x10"
                        data->x10::lang::template Rail< TPMGL(S) >::__set(
                          offset__96686, ::x10::lang::Fun_0_2<x10_long, x10_long, TPMGL(S)>::__apply(::x10aux::nullCheck(init), 
                            i__96694, j__96690));
                    }
                }
