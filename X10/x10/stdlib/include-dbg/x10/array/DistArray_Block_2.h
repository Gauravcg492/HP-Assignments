...
class DistArray_Block_2_Strings {
  public:
    static ::x10::lang::String sl__153974;
    static ::x10::lang::String sl__153975;
};
...
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::array::DistArray_Block_2<TPMGL(T)>::getPatch(
  ::x10::array::IterationSpace* space) {
        ...
        ((::x10aux::nullCheck(r)->FMGL(max1)) <= (this->FMGL(localIndices)->FMGL(max1)))))))
    {
        ...
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::ArrayIndexOutOfBoundsException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::DistArray_Block_2_Strings::sl__153974), r), (&::x10::array::DistArray_Block_2_Strings::sl__153975)), this->FMGL(localIndices)))));
    }
    ...
    ::x10::array::DenseIterationSpace_2* p__96677 = r;
    x10_long i1__96578min__96678 = ::x10aux::nullCheck(p__96677)->x10::array::DenseIterationSpace_2::min(
                                     ((x10_long)1ll));
    x10_long i1__96578max__96679 = ::x10aux::nullCheck(p__96677)->x10::array::DenseIterationSpace_2::max(
                                     ((x10_long)1ll));
    x10_long i0__96609min__96680 = ::x10aux::nullCheck(p__96677)->x10::array::DenseIterationSpace_2::min(
                                     ((x10_long)0ll));
    x10_long i0__96609max__96681 = ::x10aux::nullCheck(p__96677)->x10::array::DenseIterationSpace_2::max(
                                     ((x10_long)0ll));
    {
        x10_long i__96682;
        for (i__96682 = i0__96609min__96680; ((i__96682) <= (i0__96609max__96681));
             i__96682 = ((i__96682) + (((x10_long)1ll))))
        {
            x10_long i__96683 = i__96682;
            {
                x10_long i__96684;
                for (i__96684 = i1__96578min__96678; ((i__96684) <= (i1__96578max__96679));
                     i__96684 = ((i__96684) + (((x10_long)1ll))))
                {
                    x10_long i__96685 = i__96684;
                    
                    //#line 251 "x10/array/DistArray_Block_2.x10"
                    patch->x10::lang::template Rail< TPMGL(T) >::__set(
                      (__extension__ ({
                          x10_long pre__96676 = patchIndex;
