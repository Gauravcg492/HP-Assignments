...
class Array_2_Strings {
  public:
    static ::x10::lang::String sl__153606;
    static ::x10::lang::String sl__153610;
    static ::x10::lang::String sl__153611;
    static ::x10::lang::String sl__153607;
    static ::x10::lang::String sl__153612;
    static ::x10::lang::String sl__153613;
    static ::x10::lang::String sl__153608;
    static ::x10::lang::String sl__153609;
    static ::x10::lang::String sl__153614;
};
...
template<class TPMGL(T)> void x10::array::Array_2<TPMGL(T)>::_constructor(
    ...
    x10_long i__91952min__92009 = ((x10_long)0ll);
    x10_long i__91952max__92010 = ((m) - (((x10_long)1ll)));
    {
        x10_long i__92011;
        for (i__92011 = i__91952min__92009; ((i__92011) <= (i__91952max__92010));
             i__92011 = ((i__92011) + (((x10_long)1ll))))
        {
            x10_long i__92012 = i__92011;
            
            //#line 63 "x10/array/Array_2.x10"
            x10_long i__91934min__92005 = ((x10_long)0ll);
            x10_long i__91934max__92006 = ((n) - (((x10_long)1ll)));
            {
                x10_long i__92007;
                for (i__92007 = i__91934min__92005; ((i__92007) <= (i__91934max__92006));
                     i__92007 = ((i__92007) + (((x10_long)1ll))))
                {
                    x10_long j__92008 = i__92007;
                    ...
                    this->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__set(
                      this->x10::array::template Array_2<TPMGL(T)>::offset(
                        i__92012, j__92008), ::x10::lang::Fun_0_2<x10_long, x10_long, TPMGL(T)>::__apply(::x10aux::nullCheck(init), 
                        i__92012, j__92008));
                }
            }
...
template<class TPMGL(T)> ::x10::lang::String* x10::array::Array_2<TPMGL(T)>::toString(
  x10_long limit) {
    ...
    sb->add((&::x10::array::Array_2_Strings::sl__153609));
    
    //#line 112 "x10/array/Array_2.x10"
    x10_long printed = ((x10_long)0ll);
    
    //#line 113 "x10/array/Array_2.x10"
    x10_long i__91988min__92017 = ((x10_long)0ll);
    x10_long i__91988max__92018 = ((this->FMGL(numElems_1)) - (((x10_long)1ll)));
    goto outer__92019; outer__92019: {
        x10_long i__92020;
        for (i__92020 = i__91988min__92017; ((i__92020) <= (i__91988max__92018));
             i__92020 = ((i__92020) + (((x10_long)1ll))))
        {
        {
            x10_long i__92021 = i__92020;
            
            //#line 114 "x10/array/Array_2.x10"
            x10_long i__91970min__92013 = ((x10_long)0ll);
            x10_long i__91970max__92014 = ((this->FMGL(numElems_2)) - (((x10_long)1ll)));
            {
                x10_long i__92015;
                for (i__92015 = i__91970min__92013; ((i__92015) <= (i__91970max__92014));
                     i__92015 = ((i__92015) + (((x10_long)1ll))))
                {
                    x10_long j__92016 = i__92015;
                    
                    //#line 115 "x10/array/Array_2.x10"
                    if ((!::x10aux::struct_equals(j__92016,
                                                  ((x10_long)0ll))))
                    {
                        sb->add((&::x10::array::Array_2_Strings::sl__153610));
                    }
            ...
            sb->add((&::x10::array::Array_2_Strings::sl__153611));
        }
        goto outer__92019_next_; outer__92019_next_: ;
        }
        goto outer__92019_end_; outer__92019_end_: ;
    }
    ...
    if (((limit) < (this->FMGL(size)))) {
        ...
        sb->add(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::Array_2_Strings::sl__153612), ((this->FMGL(size)) - (limit))), (&::x10::array::Array_2_Strings::sl__153613)));
    }
    
    //#line 124 "x10/array/Array_2.x10"
    sb->add((&::x10::array::Array_2_Strings::sl__153614));
...
template<class TPMGL(T)> ::x10::array::Array_2<TPMGL(T)>*
  x10::array::Array_2<void>::makeView(::x10::lang::Rail< TPMGL(T) >* r,
    ...
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::IllegalOperationException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::Array_2_Strings::sl__153606), m), (&::x10::array::Array_2_Strings::sl__153607)), n), (&::x10::array::Array_2_Strings::sl__153608)), (x10_long)(::x10aux::nullCheck(r)->FMGL(size))))));
    }
