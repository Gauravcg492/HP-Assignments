...
template<class TPMGL(S)> ::x10::array::LocalState_B1<TPMGL(S)>*
  x10::array::LocalState_B1<void>::make(::x10::lang::PlaceGroup* pg,
    ...
    if (dist->FMGL(localIndices)->x10::array::DenseIterationSpace_1::isEmpty())
    {
        ...
        x10_long i__96207min__96231 = low;
        x10_long i__96207max__96232 = hi;
        {
            x10_long i__96233;
            for (i__96233 = i__96207min__96231; ((i__96233) <= (i__96207max__96232));
                 i__96233 = ((i__96233) + (((x10_long)1ll))))
            {
                x10_long i__96234 = i__96233;
                
                //#line 255 "x10/array/DistArray_Block_1.x10"
                x10_long offset__96230 = ((i__96234) - (low));
                
                //#line 256 "x10/array/DistArray_Block_1.x10"
                data->x10::lang::template Rail< TPMGL(S) >::__set(
                  offset__96230, ::x10::lang::Fun_0_1<x10_long, TPMGL(S)>::__apply(::x10aux::nullCheck(init), 
                    i__96234));
            }
        }
