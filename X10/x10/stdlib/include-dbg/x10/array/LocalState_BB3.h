...
template<class TPMGL(S)> ::x10::array::LocalState_BB3<TPMGL(S)>*
  x10::array::LocalState_BB3<void>::make(::x10::lang::PlaceGroup* pg,
    ...
    if (dist->FMGL(localIndices)->x10::array::DenseIterationSpace_3::isEmpty())
    {
        ...
        x10_long i__98476min__98516 = low1;
        x10_long i__98476max__98517 = hi1;
        {
            x10_long i__98518;
            for (i__98518 = i__98476min__98516; ((i__98518) <= (i__98476max__98517));
                 i__98518 = ((i__98518) + (((x10_long)1ll))))
            {
                x10_long i__98519 = i__98518;
                
                //#line 314 "x10/array/DistArray_BlockBlock_3.x10"
                x10_long i__98458min__98512 = low2;
                x10_long i__98458max__98513 = hi2;
                {
                    x10_long i__98514;
                    for (i__98514 = i__98458min__98512; ((i__98514) <= (i__98458max__98513));
                         i__98514 = ((i__98514) + (((x10_long)1ll))))
                    {
                        x10_long j__98515 = i__98514;
                        
                        //#line 315 "x10/array/DistArray_BlockBlock_3.x10"
                        x10_long i__98440min__98508 = low3;
                        x10_long i__98440max__98509 = hi3;
                        {
                            x10_long i__98510;
                            for (i__98510 = i__98440min__98508;
                                 ((i__98510) <= (i__98440max__98509));
                                 i__98510 = ((i__98510) + (((x10_long)1ll))))
                            {
                                x10_long k__98511 = i__98510;
                                
                                //#line 316 "x10/array/DistArray_BlockBlock_3.x10"
                                x10_long offset__98507 = ((k__98511) + (((localSize3) * (((((j__98515) - (low2))) + (((localSize2) * (((i__98519) - (low1))))))))));
                                
                                //#line 317 "x10/array/DistArray_BlockBlock_3.x10"
                                data->x10::lang::template Rail< TPMGL(S) >::__set(
                                  offset__98507, ::x10::lang::Fun_0_3<x10_long, x10_long, x10_long, TPMGL(S)>::__apply(::x10aux::nullCheck(init), 
                                    i__98519, j__98515, k__98511));
                            }
                        }
