...
template<class TPMGL(S)> void x10::array::LocalState_B3<TPMGL(S)>::_constructor(
    ...
    this->x10::array::template LocalState_B3<TPMGL(S)>::__fieldInitializers_x10_array_LocalState_B3();
...
template<class TPMGL(S)> ::x10::array::LocalState_B3<TPMGL(S)>*
  x10::array::LocalState_B3<void>::make(::x10::lang::PlaceGroup* pg,
    ...
    ::x10::array::Dist_Block_3* dist = ::x10::array::Dist_Block_3::_make(pg,
                                                                         globalSpace);
    ...
    if (dist->FMGL(localIndices)->x10::array::DenseIterationSpace_3::isEmpty())
    {
        ...
        x10_long i__97316min__97356 = low1;
        x10_long i__97316max__97357 = hi1;
        {
            x10_long i__97358;
            for (i__97358 = i__97316min__97356; ((i__97358) <= (i__97316max__97357));
                 i__97358 = ((i__97358) + (((x10_long)1ll))))
            {
                x10_long i__97359 = i__97358;
                
                //#line 304 "x10/array/DistArray_Block_3.x10"
                x10_long i__97298min__97352 = low2;
                x10_long i__97298max__97353 = hi2;
                {
                    x10_long i__97354;
                    for (i__97354 = i__97298min__97352; ((i__97354) <= (i__97298max__97353));
                         i__97354 = ((i__97354) + (((x10_long)1ll))))
                    {
                        x10_long j__97355 = i__97354;
                        
                        //#line 305 "x10/array/DistArray_Block_3.x10"
                        x10_long i__97280min__97348 = low3;
                        x10_long i__97280max__97349 = hi3;
                        {
                            x10_long i__97350;
                            for (i__97350 = i__97280min__97348;
                                 ((i__97350) <= (i__97280max__97349));
                                 i__97350 = ((i__97350) + (((x10_long)1ll))))
                            {
                                x10_long k__97351 = i__97350;
                                
                                //#line 306 "x10/array/DistArray_Block_3.x10"
                                x10_long offset__97347 = ((((k__97351) - (low3))) + (((localSize3) * (((((j__97355) - (low2))) + (((((i__97359) - (low1))) * (localSize2))))))));
                                
                                //#line 307 "x10/array/DistArray_Block_3.x10"
                                data->x10::lang::template Rail< TPMGL(S) >::__set(
                                  offset__97347, ::x10::lang::Fun_0_3<x10_long, x10_long, x10_long, TPMGL(S)>::__apply(::x10aux::nullCheck(init), 
                                    i__97359, j__97355, k__97351));
                            }
                        }
    ...
    return ::x10::array::LocalState_B3<TPMGL(S)>::_make(pg,
                                                        data,
                                                        ((((m) * (n))) * (p)),
                                                        dist);
