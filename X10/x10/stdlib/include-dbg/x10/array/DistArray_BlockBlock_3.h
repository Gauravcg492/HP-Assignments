...
class DistArray_BlockBlock_3_Strings {
  public:
    static ::x10::lang::String sl__154156;
    static ::x10::lang::String sl__154157;
};
...
template<class TPMGL(T)> void x10::array::DistArray_BlockBlock_3<TPMGL(T)>::_constructor(
    ...
    (this)->::x10::array::DistArray<TPMGL(T)>::_constructor(
      ...
      ::x10::array::DistArray_BlockBlock_3<void>::validateSize(
        m, n, p));
    
    //#line 70 "x10/array/DistArray_BlockBlock_3.x10"
    
    //#line 23 "x10/array/DistArray_BlockBlock_3.x10"
    this->x10::array::template DistArray_BlockBlock_3<TPMGL(T)>::__fieldInitializers_x10_array_DistArray_BlockBlock_3();
    ...
    this->FMGL(minIndex_1) = this->x10::array::template DistArray_BlockBlock_3<TPMGL(T)>::reloadMinIndex_1();
    
    //#line 78 "x10/array/DistArray_BlockBlock_3.x10"
    this->FMGL(minIndex_2) = this->x10::array::template DistArray_BlockBlock_3<TPMGL(T)>::reloadMinIndex_2();
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_3<TPMGL(T)>::__apply(
  x10_long i, x10_long j, x10_long k) {
    ...
    return (this->FMGL(raw))->unchecked_apply(this->x10::array::template DistArray_BlockBlock_3<TPMGL(T)>::offset(
                                                i, j, k));
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_3<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    return this->x10::array::template DistArray_BlockBlock_3<TPMGL(T)>::__apply(
             ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
               ((x10_long)0ll)), ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                                   ((x10_long)1ll)), ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                                                       ((x10_long)2ll)));
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_3<TPMGL(T)>::__set(
  x10_long i, x10_long j, x10_long k, TPMGL(T) v) {
    ...
    return (this->FMGL(raw))->unchecked_set(this->x10::array::template DistArray_BlockBlock_3<TPMGL(T)>::offset(
                                              i, j, k), v);
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_3<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    return this->x10::array::template DistArray_BlockBlock_3<TPMGL(T)>::__set(
             ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
               ((x10_long)0ll)), ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                                   ((x10_long)1ll)), ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                                                       ((x10_long)2ll)),
...
template<class TPMGL(T)> void x10::array::DistArray_BlockBlock_3<TPMGL(T)>::validateIndex(
  x10_long i, x10_long j, x10_long k) {
    ...
    //#line 233 "x10/array/DistArray_BlockBlock_3.x10"
    if ((PLACE_CHECK_BOOL || BOUNDS_CHECK_BOOL)) {
        
        //#line 234 "x10/array/DistArray_BlockBlock_3.x10"
        if ((BOUNDS_CHECK_BOOL && ((((k) < (((x10_long)0ll))) ||
...
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::array::DistArray_BlockBlock_3<TPMGL(T)>::getPatch(
  ::x10::array::IterationSpace* space) {
        ...
        ((::x10aux::nullCheck(r)->FMGL(max2)) <= (this->FMGL(localIndices)->FMGL(max2)))))))
    {
        ...
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::ArrayIndexOutOfBoundsException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::DistArray_BlockBlock_3_Strings::sl__154156), r), (&::x10::array::DistArray_BlockBlock_3_Strings::sl__154157)), this->FMGL(localIndices)))));
    }
    ...
    ::x10::array::DenseIterationSpace_3* p__98494 = r;
    x10_long i2__98346min__98495 = ::x10aux::nullCheck(p__98494)->x10::array::DenseIterationSpace_3::min(
                                     ((x10_long)2ll));
    x10_long i2__98346max__98496 = ::x10aux::nullCheck(p__98494)->x10::array::DenseIterationSpace_3::max(
                                     ((x10_long)2ll));
    x10_long i1__98377min__98497 = ::x10aux::nullCheck(p__98494)->x10::array::DenseIterationSpace_3::min(
                                     ((x10_long)1ll));
    x10_long i1__98377max__98498 = ::x10aux::nullCheck(p__98494)->x10::array::DenseIterationSpace_3::max(
                                     ((x10_long)1ll));
    x10_long i0__98408min__98499 = ::x10aux::nullCheck(p__98494)->x10::array::DenseIterationSpace_3::min(
                                     ((x10_long)0ll));
    x10_long i0__98408max__98500 = ::x10aux::nullCheck(p__98494)->x10::array::DenseIterationSpace_3::max(
                                     ((x10_long)0ll));
    {
        x10_long i__98501;
        for (i__98501 = i0__98408min__98499; ((i__98501) <= (i0__98408max__98500));
             i__98501 = ((i__98501) + (((x10_long)1ll))))
        {
            x10_long i__98502 = i__98501;
            {
                x10_long i__98503;
                for (i__98503 = i1__98377min__98497; ((i__98503) <= (i1__98377max__98498));
                     i__98503 = ((i__98503) + (((x10_long)1ll))))
                {
                    x10_long i__98504 = i__98503;
                    {
                        x10_long i__98505;
                        for (i__98505 = i2__98346min__98495;
                             ((i__98505) <= (i2__98346max__98496));
                             i__98505 = ((i__98505) + (((x10_long)1ll))))
                        {
                            x10_long i__98506 = i__98505;
                            
                            //#line 272 "x10/array/DistArray_BlockBlock_3.x10"
                            patch->x10::lang::template Rail< TPMGL(T) >::__set(
                              (__extension__ ({
                                  x10_long pre__98493 = patchIndex;
                                  patchIndex = ((patchIndex) + (((x10_long)1ll)));
                                  pre__98493;
                              }))
                              , this->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                  this->x10::array::template DistArray_BlockBlock_3<TPMGL(T)>::offset(
                                    i__98502, i__98504, i__98506)));
                        }
                    }
