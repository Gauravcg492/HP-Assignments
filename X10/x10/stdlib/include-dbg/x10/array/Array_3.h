...
class Array_3_Strings {
  public:
    static ::x10::lang::String sl__153682;
    static ::x10::lang::String sl__153677;
    static ::x10::lang::String sl__153681;
    static ::x10::lang::String sl__153683;
    static ::x10::lang::String sl__153678;
    static ::x10::lang::String sl__153684;
    static ::x10::lang::String sl__153685;
    static ::x10::lang::String sl__153679;
    static ::x10::lang::String sl__153680;
    static ::x10::lang::String sl__153686;
};
...
template<class TPMGL(T)> void x10::array::Array_3<TPMGL(T)>::_constructor(
    ...
    x10_long i__92519min__92598 = ((x10_long)0ll);
    x10_long i__92519max__92599 = ((m) - (((x10_long)1ll)));
    {
        x10_long i__92600;
        for (i__92600 = i__92519min__92598; ((i__92600) <= (i__92519max__92599));
             i__92600 = ((i__92600) + (((x10_long)1ll))))
        {
            x10_long i__92601 = i__92600;
            
            //#line 70 "x10/array/Array_3.x10"
            x10_long i__92501min__92594 = ((x10_long)0ll);
            x10_long i__92501max__92595 = ((n) - (((x10_long)1ll)));
            {
                x10_long i__92596;
                for (i__92596 = i__92501min__92594; ((i__92596) <= (i__92501max__92595));
                     i__92596 = ((i__92596) + (((x10_long)1ll))))
                {
                    x10_long j__92597 = i__92596;
                    
                    //#line 71 "x10/array/Array_3.x10"
                    x10_long i__92483min__92590 = ((x10_long)0ll);
                    x10_long i__92483max__92591 = ((p) - (((x10_long)1ll)));
                    {
                        x10_long i__92592;
                        for (i__92592 = i__92483min__92590;
                             ((i__92592) <= (i__92483max__92591));
                             i__92592 = ((i__92592) + (((x10_long)1ll))))
                        {
                            x10_long k__92593 = i__92592;
...
template<class TPMGL(T)> ::x10::lang::String* x10::array::Array_3<TPMGL(T)>::toString(
  x10_long limit) {
    ...
    sb->add((&::x10::array::Array_3_Strings::sl__153680));
    
    //#line 121 "x10/array/Array_3.x10"
    x10_long printed = ((x10_long)0ll);
    
    //#line 122 "x10/array/Array_3.x10"
    x10_long i__92573min__92610 = ((x10_long)0ll);
    x10_long i__92573max__92611 = ((this->FMGL(numElems_1)) - (((x10_long)1ll)));
    goto outer__92612; outer__92612: {
        x10_long i__92613;
        for (i__92613 = i__92573min__92610; ((i__92613) <= (i__92573max__92611));
             i__92613 = ((i__92613) + (((x10_long)1ll))))
        {
        {
            x10_long i__92614 = i__92613;
            
            //#line 123 "x10/array/Array_3.x10"
            x10_long i__92555min__92606 = ((x10_long)0ll);
            x10_long i__92555max__92607 = ((this->FMGL(numElems_2)) - (((x10_long)1ll)));
            {
                x10_long i__92608;
                for (i__92608 = i__92555min__92606; ((i__92608) <= (i__92555max__92607));
                     i__92608 = ((i__92608) + (((x10_long)1ll))))
                {
                    x10_long j__92609 = i__92608;
                    
                    //#line 124 "x10/array/Array_3.x10"
                    x10_long i__92537min__92602 = ((x10_long)0ll);
                    x10_long i__92537max__92603 = ((this->FMGL(numElems_3)) - (((x10_long)1ll)));
                    {
                        x10_long i__92604;
                        for (i__92604 = i__92537min__92602;
                             ((i__92604) <= (i__92537max__92603));
                             i__92604 = ((i__92604) + (((x10_long)1ll))))
                        {
                            x10_long k__92605 = i__92604;
                            
                            //#line 125 "x10/array/Array_3.x10"
                            if ((!::x10aux::struct_equals(k__92605,
                                                          ((x10_long)0ll))))
                            {
                                sb->add((&::x10::array::Array_3_Strings::sl__153681));
                            }
                    ...
                    sb->add((::x10aux::struct_equals(j__92609,
                                                     ((this->FMGL(numElems_2)) - (((x10_long)1ll)))))
                              ? ((&::x10::array::Array_3_Strings::sl__153682))
                              : ((&::x10::array::Array_3_Strings::sl__153683)));
                }
            }
            
        }
        goto outer__92612_next_; outer__92612_next_: ;
        }
        goto outer__92612_end_; outer__92612_end_: ;
    }
    ...
    if (((limit) < (this->FMGL(size)))) {
        ...
        sb->add(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::Array_3_Strings::sl__153684), ((this->FMGL(size)) - (limit))), (&::x10::array::Array_3_Strings::sl__153685)));
    }
    
    //#line 135 "x10/array/Array_3.x10"
    sb->add((&::x10::array::Array_3_Strings::sl__153686));
