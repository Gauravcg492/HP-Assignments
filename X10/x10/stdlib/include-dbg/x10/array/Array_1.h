...
template<class TPMGL(T)> void x10::array::Array_1<TPMGL(T)>::_constructor(
    ...
    (this)->::x10::array::Array<TPMGL(T)>::_constructor(::x10::array::Array_1<void>::validateSize(
                                                          n), true);
    
    //#line 29 "x10/array/Array_1.x10"
    
    //#line 19 "x10/array/Array_1.x10"
    this->x10::array::template Array_1<TPMGL(T)>::__fieldInitializers_x10_array_Array_1();
}
...
template<class TPMGL(T)> void x10::array::Array_1<TPMGL(T)>::_constructor(
    ...
    ::x10::lang::Rail< TPMGL(T) >* rail__91609 = this->FMGL(raw);
    x10_long i__91591min__91610 = ((x10_long)0ll);
    x10_long i__91591max__91611 = (x10_long)(::x10aux::nullCheck(rail__91609)->FMGL(size));
    {
        x10_long i__91612;
        for (i__91612 = i__91591min__91610; ((i__91612) < (i__91591max__91611));
             i__91612 = ((i__91612) + (((x10_long)1ll))))
        {
            x10_long i__91613 = i__91612;
            
            //#line 48 "x10/array/Array_1.x10"
            this->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__set(
              i__91613, ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>::__apply(::x10aux::nullCheck(init), 
                i__91613));
        }
    }
...
template<class TPMGL(T)> TPMGL(T) x10::array::Array_1<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    return this->x10::array::template Array_1<TPMGL(T)>::__apply(
...
template<class TPMGL(T)> TPMGL(T) x10::array::Array_1<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    return this->x10::array::template Array_1<TPMGL(T)>::__set(
             ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
               ((x10_long)0ll)), v);
...
template<class TPMGL(T)> ::x10::array::Array_1<TPMGL(T)>*
  x10::array::Array_1<void>::makeView(::x10::lang::Rail< TPMGL(T) >* r) {
    ...
    return ::x10::array::Array_1<TPMGL(T)>::_make(r);
