...
template<class TPMGL(S)> ::x10::array::LocalState_BB2<TPMGL(S)>*
  x10::array::LocalState_BB2<void>::make(::x10::lang::PlaceGroup* pg,
    ...
    if (dist->FMGL(localIndices)->x10::array::DenseIterationSpace_2::isEmpty())
    {
        ...
        x10_long i__97805min__97837 = low1;
        x10_long i__97805max__97838 = hi1;
        {
            x10_long i__97839;
            for (i__97839 = i__97805min__97837; ((i__97839) <= (i__97805max__97838));
                 i__97839 = ((i__97839) + (((x10_long)1ll))))
            {
                x10_long i__97840 = i__97839;
                
                //#line 296 "x10/array/DistArray_BlockBlock_2.x10"
                x10_long i__97787min__97833 = low2;
                x10_long i__97787max__97834 = hi2;
                {
                    x10_long i__97835;
                    for (i__97835 = i__97787min__97833; ((i__97835) <= (i__97787max__97834));
                         i__97835 = ((i__97835) + (((x10_long)1ll))))
                    {
                        x10_long j__97836 = i__97835;
                        
                        //#line 297 "x10/array/DistArray_BlockBlock_2.x10"
                        x10_long offset__97832 = ((((j__97836) - (low2))) + (((((i__97840) - (low1))) * (localSize2))));
                        
                        //#line 298 "x10/array/DistArray_BlockBlock_2.x10"
                        data->x10::lang::template Rail< TPMGL(S) >::__set(
                          offset__97832, ::x10::lang::Fun_0_2<x10_long, x10_long, TPMGL(S)>::__apply(::x10aux::nullCheck(init), 
                            i__97840, j__97836));
                    }
                }
