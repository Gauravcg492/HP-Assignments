...
class DistArray_BlockBlock_2_Strings {
  public:
    static ::x10::lang::String sl__154100;
    static ::x10::lang::String sl__154101;
};
...
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::array::DistArray_BlockBlock_2<TPMGL(T)>::getPatch(
  ::x10::array::IterationSpace* space) {
        ...
        ((::x10aux::nullCheck(r)->FMGL(max1)) <= (this->FMGL(localIndices)->FMGL(max1)))))))
    {
        ...
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::ArrayIndexOutOfBoundsException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::DistArray_BlockBlock_2_Strings::sl__154100), r), (&::x10::array::DistArray_BlockBlock_2_Strings::sl__154101)), this->FMGL(localIndices)))));
    }
    ...
    ::x10::array::DenseIterationSpace_2* p__97823 = r;
    x10_long i1__97724min__97824 = ::x10aux::nullCheck(p__97823)->x10::array::DenseIterationSpace_2::min(
                                     ((x10_long)1ll));
    x10_long i1__97724max__97825 = ::x10aux::nullCheck(p__97823)->x10::array::DenseIterationSpace_2::max(
                                     ((x10_long)1ll));
    x10_long i0__97755min__97826 = ::x10aux::nullCheck(p__97823)->x10::array::DenseIterationSpace_2::min(
                                     ((x10_long)0ll));
    x10_long i0__97755max__97827 = ::x10aux::nullCheck(p__97823)->x10::array::DenseIterationSpace_2::max(
                                     ((x10_long)0ll));
    {
        x10_long i__97828;
        for (i__97828 = i0__97755min__97826; ((i__97828) <= (i0__97755max__97827));
             i__97828 = ((i__97828) + (((x10_long)1ll))))
        {
            x10_long i__97829 = i__97828;
            {
                x10_long i__97830;
                for (i__97830 = i1__97724min__97824; ((i__97830) <= (i1__97724max__97825));
                     i__97830 = ((i__97830) + (((x10_long)1ll))))
                {
                    x10_long i__97831 = i__97830;
                    
                    //#line 257 "x10/array/DistArray_BlockBlock_2.x10"
                    patch->x10::lang::template Rail< TPMGL(T) >::__set(
                      (__extension__ ({
                          x10_long pre__97822 = patchIndex;
