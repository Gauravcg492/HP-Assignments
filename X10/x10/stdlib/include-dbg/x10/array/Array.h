...
class Array_Strings {
  public:
    static ::x10::lang::String sl__153867;
    static ::x10::lang::String sl__153868;
    static ::x10::lang::String sl__153866;
    static ::x10::lang::String sl__153865;
    static ::x10::lang::String sl__153864;
};
...
template<class TPMGL(T)> template<class TPMGL(U)> TPMGL(U) x10::array::Array<TPMGL(T)>::reduce(
  ::x10::lang::Fun_0_2<TPMGL(U), TPMGL(T), TPMGL(U)>* op, TPMGL(U) unit) {
    ...
    return ::x10::util::RailUtils::template reduce< TPMGL(T), TPMGL(U) >(
             this->FMGL(raw), op, unit);
...
template<class TPMGL(T)> template<class TPMGL(U)> ::x10::array::Array<TPMGL(U)>*
  x10::array::Array<TPMGL(T)>::map(::x10::array::Array<TPMGL(U)>* dst,
    ...
    ::x10::util::RailUtils::template map< TPMGL(T), TPMGL(U) >(this->FMGL(raw),
...
::x10::array::Array<TPMGL(U)>* x10::array::Array<TPMGL(T)>::map(
  ...
  ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(S), TPMGL(U)>* op) {
    ...
    TPMGL(U) >(this->FMGL(raw), ::x10aux::nullCheck(src2)->FMGL(raw),
               ::x10aux::nullCheck(dst)->FMGL(raw), op);
...
template<class TPMGL(T)> void x10::array::Array<TPMGL(T)>::_constructor(x10_long s,
    ...
    this->x10::array::template Array<TPMGL(T)>::__fieldInitializers_x10_array_Array();
...
template<class TPMGL(T)> void x10::array::Array<TPMGL(T)>::modifyRaw(
  ::x10::lang::Rail< TPMGL(T) >* r) {
    ...
    if ((!::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(this->FMGL(raw))->FMGL(size)),
                                  this->FMGL(size)))) {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::IllegalArgumentException::_make((&::x10::array::Array_Strings::sl__153864))));
    }
    
    //#line 92 "x10/array/Array.x10"
    this->FMGL(raw) = (__extension__ ({
        ::x10::lang::Rail< TPMGL(T) >* t__93393 = r;
        if (!(((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__93393)->FMGL(size)),
                                        ::x10aux::nullCheck(this)->FMGL(size))) &&
            (!::x10aux::struct_equals(t__93393, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))))
        {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::array::Array_Strings::sl__153865))));
        }
        t__93393;
    }))
    ;
...
template<class TPMGL(T)> void x10::array::Array<void>::swap(::x10::array::Array<TPMGL(T)>* a1,
    ...
    ::x10::lang::Rail< TPMGL(T) >* tmp = a1->x10::array::template Array<TPMGL(T)>::raw();
    
    //#line 106 "x10/array/Array.x10"
    a1->x10::array::template Array<TPMGL(T)>::modifyRaw(a2->x10::array::template Array<TPMGL(T)>::raw());
