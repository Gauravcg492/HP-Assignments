...
class HashMap_Strings {
  public:
    static ::x10::lang::String sl__158486;
    static ::x10::lang::String sl__158487;
};
...
template<class TPMGL(K), class TPMGL(V)> void x10::util::HashMap<TPMGL(K), TPMGL(V)>::_constructor(
    ...
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::OutOfMemoryError::_make(::x10::lang::String::__plus((&::x10::util::HashMap_Strings::sl__158486), sz))));
    }
...
template<class TPMGL(K), class TPMGL(V)> TPMGL(V) x10::util::HashMap<TPMGL(K), TPMGL(V)>::getOrThrow(
  TPMGL(K) k) {
    ...
    if (((::x10aux::struct_equals(e, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))) ||
        ::x10aux::nullCheck(e)->FMGL(removed))) {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::util::NoSuchElementException::_make(::x10::lang::String::__plus((&::x10::util::HashMap_Strings::sl__158487), k))));
    }
...
template<class TPMGL(K), class TPMGL(V)> void x10::util::HashMap<TPMGL(K), TPMGL(V)>::_constructor(
    ...
    x10_long i__123466min__123485 = ((x10_long)1ll);
    x10_long i__123466max__123486 = numEntries;
    {
        x10_long i__123487;
        for (i__123487 = i__123466min__123485; ((i__123487) <= (i__123466max__123486));
             i__123487 = ((i__123487) + (((x10_long)1ll))))
        {
            
            //#line 308 "x10/util/HashMap.x10"
            TPMGL(K) key__123483 = ::x10aux::class_cast<TPMGL(K)>(::x10aux::nullCheck(ds)->x10::io::Deserializer::readAny());
            
            //#line 309 "x10/util/HashMap.x10"
            TPMGL(V) value__123484 = ::x10aux::class_cast<TPMGL(V)>(::x10aux::nullCheck(ds)->x10::io::Deserializer::readAny());
            
            //#line 310 "x10/util/HashMap.x10"
            this->x10::util::template HashMap<TPMGL(K), TPMGL(V)>::putInternal(
              key__123483, value__123484, true);
        }
    }
