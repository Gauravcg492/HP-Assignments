...
class Team__DoubleIdx_Strings {
  public:
    static ::x10::lang::String sl__161011;
    static ::x10::lang::String sl__161012;
    static ::x10::lang::String sl__161010;
};
...
class Team__DoubleIdx   {
    ...
    void _constructor(x10_double value, x10_int idx) {
        FMGL(value) = value;
        FMGL(idx) = idx;
        (*this)->x10::util::Team__DoubleIdx::__fieldInitializers_x10_util_Team_DoubleIdx();
    }
