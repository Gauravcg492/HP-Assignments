...
template<class TPMGL(T), class TPMGL(U), class TPMGL(V)> void x10::util::Triple<TPMGL(T), TPMGL(U), TPMGL(V)>::_constructor(
    ...
    (*this)->x10::util::template Triple<TPMGL(T), TPMGL(U), TPMGL(V)>::__fieldInitializers_x10_util_Triple();
...
template<class TPMGL(T), class TPMGL(U), class TPMGL(V)> ::x10::lang::String*
  x10::util::Triple<TPMGL(T), TPMGL(U), TPMGL(V)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::util::Triple_Strings::sl__161130), (*this)->FMGL(first)), (&::x10::util::Triple_Strings::sl__161131)), (*this)->FMGL(second)), (&::x10::util::Triple_Strings::sl__161131)), (*this)->FMGL(third)), (&::x10::util::Triple_Strings::sl__161132));
