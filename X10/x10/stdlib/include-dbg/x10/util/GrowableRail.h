...
class GrowableRail_Strings {
  public:
    static ::x10::lang::String sl__158457;
    static ::x10::lang::String sl__158458;
    static ::x10::lang::String sl__158459;
    static ::x10::lang::String sl__158464;
    static ::x10::lang::String sl__158465;
    static ::x10::lang::String sl__158461;
    static ::x10::lang::String sl__158460;
    static ::x10::lang::String sl__158462;
    static ::x10::lang::String sl__158463;
    static ::x10::lang::String sl__158466;
};
...
template<class TPMGL(T)> void x10::util::GrowableRail<TPMGL(T)>::addAll(
  ::x10::lang::Rail< TPMGL(T) >* x) {
    ...
    x10_long i__123069min__123122 = ((x10_long)0ll);
    x10_long i__123069max__123123 = (((x10_long)(::x10aux::nullCheck(x)->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__123124;
        for (i__123124 = i__123069min__123122; ((i__123124) <= (i__123069max__123123));
             i__123124 = ((i__123124) + (((x10_long)1ll))))
        {
            x10_long i__123125 = i__123124;
...
template<class TPMGL(T)> x10_boolean x10::util::GrowableRail<TPMGL(T)>::contains(
  TPMGL(T) v) {
    ...
    if ((::x10aux::struct_equals(v, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
    {
        ...
        x10_long i__123087min__123126 = ((x10_long)0ll);
        x10_long i__123087max__123127 = ((this->x10::util::template GrowableRail<TPMGL(T)>::size()) - (((x10_long)1ll)));
        {
            x10_long i__123128;
            for (i__123128 = i__123087min__123126; ((i__123128) <= (i__123087max__123127));
                 i__123128 = ((i__123128) + (((x10_long)1ll))))
            {
                x10_long i__123129 = i__123128;
        ...
        x10_long i__123105min__123130 = ((x10_long)0ll);
        x10_long i__123105max__123131 = ((this->x10::util::template GrowableRail<TPMGL(T)>::size()) - (((x10_long)1ll)));
        {
            x10_long i__123132;
            for (i__123132 = i__123105min__123130; ((i__123132) <= (i__123105max__123131));
                 i__123132 = ((i__123132) + (((x10_long)1ll))))
            {
                x10_long i__123133 = i__123132;
...
template<class TPMGL(T)> ::x10::lang::String* x10::util::GrowableRail<TPMGL(T)>::toString(
    ...
    sb->add((&::x10::util::GrowableRail_Strings::sl__158462));
    ...
    //#line 275 "x10/util/GrowableRail.x10"
    {
        ...
        for (i = ((x10_long)0ll); ((i) < (sz)); i = ((i) + (((x10_long)1ll))))
        {
            ...
            if (((i) > (((x10_long)0ll)))) {
                ...
                sb->add((&::x10::util::GrowableRail_Strings::sl__158463));
            }
    ...
    if (((sz) < (this->FMGL(size)))) {
        ...
        sb->add(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::util::GrowableRail_Strings::sl__158464), ((this->FMGL(size)) - (sz))), (&::x10::util::GrowableRail_Strings::sl__158465)));
    }
    
    //#line 282 "x10/util/GrowableRail.x10"
    sb->add((&::x10::util::GrowableRail_Strings::sl__158466));
