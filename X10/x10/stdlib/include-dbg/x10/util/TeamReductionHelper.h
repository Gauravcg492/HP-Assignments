...
template<class TPMGL(T)> class x10_util_TeamReductionHelper__closure__1 : public ::x10::lang::Closure {
    ...
    void __apply(::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* op){
        ...
        x10_long i__136684min__136709 = ((x10_long)0ll);
        x10_long i__136684max__136710 = ((count) - (((x10_long)1ll)));
        {
            x10_long i__136711;
            for (i__136711 = i__136684min__136709; ((i__136711) <= (i__136684max__136710));
                 i__136711 = ((i__136711) + (((x10_long)1ll)))) {
                x10_long i__136712 = i__136711;
                
                //#line 361 "x10/util/TeamReductionHelper.x10"
                ::x10aux::nullCheck(dst)->x10::lang::template Rail< TPMGL(T) >::__set(
                  ((i__136712) + (dst_off)), ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>::__apply(::x10aux::nullCheck(op), 
                    ::x10aux::nullCheck(dst)->x10::lang::template Rail< TPMGL(T) >::__apply(
                      ((i__136712) + (dst_off))), ::x10aux::nullCheck(src)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                                    ((i__136712) + (src_off)))));
            }
        }
...
#ifndef X10_UTIL_TEAMREDUCTIONHELPER_H_performReduction_2862
#define X10_UTIL_TEAMREDUCTIONHELPER_H_performReduction_2862
...
#endif // X10_UTIL_TEAMREDUCTIONHELPER_H_performReduction_2862
#ifndef X10_UTIL_TEAMREDUCTIONHELPER_H_reduce_2871
#define X10_UTIL_TEAMREDUCTIONHELPER_H_reduce_2871
  ...
  x10_long dst_off, x10_long count, x10_int operation) {
    ...
    switch (operation) {
        ...
        default: ;
        {
            ...
            ::x10::lang::RuntimeNatives::println(::x10aux::to_string(reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((&::x10::util::TeamReductionHelper_Strings::sl__160792), operation)))->c_str());
        }
    }
}
#endif // X10_UTIL_TEAMREDUCTIONHELPER_H_reduce_2871
