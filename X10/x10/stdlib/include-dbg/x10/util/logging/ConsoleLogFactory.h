...
#ifndef X10_UTIL_LOGGING_CONSOLELOGFACTORY_H_toRail_2346
#define X10_UTIL_LOGGING_CONSOLELOGFACTORY_H_toRail_2346
template<class TPMGL(K)> ::x10::lang::Rail< TPMGL(K) >* x10::util::logging::ConsoleLogFactory::toRail(
  ::x10::util::Container<TPMGL(K)>* c) {
    ...
    {
        ::x10::lang::Iterator<TPMGL(K)>* k__123499;
        for (k__123499 = ::x10::util::Container<TPMGL(K)>::iterator(::x10aux::nullCheck(c));
             ::x10::lang::Iterator<TPMGL(K)>::hasNext(::x10aux::nullCheck(k__123499));
             ) {
            TPMGL(K) k = ::x10::lang::Iterator<TPMGL(K)>::next(::x10aux::nullCheck(k__123499));
            
            //#line 61 "x10/util/logging/ConsoleLogFactory.x10"
            arr->x10::lang::template Rail< TPMGL(K) >::__set(
              (__extension__ ({
                  x10_long pre__123490 = i;
                  i = ((i) + (((x10_long)1ll)));
                  pre__123490;
              }))
              , k);
...
#endif // X10_UTIL_LOGGING_CONSOLELOGFACTORY_H_toRail_2346
