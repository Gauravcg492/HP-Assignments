...
template<class TPMGL(T)> class x10_util_WorkerLocalHandle__closure__2 : public ::x10::lang::Closure {
    ...
    static x10::lang::Reference* _deserialize(::x10aux::deserialization_buffer &buf) {
        ...
        buf.record_reference(storage);
        TPMGL(T) that_t__143503 = buf.read<TPMGL(T)>();
        ::x10::lang::VoidFun_0_1<TPMGL(T)>* that_op = buf.read< ::x10::lang::VoidFun_0_1<TPMGL(T)>*>();
        x10_util_WorkerLocalHandle__closure__2<TPMGL(T) >* this_ = new (storage) x10_util_WorkerLocalHandle__closure__2<TPMGL(T) >(that_t__143503, that_op);
        return this_;
    }
    
    x10_util_WorkerLocalHandle__closure__2(TPMGL(T) t__143503, ::x10::lang::VoidFun_0_1<TPMGL(T)>* op) : t__143503(t__143503), op(op) { }
...
template<class TPMGL(T)> void x10::util::WorkerLocalHandle<TPMGL(T)>::applyLocal(
  ::x10::lang::VoidFun_0_1<TPMGL(T)>* op) {
    ...
    ::x10::lang::Rail< TPMGL(T) >* localStore = ::x10aux::nullCheck(this->FMGL(state)->x10::lang::template PlaceLocalHandle< ::x10::util::WorkerLocalHandle__State<TPMGL(T)>*>::__apply())->FMGL(store);
    {
        ...
        ::x10::xrx::FinishState* fs__143521 = ::x10::xrx::Runtime::startFinish();
        try {
            {
                x10_long i__143450min__143504 = ((x10_long)0ll);
                x10_long i__143450max__143505 = (((x10_long)(::x10aux::nullCheck(localStore)->FMGL(size))) - (((x10_long)1ll)));
                {
                    x10_long i__143506;
                    for (i__143506 = i__143450min__143504;
                         ((i__143506) <= (i__143450max__143505));
                         i__143506 = ((i__143506) + (((x10_long)1ll))))
                    {
                        x10_long i__143507 = i__143506;
                        
                        //#line 72 "x10/util/WorkerLocalHandle.x10"
                        TPMGL(T) t__143503 = ::x10aux::nullCheck(localStore)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                               i__143507);
                        
                        //#line 73 "x10/util/WorkerLocalHandle.x10"
                        if ((!::x10aux::struct_equals(t__143503,
                                                      reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
                        {
                            
                            //#line 74 "x10/util/WorkerLocalHandle.x10"
                            ::x10::xrx::Runtime::runAsync(
                              reinterpret_cast< ::x10::lang::VoidFun_0_0*>((new (::x10aux::alloc< ::x10::lang::VoidFun_0_0>(sizeof(x10_util_WorkerLocalHandle__closure__2<TPMGL(T)>)))x10_util_WorkerLocalHandle__closure__2<TPMGL(T)>(t__143503, op))));
                        }
            ...
            {
                ::x10::lang::CheckedThrowable* ct__143519 =
                  __exc3057;
                {
                    ::x10::xrx::Runtime::pushException(ct__143519);
                }
            }
        }
        ::x10::xrx::Runtime::stopFinish(fs__143521);
    }
...
template<class TPMGL(T)> TPMGL(T) x10::util::WorkerLocalHandle<TPMGL(T)>::reduceLocal(
  ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* op) {
    ...
    x10_long i__143468min__143509 = ((x10_long)0ll);
    x10_long i__143468max__143510 = (((x10_long)(::x10aux::nullCheck(localStore)->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__143511;
        for (i__143511 = i__143468min__143509; ((i__143511) <= (i__143468max__143510));
             i__143511 = ((i__143511) + (((x10_long)1ll))))
        {
            x10_long i__143512 = i__143511;
            
            //#line 89 "x10/util/WorkerLocalHandle.x10"
            TPMGL(T) t__143508 = ::x10aux::nullCheck(localStore)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                   i__143512);
            
            //#line 90 "x10/util/WorkerLocalHandle.x10"
            if ((!::x10aux::struct_equals(t__143508, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
            {
...
template<class TPMGL(T)> TPMGL(T) x10::util::WorkerLocalHandle<TPMGL(T)>::reduceLocal(
  TPMGL(T) result, ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* op) {
    ...
    x10_long i__143486min__143514 = ((x10_long)0ll);
    x10_long i__143486max__143515 = (((x10_long)(::x10aux::nullCheck(localStore)->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__143516;
        for (i__143516 = i__143486min__143514; ((i__143516) <= (i__143486max__143515));
             i__143516 = ((i__143516) + (((x10_long)1ll))))
        {
            x10_long i__143517 = i__143516;
            
            //#line 111 "x10/util/WorkerLocalHandle.x10"
            TPMGL(T) t__143513 = ::x10aux::nullCheck(localStore)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                   i__143517);
            
            //#line 112 "x10/util/WorkerLocalHandle.x10"
            if ((!::x10aux::struct_equals(t__143513, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
            {
