...
class HashMap__EntriesIterator_Strings {
  public:
    static ::x10::lang::String sl__158627;
    static ::x10::lang::String sl__158628;
};
...
template<class TPMGL(Key), class TPMGL(Value)> ::x10::util::Map__Entry<TPMGL(Key), TPMGL(Value)>*
  x10::util::HashMap__EntriesIterator<TPMGL(Key), TPMGL(Value)>::next(
    ...
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::Exception::_make(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::util::HashMap__EntriesIterator_Strings::sl__158627), ((::x10aux::nullCheck(this->FMGL(map))->FMGL(modCount)) - (this->FMGL(originalModCount)))), (&::x10::util::HashMap__EntriesIterator_Strings::sl__158628)))));
    }
