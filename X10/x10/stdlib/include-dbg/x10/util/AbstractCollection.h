...
template<class TPMGL(T)> x10_boolean x10::util::AbstractCollection<TPMGL(T)>::addAllWhere(
  ::x10::util::Container<TPMGL(T)>* c, ::x10::lang::Fun_0_1<TPMGL(T), x10_boolean>* p) {
    ...
    {
        ::x10::lang::Iterator<TPMGL(T)>* x__120123;
        for (x__120123 = ::x10::util::Container<TPMGL(T)>::iterator(::x10aux::nullCheck(c));
             ::x10::lang::Iterator<TPMGL(T)>::hasNext(::x10aux::nullCheck(x__120123));
             ) {
            TPMGL(T) x = ::x10::lang::Iterator<TPMGL(T)>::next(::x10aux::nullCheck(x__120123));
...
template<class TPMGL(T)> x10_boolean x10::util::AbstractCollection<TPMGL(T)>::removeAllWhere(
  ::x10::lang::Fun_0_1<TPMGL(T), x10_boolean>* p) {
    ...
    {
        ::x10::lang::Iterator<TPMGL(T)>* x__120125;
        for (x__120125 = ::x10::util::Collection<TPMGL(T)>::iterator(::x10aux::nullCheck(reinterpret_cast< ::x10::util::Collection<TPMGL(T)>*>(this->clone())));
             ::x10::lang::Iterator<TPMGL(T)>::hasNext(::x10aux::nullCheck(x__120125));
             ) {
            TPMGL(T) x = ::x10::lang::Iterator<TPMGL(T)>::next(::x10aux::nullCheck(x__120125));
...
template<class TPMGL(T)> void x10::util::AbstractCollection<TPMGL(T)>::_constructor(
    ...
    (this)->::x10::util::AbstractContainer<TPMGL(T)>::_constructor();
    this->x10::util::template AbstractCollection<TPMGL(T)>::__fieldInitializers_x10_util_AbstractCollection();
}
