...
template<class TPMGL(T)> TPMGL(T) x10::util::concurrent::Future<TPMGL(T)>::forceLocal(
    ...
    if (((this->FMGL(exception)->x10::util::template GrowableRail< ::x10::lang::Exception*>::size()) > (((x10_long)0ll))))
    {
    ...
    try {
        {
            ...
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__120620 = ::x10::xrx::Runtime::startFinish();
            try {
                {
            ...
            catch (::x10::lang::CheckedThrowable* __exc2121) {
                {
                    ::x10::lang::CheckedThrowable* ct__120618 =
                      __exc2121;
                    {
            ...
            ::x10::xrx::Runtime::stopFinish(fs__120620);
        }
        
        //#line 75 "x10/util/concurrent/Future.x10"
        this->FMGL(latch)->release();
    }
    catch (::x10::lang::CheckedThrowable* __exc2122) {
        if (::x10aux::instanceof< ::x10::lang::Exception*>(__exc2122)) {
            ::x10::lang::Exception* t = static_cast< ::x10::lang::Exception*>(__exc2122);
            {
...
template<class TPMGL(T)> void x10::util::concurrent::Future<TPMGL(T)>::__fieldInitializers_x10_util_concurrent_Future(
    ...
    this->FMGL(exception) = ::x10::util::GrowableRail< ::x10::lang::Exception*>::_make();
    this->FMGL(result) = ::x10::util::GrowableRail<TPMGL(T)>::_make();
}
...
template<class TPMGL(T)> ::x10::util::concurrent::Future<TPMGL(T)>*
  x10::util::concurrent::Future<void>::make(::x10::lang::Fun_0_0<TPMGL(T)>* eval) {
    ...
    ::x10::util::concurrent::Future<TPMGL(T)>* f = ::x10::util::concurrent::Future<TPMGL(T)>::_make(eval);
