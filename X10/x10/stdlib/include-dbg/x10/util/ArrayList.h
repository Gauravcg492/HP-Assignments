...
class ArrayList_Strings {
  public:
    static ::x10::lang::String sl__157821;
    static ::x10::lang::String sl__157822;
    static ::x10::lang::String sl__157823;
    static ::x10::lang::String sl__157819;
    static ::x10::lang::String sl__157820;
    static ::x10::lang::String sl__157824;
};
...
template<class TPMGL(T)> x10_boolean x10::util::ArrayList<TPMGL(T)>::contains(
  TPMGL(T) v) {
    ...
    x10_long i__120489min__120560 = ((x10_long)0ll);
    x10_long i__120489max__120561 = ((::x10aux::nullCheck(this->FMGL(a))->x10::util::template GrowableRail<TPMGL(T)>::size()) - (((x10_long)1ll)));
    {
        x10_long i__120562;
        for (i__120562 = i__120489min__120560; ((i__120562) <= (i__120489max__120561));
             i__120562 = ((i__120562) + (((x10_long)1ll)))) {
            x10_long i__120563 = i__120562;
...
template<class TPMGL(T)> x10_boolean x10::util::ArrayList<TPMGL(T)>::remove(
  TPMGL(T) v) {
    ...
    x10_long i__120507min__120564 = ((x10_long)0ll);
    x10_long i__120507max__120565 = ((::x10aux::nullCheck(this->FMGL(a))->x10::util::template GrowableRail<TPMGL(T)>::size()) - (((x10_long)1ll)));
    {
        x10_long i__120566;
        for (i__120566 = i__120507min__120564; ((i__120566) <= (i__120507max__120565));
             i__120566 = ((i__120566) + (((x10_long)1ll))))
        {
            x10_long i__120567 = i__120566;
...
template<class TPMGL(T)> ::x10::util::List<x10_long>* x10::util::ArrayList<TPMGL(T)>::indices(
    ...
    x10_long i__120525min__120568 = ((x10_long)0ll);
    x10_long i__120525max__120569 = ((::x10aux::nullCheck(this->FMGL(a))->x10::util::template GrowableRail<TPMGL(T)>::size()) - (((x10_long)1ll)));
    {
        x10_long i__120570;
        for (i__120570 = i__120525min__120568; ((i__120570) <= (i__120525max__120569));
             i__120570 = ((i__120570) + (((x10_long)1ll))))
        {
            x10_long i__120571 = i__120570;
...
template<class TPMGL(T)> void x10::util::ArrayList<TPMGL(T)>::resize(
  x10_long newSize, TPMGL(T) value) {
    ...
    if (((newSize) > (oldSize))) {
        ...
        x10_long i__120543min__120572 = oldSize;
        x10_long i__120543max__120573 = ((newSize) - (((x10_long)1ll)));
        {
            x10_long i__120574;
            for (i__120574 = i__120543min__120572; ((i__120574) <= (i__120543max__120573));
                 i__120574 = ((i__120574) + (((x10_long)1ll))))
            {
                x10_long i__120575 = i__120574;
...
template<class TPMGL(T)> ::x10::lang::String* x10::util::ArrayList<TPMGL(T)>::toString(
    ...
    sb->add((&::x10::util::ArrayList_Strings::sl__157819));
    ...
    //#line 289 "x10/util/ArrayList.x10"
    {
        ...
        for (i = ((x10_long)0ll); ((i) < (sz)); i = ((i) + (((x10_long)1ll))))
        {
            ...
            if (((i) > (((x10_long)0ll)))) {
                sb->add((&::x10::util::ArrayList_Strings::sl__157820));
            }
            
            //#line 291 "x10/util/ArrayList.x10"
            sb->add(::x10::lang::String::__plus((&::x10::util::ArrayList_Strings::sl__157821), this->__apply(
                                                                                                 i)));
        }
    }
    ...
    if (((sz) < (this->size()))) {
        sb->add(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::util::ArrayList_Strings::sl__157822), ((this->size()) - (sz))), (&::x10::util::ArrayList_Strings::sl__157823)));
    }
    
    //#line 294 "x10/util/ArrayList.x10"
    sb->add((&::x10::util::ArrayList_Strings::sl__157824));
