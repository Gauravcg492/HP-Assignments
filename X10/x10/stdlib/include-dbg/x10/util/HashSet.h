...
template<class TPMGL(T)> ::x10::util::Container<TPMGL(T)>*
  x10::util::HashSet<TPMGL(T)>::clone() {
    ...
    {
        ::x10::lang::Iterator< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>* e__123489;
        for (e__123489 = ::x10::util::Set< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>::iterator(::x10aux::nullCheck(::x10::util::Map<TPMGL(T), x10_boolean>::entries(::x10aux::nullCheck(this->FMGL(map)))));
             ::x10::lang::Iterator< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>::hasNext(::x10aux::nullCheck(e__123489));
             ) {
            ::x10::util::Map__Entry<TPMGL(T), x10_boolean>* e =
              ::x10::lang::Iterator< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>::next(::x10aux::nullCheck(e__123489));
