...
template<class TPMGL(T)> x10_boolean x10::util::AbstractContainer<TPMGL(T)>::containsAll(
  ::x10::util::Container<TPMGL(T)>* c) {
    ...
    {
        ::x10::lang::Iterator<TPMGL(T)>* x__120127;
        for (x__120127 = ::x10::util::Container<TPMGL(T)>::iterator(::x10aux::nullCheck(c));
             ::x10::lang::Iterator<TPMGL(T)>::hasNext(::x10aux::nullCheck(x__120127));
             ) {
            TPMGL(T) x = ::x10::lang::Iterator<TPMGL(T)>::next(::x10aux::nullCheck(x__120127));
...
template<class TPMGL(T)> void x10::util::AbstractContainer<TPMGL(T)>::_constructor(
    ...
    this->x10::util::template AbstractContainer<TPMGL(T)>::__fieldInitializers_x10_util_AbstractContainer();
}
