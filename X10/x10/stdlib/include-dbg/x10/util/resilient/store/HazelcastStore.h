...
class HazelcastStore_Strings {
  public:
    static ::x10::lang::String sl__160228;
    static ::x10::lang::String sl__160226;
    static ::x10::lang::String sl__160225;
    static ::x10::lang::String sl__160227;
};
...
template<class TPMGL(V)> void x10::util::resilient::store::HazelcastStore<TPMGL(V)>::_constructor(
    ...
    this->x10::util::resilient::store::template HazelcastStore<TPMGL(V)>::__fieldInitializers_x10_util_resilient_store_HazelcastStore();
    ...
    this->FMGL(map) = ::x10::util::resilient::ResilientMap<void, void>::template getMap< ::x10::lang::String*,
                      TPMGL(V) >(::x10::lang::String::__plus((&::x10::util::resilient::store::HazelcastStore_Strings::sl__160225), name));
    ...
    this->FMGL(log) = ::x10::util::resilient::ResilientMap<void, void>::template getMap< ::x10::lang::String*,
                      ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>* >(
                        ::x10::lang::String::__plus((&::x10::util::resilient::store::HazelcastStore_Strings::sl__160226), name));
...
template<class TPMGL(V)> ::x10::lang::String* x10::util::resilient::store::HazelcastStore<TPMGL(V)>::k(
  ::x10::lang::Place place, ::x10::lang::String* key) {
    return ::x10::lang::String::__plus(::x10::lang::String::__plus(((::x10aux::nullCheck(this->FMGL(group))->indexOf(
                                                                       place)) << (0x3f & (x10_int)(((x10_long)32ll)))), (&::x10::util::resilient::store::HazelcastStore_Strings::sl__160227)), key);
...
template<class TPMGL(V)> void x10::util::resilient::store::HazelcastStore<TPMGL(V)>::set2(
  ...
  ::x10::lang::String* key2, TPMGL(V) value2) {
    ...
    ::x10aux::nullCheck(this->FMGL(log))->set(k1, ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>::_make(k1,
                                                                                                                           value,
                                                                                                                           k2,
                                                                                                                           value2));
...
template<class TPMGL(V)> void x10::util::resilient::store::HazelcastStore<TPMGL(V)>::updateForChangedPlaces(
  ::x10::util::resilient::PlaceManager__ChangeDescription changes) {
    ...
    {
        ::x10::lang::Iterator< ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>*>* entry__133573;
        for (entry__133573 = ::x10::util::Collection< ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>*>::iterator(::x10aux::nullCheck(::x10aux::nullCheck(this->FMGL(log))->values()));
             ::x10::lang::Iterator< ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>*>::hasNext(::x10aux::nullCheck(entry__133573));
             ) {
            ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>* entry =
              ::x10::lang::Iterator< ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>*>::next(::x10aux::nullCheck(entry__133573));
            
            //#line 81 "x10/util/resilient/store/HazelcastStore.x10"
            ::x10::io::Console::FMGL(ERR__get)()->x10::io::Printer::println(
              reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((&::x10::util::resilient::store::HazelcastStore_Strings::sl__160228), ::x10aux::nullCheck(entry)->FMGL(key))));
