...
class Store_Strings {
  public:
    static ::x10::lang::String sl__160251;
    static ::x10::lang::String sl__160252;
};
...
template<class TPMGL(V)> class x10_util_resilient_store_Store__closure__1 : public ::x10::lang::Closure {
    ...
    static x10::lang::Reference* _deserialize(::x10aux::deserialization_buffer &buf) {
        ...
        x10_util_resilient_store_Store__closure__1<TPMGL(V) >* this_ = new (storage) x10_util_resilient_store_Store__closure__1<TPMGL(V) >(that_key, that_saved_this);
        return this_;
    }
    
    x10_util_resilient_store_Store__closure__1(::x10::lang::String* key, ::x10::util::resilient::store::Store<TPMGL(V)>* saved_this) : key(key), saved_this(saved_this) { }
...
template<class TPMGL(V)> class x10_util_resilient_store_Store__closure__2 : public ::x10::lang::Closure {
    ...
    static x10::lang::Reference* _deserialize(::x10aux::deserialization_buffer &buf) {
        ...
        ::x10::util::resilient::store::Store<TPMGL(V)>* that_saved_this = buf.read< ::x10::util::resilient::store::Store<TPMGL(V)>*>();
        x10_util_resilient_store_Store__closure__2<TPMGL(V) >* this_ = new (storage) x10_util_resilient_store_Store__closure__2<TPMGL(V) >(that_key, that_value, that_saved_this);
        return this_;
    }
    
    x10_util_resilient_store_Store__closure__2(::x10::lang::String* key, TPMGL(V) value, ::x10::util::resilient::store::Store<TPMGL(V)>* saved_this) : key(key), value(value), saved_this(saved_this) { }
...
template<class TPMGL(V)> TPMGL(V) x10::util::resilient::store::Store<TPMGL(V)>::getRemote(
  ::x10::lang::Place place, ::x10::lang::String* key) {
    return ::x10::xrx::Runtime::template evalAt< TPMGL(V) >(place,
                                                            reinterpret_cast< ::x10::lang::Fun_0_0<TPMGL(V)>*>((new (::x10aux::alloc< ::x10::lang::Fun_0_0<TPMGL(V)> >(sizeof(x10_util_resilient_store_Store__closure__1<TPMGL(V)>)))x10_util_resilient_store_Store__closure__1<TPMGL(V)>(key, this))),
...
template<class TPMGL(V)> void x10::util::resilient::store::Store<TPMGL(V)>::setRemote(
  ::x10::lang::Place place, ::x10::lang::String* key, TPMGL(V) value) {
    {
        ::x10::xrx::Runtime::runAt(place, reinterpret_cast< ::x10::lang::VoidFun_0_0*>((new (::x10aux::alloc< ::x10::lang::VoidFun_0_0>(sizeof(x10_util_resilient_store_Store__closure__2<TPMGL(V)>)))x10_util_resilient_store_Store__closure__2<TPMGL(V)>(key, value, this))),
                                   ::x10aux::class_cast_unchecked< ::x10::xrx::Runtime__Profile*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    }
}
...
template<class TPMGL(V)> void x10::util::resilient::store::Store<TPMGL(V)>::_constructor(
    ...
    this->x10::util::resilient::store::template Store<TPMGL(V)>::__fieldInitializers_x10_util_resilient_store_Store();
}
...
template<class TPMGL(V)> ::x10::util::resilient::store::Store<TPMGL(V)>*
  x10::util::resilient::store::Store<void>::make(::x10::lang::String* name,
    ...
    if (::x10aux::equals((&::x10::util::resilient::store::Store_Strings::sl__160251),::x10::util::resilient::store::Store<void>::dataStore()))
    {
        
        //#line 48 "x10/util/resilient/store/Store.x10"
        return ::x10::util::resilient::store::HazelcastStore<TPMGL(V)>::_make(name,
                                                                              activePlaces);
        
    } else {
        
        //#line 50 "x10/util/resilient/store/Store.x10"
        return ::x10::util::resilient::store::NativeStore<TPMGL(V)>::_make(name,
                                                                           activePlaces);
