...
class ResilientTransactionManager_Strings {
  public:
    static ::x10::lang::String sl__160224;
};
...
#ifndef X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runTransaction_2750
#define X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runTransaction_2750
template<class TPMGL(T)> TPMGL(T) x10::util::resilient::ResilientTransactionManager::runTransaction(
  ::x10::lang::Fun_0_1< ::x10::util::resilient::ResilientTransactionManager*, TPMGL(T)>* run) {
    ...
    ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::Exception::_make((&::x10::util::resilient::ResilientTransactionManager_Strings::sl__160224))));
}
#endif // X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runTransaction_2750
#ifndef X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runLocalTransaction_2751
#define X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runLocalTransaction_2751
...
#endif // X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runLocalTransaction_2751
#ifndef X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_getMap_2752
#define X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_getMap_2752
...
#endif // X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_getMap_2752
