...
template<class TPMGL(T)> class x10_util_foreach_Cyclic__closure__2 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        TPMGL(T) myRes__122278 = identity;
        
        //#line 66 "x10/util/foreach/Cyclic.x10"
        {
            x10_long i__122279;
            for (i__122279 = ((min) + (t__122283)); ((i__122279) <= (max));
                 i__122279 = ((i__122279) + (((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)())))))
            {
                
                //#line 67 "x10/util/foreach/Cyclic.x10"
                myRes__122278 = ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>::__apply(::x10aux::nullCheck(reduce), 
                  myRes__122278, ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>::__apply(::x10aux::nullCheck(body), 
                    i__122279));
            }
        }
    ...
    static x10::lang::Reference* _deserialize(::x10aux::deserialization_buffer &buf) {
        ...
        x10_long that_t__122283 = buf.read<x10_long>();
        ...
        x10_util_foreach_Cyclic__closure__2<TPMGL(T) >* this_ = new (storage) x10_util_foreach_Cyclic__closure__2<TPMGL(T) >(that_identity, that_min, that_t__122283, that_max, that_body, that_reduce, that_results);
        return this_;
    }
    
    x10_util_foreach_Cyclic__closure__2(TPMGL(T) identity, x10_long min, x10_long t__122283, x10_long max, ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>* body, ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* reduce, ::x10::lang::Rail< TPMGL(T) >* results) : identity(identity), min(min), t__122283(t__122283), max(max), body(body), reduce(reduce), results(results) { }
...
#ifndef X10_UTIL_FOREACH_CYCLIC_H__kwd__for_2243
#define X10_UTIL_FOREACH_CYCLIC_H__kwd__for_2243
template<class TPMGL(T)> TPMGL(T) x10::util::foreach::Cyclic::_kwd__for(::x10::lang::LongRange range,
    ...
    if ((::x10aux::struct_equals(::x10::xrx::Runtime::FMGL(NTHREADS__get)(),
        ...
        ::x10::lang::Rail< TPMGL(T) >* results = ::x10::lang::Rail< TPMGL(T) >::_makeUnsafe(((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)())), false);
        {
            ...
            try {
                {
                    x10_long i__122238min__122280 = ((x10_long)0ll);
                    x10_long i__122238max__122281 = ((((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)()))) - (((x10_long)1ll)));
                    {
                        x10_long i__122282;
                        for (i__122282 = i__122238min__122280;
                             ((i__122282) <= (i__122238max__122281));
                             i__122282 = ((i__122282) + (((x10_long)1ll))))
                        {
                            x10_long t__122283 = i__122282;
                            ::x10::xrx::Runtime::runAsync(
                              reinterpret_cast< ::x10::lang::VoidFun_0_0*>((new (::x10aux::alloc< ::x10::lang::VoidFun_0_0>(sizeof(x10_util_foreach_Cyclic__closure__2<TPMGL(T)>)))x10_util_foreach_Cyclic__closure__2<TPMGL(T)>(identity, min, t__122283, max, body, reduce, results))));
                        }
                    }
                    
                }
            }
            catch (::x10::lang::CheckedThrowable* __exc2244) {
                {
        ...
        x10_long i__122256min__122284 = ((x10_long)1ll);
        x10_long i__122256max__122285 = ((((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)()))) - (((x10_long)1ll)));
        {
            x10_long i__122286;
            for (i__122286 = i__122256min__122284; ((i__122286) <= (i__122256max__122285));
                 i__122286 = ((i__122286) + (((x10_long)1ll))))
            {
                x10_long myT__122287 = i__122286;
...
#endif // X10_UTIL_FOREACH_CYCLIC_H__kwd__for_2243
