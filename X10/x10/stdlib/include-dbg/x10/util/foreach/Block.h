...
template<class TPMGL(T)> class x10_util_foreach_Block__closure__4 : public ::x10::lang::Closure {
    ...
    TPMGL(T) __apply(::x10::lang::LongRange range){
        ...
        ::x10::lang::LongRange i__122049domain__122103 = range;
        x10_long i__122049min__122104 = i__122049domain__122103->FMGL(min);
        x10_long i__122049max__122105 = i__122049domain__122103->FMGL(max);
        {
            x10_long i__122106;
            for (i__122106 = i__122049min__122104; ((i__122106) <= (i__122049max__122105));
                 i__122106 = ((i__122106) + (((x10_long)1ll)))) {
                x10_long i__122107 = i__122106;
...
#ifndef X10_UTIL_FOREACH_BLOCK_H__kwd__for_2229
#define X10_UTIL_FOREACH_BLOCK_H__kwd__for_2229
...
#endif // X10_UTIL_FOREACH_BLOCK_H__kwd__for_2229
#ifndef X10_UTIL_FOREACH_BLOCK_H__kwd__for_2230
#define X10_UTIL_FOREACH_BLOCK_H__kwd__for_2230
  ...
  TPMGL(T) identity, ::x10::lang::Fun_0_2<x10_long, x10_long, TPMGL(T)>* body) {
    ...
    if ((::x10aux::struct_equals(::x10::xrx::Runtime::FMGL(NTHREADS__get)(),
        ...
        ::x10::lang::Rail< TPMGL(T) >* results = ::x10::lang::Rail< TPMGL(T) >::_makeUnsafe(((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)())), false);
        {
            ...
            ::x10::xrx::FinishState* fs__122129 = ::x10::xrx::Runtime::startFinish();
            try {
                {
                    {
                        x10_long t;
            ...
            catch (::x10::lang::CheckedThrowable* __exc2231) {
                {
                    ::x10::lang::CheckedThrowable* ct__122127 =
                      __exc2231;
                    {
            ...
            ::x10::xrx::Runtime::stopFinish(fs__122129);
        }
        ...
        x10_long i__122068min__122108 = ((x10_long)1ll);
        x10_long i__122068max__122109 = ((((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)()))) - (((x10_long)1ll)));
        {
            x10_long i__122110;
            for (i__122110 = i__122068min__122108; ((i__122110) <= (i__122068max__122109));
                 i__122110 = ((i__122110) + (((x10_long)1ll))))
            {
                x10_long myT__122111 = i__122110;
...
#endif // X10_UTIL_FOREACH_BLOCK_H__kwd__for_2230
  ...
  ::x10::lang::Fun_0_1< ::x10::lang::LongRange, TPMGL(T)>* body) {
    ...
    if ((::x10aux::struct_equals(nthreads, ((x10_int)1))))
    {
        ...
        ::x10::lang::Rail< TPMGL(T) >* results = ::x10::lang::Rail< TPMGL(T) >::_makeUnsafe(((x10_long)(nthreads)), false);
        {
            ...
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__122134 = ::x10::xrx::Runtime::startFinish();
            try {
                {
                    {
                        x10_long t;
            ...
            catch (::x10::lang::CheckedThrowable* __exc2233) {
                {
                    ::x10::lang::CheckedThrowable* ct__122132 =
                      __exc2233;
                    {
                        ::x10::xrx::Runtime::pushException(
                          ct__122132);
            ...
            ::x10::xrx::Runtime::stopFinish(fs__122134);
        }
        ...
        x10_long i__122086min__122112 = ((x10_long)1ll);
        x10_long i__122086max__122113 = ((((x10_long)(nthreads))) - (((x10_long)1ll)));
        {
            x10_long i__122114;
            for (i__122114 = i__122086min__122112; ((i__122114) <= (i__122086max__122113));
                 i__122114 = ((i__122114) + (((x10_long)1ll))))
            {
                x10_long myT__122115 = i__122114;
