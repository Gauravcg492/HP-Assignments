...
template<class TPMGL(T)> class x10_util_foreach_Bisect__closure__3 : public ::x10::lang::Closure {
    ...
    TPMGL(T) __apply(::x10::lang::LongRange range){
        ...
        ::x10::lang::LongRange i__121585domain__121708 = range;
        x10_long i__121585min__121709 = i__121585domain__121708->FMGL(min);
        x10_long i__121585max__121710 = i__121585domain__121708->FMGL(max);
        {
            x10_long i__121711;
            for (i__121711 = i__121585min__121709; ((i__121711) <= (i__121585max__121710));
                 i__121711 = ((i__121711) + (((x10_long)1ll)))) {
                x10_long i__121712 = i__121711;
...
template<class TPMGL(T)> class x10_util_foreach_Bisect__closure__8 : public ::x10::lang::Closure {
    ...
    TPMGL(T) __apply(x10_long min0, x10_long max0, x10_long min1, x10_long max1){
        ...
        x10_long i__121686min__121726 = min0;
        x10_long i__121686max__121727 = max0;
        {
            x10_long i__121728;
            for (i__121728 = i__121686min__121726; ((i__121728) <= (i__121686max__121727));
                 i__121728 = ((i__121728) + (((x10_long)1ll)))) {
                x10_long i__121729 = i__121728;
                
                //#line 318 "x10/util/foreach/Bisect.x10"
                x10_long i__121668min__121722 = min1;
                x10_long i__121668max__121723 = max1;
                {
                    x10_long i__121724;
                    for (i__121724 = i__121668min__121722; ((i__121724) <= (i__121668max__121723));
                         i__121724 = ((i__121724) + (((x10_long)1ll))))
                    {
                        x10_long j__121725 = i__121724;
...
#ifndef X10_UTIL_FOREACH_BISECT_H__kwd__for_2197
#define X10_UTIL_FOREACH_BISECT_H__kwd__for_2197
...
#endif // X10_UTIL_FOREACH_BISECT_H__kwd__for_2197
#ifndef X10_UTIL_FOREACH_BISECT_H__kwd__for_2198
#define X10_UTIL_FOREACH_BISECT_H__kwd__for_2198
...
#endif // X10_UTIL_FOREACH_BISECT_H__kwd__for_2198
#ifndef X10_UTIL_FOREACH_BISECT_H__kwd__for_2199
#define X10_UTIL_FOREACH_BISECT_H__kwd__for_2199
template<class TPMGL(T)> TPMGL(T) x10::util::foreach::Bisect::_kwd__for(
...
#endif // X10_UTIL_FOREACH_BISECT_H__kwd__for_2199
...
#ifndef X10_UTIL_FOREACH_BISECT_H_doBisectReduce1D_2201
#define X10_UTIL_FOREACH_BISECT_H_doBisectReduce1D_2201
  ...
  ::x10::lang::Fun_0_1< ::x10::lang::LongRange, TPMGL(T)>* body) {
    ...
    if (((((end) - (start))) > (grainSize))) {
        ...
        TPMGL(T) syncResult;
        {
            ...
            ::x10::xrx::FinishState* fs__121742 = ::x10::xrx::Runtime::startFinish();
            try {
                {
            ...
            catch (::x10::lang::CheckedThrowable* __exc2202) {
                {
                    ::x10::lang::CheckedThrowable* ct__121740 =
                      __exc2202;
                    {
            ...
            ::x10::xrx::Runtime::stopFinish(fs__121742);
        }
...
#endif // X10_UTIL_FOREACH_BISECT_H_doBisectReduce1D_2201
#ifndef X10_UTIL_FOREACH_BISECT_H__kwd__for_2209
#define X10_UTIL_FOREACH_BISECT_H__kwd__for_2209
template<class TPMGL(T)> TPMGL(T) x10::util::foreach::Bisect::_kwd__for(
...
#endif // X10_UTIL_FOREACH_BISECT_H__kwd__for_2209
#ifndef X10_UTIL_FOREACH_BISECT_H__kwd__for_2210
#define X10_UTIL_FOREACH_BISECT_H__kwd__for_2210
template<class TPMGL(T)> TPMGL(T) x10::util::foreach::Bisect::_kwd__for(
...
#endif // X10_UTIL_FOREACH_BISECT_H__kwd__for_2210
#ifndef X10_UTIL_FOREACH_BISECT_H_doBisectReduce2D_2211
#define X10_UTIL_FOREACH_BISECT_H_doBisectReduce2D_2211
  ...
  ::x10::lang::Fun_0_4<x10_long, x10_long, x10_long, x10_long, TPMGL(T)>* body) {
                                      ...
                                      ((((e1) - (s1))) <= (g2))))))
    {
        ...
        TPMGL(T) syncResult;
        {
            ...
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__121753 = ::x10::xrx::Runtime::startFinish();
            try {
                {
            ...
            catch (::x10::lang::CheckedThrowable* __exc2212) {
                {
                    ::x10::lang::CheckedThrowable* ct__121751 =
                      __exc2212;
                    {
                        ::x10::xrx::Runtime::pushException(
                          ct__121751);
            ...
            ::x10::xrx::Runtime::stopFinish(fs__121753);
        }
    ...
    if (((((e1) - (s1))) > (g2))) {
        ...
        TPMGL(T) syncResult;
        {
            ...
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__121758 = ::x10::xrx::Runtime::startFinish();
            try {
                {
            ...
            catch (::x10::lang::CheckedThrowable* __exc2213) {
                {
                    ::x10::lang::CheckedThrowable* ct__121756 =
                      __exc2213;
                    {
                        ::x10::xrx::Runtime::pushException(
                          ct__121756);
            ...
            ::x10::xrx::Runtime::stopFinish(fs__121758);
        }
...
#endif // X10_UTIL_FOREACH_BISECT_H_doBisectReduce2D_2211
