...
class Mat_Strings {
  public:
    static ::x10::lang::String sl__156567;
    static ::x10::lang::String sl__156568;
};
...
template<class TPMGL(T)> void x10::regionarray::Mat<TPMGL(T)>::printInfo(
  ::x10::io::Printer* ps, ::x10::lang::String* label) {
    ...
    ::x10aux::nullCheck(ps)->printf((&::x10::regionarray::Mat_Strings::sl__156567),
    ...
    {
        ::x10::lang::Iterator<TPMGL(T)>* r__115306;
        for (r__115306 = this->iterator(); ::x10::lang::Iterator<TPMGL(T)>::hasNext(::x10aux::nullCheck(r__115306));
             ) {
            ::x10::regionarray::Row* r = reinterpret_cast< ::x10::regionarray::Row*>(::x10::lang::Iterator<TPMGL(T)>::next(::x10aux::nullCheck(r__115306)));
            
            //#line 34 "x10/regionarray/Mat.x10"
            ::x10aux::nullCheck(ps)->printf((&::x10::regionarray::Mat_Strings::sl__156568));
