...
template<class TPMGL(T)> ::x10::glb::ArrayListTaskBag<TPMGL(T)>* x10::glb::ArrayListTaskBag<TPMGL(T)>::split(
    ...
    ::x10::glb::ArrayListTaskBag<TPMGL(T)>* o = ::x10::glb::ArrayListTaskBag<TPMGL(T)>::_make();
    
    //#line 44 "x10/glb/ArrayListTaskBag.x10"
    x10_long i__101090min__101107 = ((x10_long)1ll);
    x10_long i__101090max__101108 = size;
    {
        x10_long i__101109;
        for (i__101109 = i__101090min__101107; ((i__101109) <= (i__101090max__101108));
             i__101109 = ((i__101109) + (((x10_long)1ll))))
        {
            x10_long i__101110 = i__101109;
...
template<class TPMGL(T)> ::x10::util::ArrayList<TPMGL(T)>*
  x10::glb::ArrayListTaskBag<TPMGL(T)>::bag() {
...
template<class TPMGL(T)> void x10::glb::ArrayListTaskBag<TPMGL(T)>::_constructor(
    ...
    this->x10::glb::template ArrayListTaskBag<TPMGL(T)>::__fieldInitializers_x10_glb_ArrayListTaskBag();
}
...
template<class TPMGL(T)> void x10::glb::ArrayListTaskBag<TPMGL(T)>::__fieldInitializers_x10_glb_ArrayListTaskBag(
    ...
    this->FMGL(bag) = ::x10::util::ArrayList<TPMGL(T)>::_make();
}
