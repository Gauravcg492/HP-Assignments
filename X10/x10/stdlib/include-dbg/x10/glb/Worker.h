...
class Worker_Strings {
  public:
    static ::x10::lang::String sl__154471;
};
...
template<class TPMGL(Queue), class TPMGL(R)> void x10::glb::Worker<TPMGL(Queue), TPMGL(R)>::give(
  ...
  ::x10::glb::TaskBag* loot) {
    ...
    ::x10::glb::Logger* obj__103746 = this->FMGL(logger);
    ::x10aux::nullCheck(obj__103746)->FMGL(nodesGiven) = ((::x10aux::nullCheck(obj__103746)->FMGL(nodesGiven)) + (::x10::glb::TaskBag::size(::x10aux::nullCheck(loot))));
    ...
    if (((::x10aux::nullCheck(this->FMGL(thieves))->x10::glb::template FixedSizeStack<x10_long>::size()) > (((x10_long)0ll))))
    {
        ...
        if (((thief) >= (((x10_long)0ll)))) {
            ...
            ::x10::glb::Logger* obj__103743 = this->FMGL(logger);
            ::x10aux::nullCheck(obj__103743)->FMGL(lifelineStealsSuffered) =
              ((::x10aux::nullCheck(obj__103743)->FMGL(lifelineStealsSuffered)) + (((x10_long)1ll)));
            ...
            ::x10::glb::Logger* obj__103744 = this->FMGL(logger);
            ::x10aux::nullCheck(obj__103744)->FMGL(stealsSuffered) =
              ((::x10aux::nullCheck(obj__103744)->FMGL(stealsSuffered)) + (((x10_long)1ll)));
        ...
        ::x10::glb::Logger* obj__103745 = this->FMGL(logger);
        ::x10aux::nullCheck(obj__103745)->FMGL(lifelineStealsSuffered) =
          ((::x10aux::nullCheck(obj__103745)->FMGL(lifelineStealsSuffered)) + (((x10_long)1ll)));
  ...
  ::x10::lang::PlaceLocalHandle< ::x10::glb::Worker<TPMGL(Queue), TPMGL(R)>*> st) {
    ...
    //#line 225 "x10/glb/Worker.x10"
    {
                                                        ...
                                                        ((i) + (((x10_long)1ll))))
        {
            ...
            ::x10::glb::Logger* obj__103747 = this->FMGL(logger);
            ::x10aux::nullCheck(obj__103747)->FMGL(stealsAttempted) =
              ((::x10aux::nullCheck(obj__103747)->FMGL(stealsAttempted)) + (((x10_long)1ll)));
    ...
    //#line 234 "x10/glb/Worker.x10"
    {
        ...
        for (i = ((x10_long)0ll); ((((i) < ((x10_long)(::x10aux::nullCheck(this->FMGL(lifelines))->FMGL(size)))) &&
            ...
            if (!(::x10aux::nullCheck(this->FMGL(lifelinesActivated))->x10::lang::template Rail< x10_boolean >::__apply(
                ...
                ::x10::glb::Logger* obj__103748 = this->FMGL(logger);
                ::x10aux::nullCheck(obj__103748)->FMGL(lifelineStealsAttempted) =
                  ((::x10aux::nullCheck(obj__103748)->FMGL(lifelineStealsAttempted)) + (((x10_long)1ll)));
...
template<class TPMGL(Queue), class TPMGL(R)> void x10::glb::Worker<TPMGL(Queue), TPMGL(R)>::request(
  ...
  x10_long thief, x10_boolean lifeline) {
    ...
    try {
        ...
        if (lifeline) {
            ::x10::glb::Logger* obj__103749 = this->FMGL(logger);
            ::x10aux::nullCheck(obj__103749)->FMGL(lifelineStealsReceived) =
              ((::x10aux::nullCheck(obj__103749)->FMGL(lifelineStealsReceived)) + (((x10_long)1ll)));
        } else {
            ::x10::glb::Logger* obj__103750 = this->FMGL(logger);
            ::x10aux::nullCheck(obj__103750)->FMGL(stealsReceived) =
              ((::x10aux::nullCheck(obj__103750)->FMGL(stealsReceived)) + (((x10_long)1ll)));
        }
...
template<class TPMGL(Queue), class TPMGL(R)> void x10::glb::Worker<TPMGL(Queue), TPMGL(R)>::processLoot(
  ::x10::glb::TaskBag* loot, x10_boolean lifeline) {
    ...
    if (lifeline) {
        ...
        ::x10::glb::Logger* obj__103751 = this->FMGL(logger);
        ::x10aux::nullCheck(obj__103751)->FMGL(lifelineStealsPerpetrated) =
          ((::x10aux::nullCheck(obj__103751)->FMGL(lifelineStealsPerpetrated)) + (((x10_long)1ll)));
        
        //#line 279 "x10/glb/Worker.x10"
        ::x10::glb::Logger* obj__103752 = this->FMGL(logger);
        ::x10aux::nullCheck(obj__103752)->FMGL(lifelineNodesReceived) =
          ((::x10aux::nullCheck(obj__103752)->FMGL(lifelineNodesReceived)) + (n));
    } else {
        
        //#line 281 "x10/glb/Worker.x10"
        ::x10::glb::Logger* obj__103753 = this->FMGL(logger);
        ::x10aux::nullCheck(obj__103753)->FMGL(stealsPerpetrated) =
          ((::x10aux::nullCheck(obj__103753)->FMGL(stealsPerpetrated)) + (((x10_long)1ll)));
        
        //#line 282 "x10/glb/Worker.x10"
        ::x10::glb::Logger* obj__103754 = this->FMGL(logger);
        ::x10aux::nullCheck(obj__103754)->FMGL(nodesReceived) =
          ((::x10aux::nullCheck(obj__103754)->FMGL(nodesReceived)) + (n));
    }
  ...
  ::x10::lang::VoidFun_0_0* start) {
    {
        ...
        ::x10::xrx::FinishState* fs__103782 = ::x10::xrx::Runtime::startFinish(
        ...
        try {
            ...
            {
                ::x10::lang::CheckedThrowable* ct__103779 =
                  __exc522;
                {
                    ::x10::xrx::Runtime::pushException(ct__103779);
                }
            }
        }
        ::x10::xrx::Runtime::stopFinish(fs__103782);
    }
}
...
template<class TPMGL(Queue), class TPMGL(R)> void x10::glb::Worker<void, void>::broadcast(::x10::lang::PlaceLocalHandle< ::x10::glb::Worker<TPMGL(Queue), TPMGL(R)>*> st) {
    ...
    x10_long P = ((x10_long)x10rt_nhosts());
    {
        ...
        ::x10::xrx::Runtime::ensureNotInAtomic();
        ::x10::xrx::FinishState* fs__103796 = ::x10::xrx::Runtime::startFinish(
                                                ::x10::compiler::Pragma::FMGL(FINISH_DENSE__get)());
        try {
            {
            ...
            {
                ::x10::lang::CheckedThrowable* ct__103793 =
                  __exc529;
                {
                    ::x10::xrx::Runtime::pushException(ct__103793);
                }
            }
        }
        ::x10::xrx::Runtime::stopFinish(fs__103796);
    }
}
template<class TPMGL(Queue), class TPMGL(R)> void x10::glb::Worker<void, void>::initContexts(::x10::lang::PlaceLocalHandle< ::x10::glb::Worker<TPMGL(Queue), TPMGL(R)>*> st) {
    ...
    x10_long P = ((x10_long)x10rt_nhosts());
    {
        ...
        ::x10::xrx::Runtime::ensureNotInAtomic();
        ::x10::xrx::FinishState* fs__103810 = ::x10::xrx::Runtime::startFinish(
                                                ::x10::compiler::Pragma::FMGL(FINISH_DENSE__get)());
        try {
            {
            ...
            {
                ::x10::lang::CheckedThrowable* ct__103807 =
                  __exc530;
                {
                    ::x10::xrx::Runtime::pushException(ct__103807);
                }
            }
        }
        ::x10::xrx::Runtime::stopFinish(fs__103810);
    }
}
