...
template<class TPMGL(T)> void x10::xrx::FinishState__StatefulReducer<TPMGL(T)>::_constructor(
    ...
    x10_long i__154606max__162369 = (((x10_long)(::x10aux::nullCheck(this->FMGL(resultRail))->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__162370;
        for (i__162370 = ((x10_long)0ll); ((i__162370) <= (i__154606max__162369));
             i__162370 = ((i__162370) + (((x10_long)1ll))))
        {
