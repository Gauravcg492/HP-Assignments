...
template<class TPMGL(T)> class x10_xrx_FinishState__CollectingFinish__closure__23 : public ::x10::lang::Closure {
    ...
    ::x10::xrx::FinishState__RemoteCollectingFinish<TPMGL(T)>* __apply(){
        ::x10::xrx::FinishState__RemoteCollectingFinish<TPMGL(T)>* alloc__162374 =
        ...
        (alloc__162374)->::x10::xrx::FinishState__RemoteCollectingFinish<TPMGL(T)>::_constructor(
          _ref, tmpReducer);
        return alloc__162374;
...
template<class TPMGL(T)> void x10::xrx::FinishState__CollectingFinish<TPMGL(T)>::_constructor(
    ...
    (this)->::x10::xrx::FinishState__Finish::_constructor(reinterpret_cast< ::x10::xrx::FinishState__RootFinish*>((__extension__ ({
                                                              ::x10::xrx::FinishState__RootCollectingFinish<TPMGL(T)>* alloc__154541 =
                                                                
                                                              (new (::x10aux::alloc_z< ::x10::xrx::FinishState__RootCollectingFinish<TPMGL(T)> >()) ::x10::xrx::FinishState__RootCollectingFinish<TPMGL(T)>());
                                                              (alloc__154541)->::x10::xrx::FinishState__RootCollectingFinish<TPMGL(T)>::_constructor(
                                                                reducer);
                                                              alloc__154541;
                                                          }))
                                                          ));
...
template<class TPMGL(T)> void x10::xrx::FinishState__CollectingFinish<TPMGL(T)>::_constructor(
                                 ...
                                 ((x10_long)::x10aux::here))))
    {
        ...
        this->FMGL(me) = ((__extension__ ({
            ::x10::lang::GlobalRef< ::x10::xrx::FinishState* > t__154502 =
              this->FMGL(ref);
            if (!((::x10aux::struct_equals(::x10::lang::Place::_make((t__154502)->location),
                                           ::x10::lang::Place::_make(::x10aux::here)))))
            {
                ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::xrx::FinishState__CollectingFinish_Strings::sl__172190))));
            }
            t__154502;
        }))
        )->__apply();
