...
class FinishState_Strings {
  public:
    static ::x10::lang::String sl__172024;
    static ::x10::lang::String sl__172023;
};
...
#ifndef X10_XRX_FINISHSTATE_H_deref_3285
#define X10_XRX_FINISHSTATE_H_deref_3285
template<class TPMGL(T)> TPMGL(T) x10::xrx::FinishState::deref(::x10::lang::GlobalRef< ::x10::xrx::FinishState* > root) {
    return ::x10aux::class_cast<TPMGL(T)>(((__extension__ ({
        ::x10::lang::GlobalRef< ::x10::xrx::FinishState* > t__154317 = root;
        if (!((::x10aux::struct_equals(::x10::lang::Place::_make((t__154317)->location),
                                       ::x10::lang::Place::_make(::x10aux::here)))))
        {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::xrx::FinishState_Strings::sl__172024))));
        }
        t__154317;
    }))
    )->__apply());
...
#endif // X10_XRX_FINISHSTATE_H_deref_3285
