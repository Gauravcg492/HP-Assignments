...
template<class TPMGL(T)> void x10::xrx::FinishState__RemoteCollectingFinish<TPMGL(T)>::_constructor(
    ...
    this->FMGL(sr) = (__extension__ ({
        ::x10::xrx::FinishState__StatefulReducer<TPMGL(T)>* alloc__154544 =
           (new (::x10aux::alloc_z< ::x10::xrx::FinishState__StatefulReducer<TPMGL(T)> >()) ::x10::xrx::FinishState__StatefulReducer<TPMGL(T)>());
        (alloc__154544)->::x10::xrx::FinishState__StatefulReducer<TPMGL(T)>::_constructor(
          reducer);
        alloc__154544;
    }))
    ;
...
template<class TPMGL(T)> void x10::xrx::FinishState__RemoteCollectingFinish<TPMGL(T)>::notifyActivityTermination(
    ...
    (__extension__ ({
        ::x10::util::GrowableRail< ::x10::lang::CheckedThrowable*>* this__162318 =
          this->FMGL(exceptions);
        (::x10aux::struct_equals(::x10aux::nullCheck(this__162318)->FMGL(size),
                                 ((x10_long)0ll)));
    }))
    ...
    if (((!::x10aux::struct_equals(this->FMGL(remoteActivities),
        ...
        x10_long first__162377 = ::x10::lang::Place::_make(::x10aux::here)->FMGL(id);
        x10_int second__162378 = this->FMGL(count);
        
        //#line 22 "x10/util/Pair.x10"
        message->FMGL(first) = first__162377;
        
        //#line 23 "x10/util/Pair.x10"
        message->FMGL(second) = second__162378;
