...
class RemoteArray_Strings {
  public:
    static ::x10::lang::String sl__167609;
};
...
template<class TPMGL(T)> void x10::regionarray::RemoteArray<TPMGL(T)>::_constructor(
    ...
    this->FMGL(rawData) = (__extension__ ({
        ::x10::lang::GlobalRail<TPMGL(T)> alloc__136050 =
           ::x10::lang::GlobalRail<TPMGL(T)>::_alloc();
        (alloc__136050)->::x10::lang::GlobalRail<TPMGL(T)>::_constructor(
          a->FMGL(raw));
        alloc__136050;
    }))
    ;
...
template<class TPMGL(T)> TPMGL(T) x10::regionarray::RemoteArray<TPMGL(T)>::__apply(
  x10_int i) {
    ::x10::regionarray::Array<TPMGL(T)>* this__136090 = this->x10::regionarray::template RemoteArray<TPMGL(T)>::__apply();
    x10_long i__136091 = ((x10_long)(i));
    
    //#line 442 "x10/regionarray/Array.x10"
    TPMGL(T) ret__136092;
    goto __ret__136093; __ret__136093: {
    {
        
        //#line 444 "x10/regionarray/Array.x10"
        if (::x10aux::nullCheck(this__136090)->FMGL(rail))
        {
            
            //#line 446 "x10/regionarray/Array.x10"
            ret__136092 = ::x10aux::nullCheck(this__136090)->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__apply(
                            i__136091);
            goto __ret__136093_end_;
        } else {
            
            //#line 448 "x10/regionarray/Array.x10"
            if ((true && !(::x10aux::nullCheck(this__136090)->FMGL(region)->contains(
                             i__136091)))) {
            ...
            ret__136092 = ::x10aux::nullCheck(this__136090)->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__apply(
                            ((i__136091) - (::x10aux::nullCheck(this__136090)->FMGL(layout_min0))));
            goto __ret__136093_end_;
        }
        
    }goto __ret__136093_end_; __ret__136093_end_: ;
    }
...
template<class TPMGL(T)> TPMGL(T) x10::regionarray::RemoteArray<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    ::x10::regionarray::Array<TPMGL(T)>* this__136097 = this->x10::regionarray::template RemoteArray<TPMGL(T)>::__apply();
    
    //#line 524 "x10/regionarray/Array.x10"
    if ((true && !(::x10aux::nullCheck(this__136097)->FMGL(region)->contains(
                     p)))) {
    ...
    //#line 91 "x10/regionarray/RemoteArray.x10"
    return ::x10aux::nullCheck(this__136097)->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__apply(
             (__extension__ ({
                 
                 //#line 1315 "x10/regionarray/Array.x10"
                 x10_long offset__136100 = ((::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                                               ((x10_long)(((x10_int)0))))) - (::x10aux::nullCheck(this__136097)->FMGL(layout_min0)));
                 ...
                 if (((::x10aux::nullCheck(p)->FMGL(rank)) > (((x10_long)1ll))))
                 {
                     ...
                     offset__136100 = ((((((offset__136100) * (::x10aux::nullCheck(this__136097)->FMGL(layout_stride1)))) + (::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                                                                                                                               ((x10_long)1ll))))) - (::x10aux::nullCheck(this__136097)->FMGL(layout_min1)));
                     
                     //#line 1318 "x10/regionarray/Array.x10"
                     x10_long i__124769max__136094 = ((::x10aux::nullCheck(p)->FMGL(rank)) - (((x10_long)1ll)));
                     {
                         x10_long i__136095;
                         for (i__136095 = ((x10_long)2ll);
                              ((i__136095) <= (i__124769max__136094));
                              i__136095 = ((i__136095) + (((x10_long)1ll))))
                         {
                             
                             //#line 1319 "x10/regionarray/Array.x10"
                             offset__136100 = ((((((offset__136100) * (::x10aux::nullCheck(::x10aux::nullCheck(this__136097)->FMGL(layout))->x10::lang::template Rail< x10_long >::__apply(
                                                                         ((((x10_long)2ll)) * (((i__136095) - (((x10_long)2ll))))))))) + (::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                                                                                                                                            i__136095)))) - (::x10aux::nullCheck(::x10aux::nullCheck(this__136097)->FMGL(layout))->x10::lang::template Rail< x10_long >::__apply(
                                                                                                                                                               ((((((x10_long)2ll)) * (((i__136095) - (((x10_long)2ll)))))) + (((x10_long)1ll))))));
                         }
                     }
...
template<class TPMGL(T)> TPMGL(T) x10::regionarray::RemoteArray<TPMGL(T)>::__set(
  x10_int i, TPMGL(T) v) {
    ::x10::regionarray::Array<TPMGL(T)>* this__136101 = this->x10::regionarray::template RemoteArray<TPMGL(T)>::__apply();
    x10_long i__136102 = ((x10_long)(i));
    
    //#line 545 "x10/regionarray/Array.x10"
    if (::x10aux::nullCheck(this__136101)->FMGL(rail)) {
        
        //#line 547 "x10/regionarray/Array.x10"
        ::x10aux::nullCheck(this__136101)->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__set(
          i__136102, v);
    } else {
        
        //#line 549 "x10/regionarray/Array.x10"
        if ((true && !(::x10aux::nullCheck(this__136101)->FMGL(region)->contains(
                         i__136102)))) {
        ...
        ::x10aux::nullCheck(this__136101)->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__set(
          ((i__136102) - (::x10aux::nullCheck(this__136101)->FMGL(layout_min0))),
          v);
    }
...
template<class TPMGL(T)> TPMGL(T) x10::regionarray::RemoteArray<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    ...
    ::x10::regionarray::Array<TPMGL(T)>* this__136107 = this->x10::regionarray::template RemoteArray<TPMGL(T)>::__apply();
    
    //#line 637 "x10/regionarray/Array.x10"
    if ((true && !(::x10aux::nullCheck(this__136107)->FMGL(region)->contains(
                     p)))) {
    ...
    ::x10aux::nullCheck(this__136107)->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__set(
      (__extension__ ({
          
          //#line 1315 "x10/regionarray/Array.x10"
          x10_long offset__136111 = ((::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                                        ((x10_long)(((x10_int)0))))) - (::x10aux::nullCheck(this__136107)->FMGL(layout_min0)));
          ...
          if (((::x10aux::nullCheck(p)->FMGL(rank)) > (((x10_long)1ll))))
          {
              ...
              //#line 1317 "x10/regionarray/Array.x10"
              offset__136111 = ((((((offset__136111) * (::x10aux::nullCheck(this__136107)->FMGL(layout_stride1)))) + (::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                                                                                                                        ((x10_long)1ll))))) - (::x10aux::nullCheck(this__136107)->FMGL(layout_min1)));
              
              //#line 1318 "x10/regionarray/Array.x10"
              x10_long i__124769max__136104 = ((::x10aux::nullCheck(p)->FMGL(rank)) - (((x10_long)1ll)));
              {
                  x10_long i__136105;
                  for (i__136105 = ((x10_long)2ll); ((i__136105) <= (i__124769max__136104));
                       i__136105 = ((i__136105) + (((x10_long)1ll))))
                  {
                      
                      //#line 1319 "x10/regionarray/Array.x10"
                      offset__136111 = ((((((offset__136111) * (::x10aux::nullCheck(::x10aux::nullCheck(this__136107)->FMGL(layout))->x10::lang::template Rail< x10_long >::__apply(
                                                                  ((((x10_long)2ll)) * (((i__136105) - (((x10_long)2ll))))))))) + (::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                                                                                                                                     i__136105)))) - (::x10aux::nullCheck(::x10aux::nullCheck(this__136107)->FMGL(layout))->x10::lang::template Rail< x10_long >::__apply(
                                                                                                                                                        ((((((x10_long)2ll)) * (((i__136105) - (((x10_long)2ll)))))) + (((x10_long)1ll))))));
                  }
              }
...
template<class TPMGL(T)> ::x10::regionarray::Array<TPMGL(T)>*
  x10::regionarray::RemoteArray<TPMGL(T)>::__apply() {
    ::x10::regionarray::Array<TPMGL(T)>* t__136112 = (this->FMGL(array))->__apply();
    if (!((::x10aux::struct_equals(::x10aux::nullCheck(t__136112)->FMGL(rank),
                                   ::x10aux::nullCheck(::x10aux::nullCheck(this)->FMGL(region))->FMGL(rank)))))
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::regionarray::RemoteArray_Strings::sl__167609))));
    }
    return t__136112;
