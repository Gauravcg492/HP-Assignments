...
class Mat_Strings {
  public:
    static ::x10::lang::String sl__166778;
    static ::x10::lang::String sl__166779;
};
...
template<class TPMGL(T)> void x10::regionarray::Mat<TPMGL(T)>::printInfo(
  ::x10::io::Printer* ps, ::x10::lang::String* label) {
    ...
    ::x10aux::nullCheck(ps)->printf((&::x10::regionarray::Mat_Strings::sl__166778),
    ...
    {
        ::x10::lang::Iterator<TPMGL(T)>* r__133082;
        for (r__133082 = this->iterator(); ::x10::lang::Iterator<TPMGL(T)>::hasNext(::x10aux::nullCheck(r__133082));
             ) {
            ::x10::regionarray::Row* r = reinterpret_cast< ::x10::regionarray::Row*>(::x10::lang::Iterator<TPMGL(T)>::next(::x10aux::nullCheck(r__133082)));
            
            //#line 34 "x10/regionarray/Mat.x10"
            ::x10aux::nullCheck(ps)->printf((&::x10::regionarray::Mat_Strings::sl__166779));
