...
template<class TPMGL(T)> TPMGL(T) x10::regionarray::Array__Anonymous__14520__Anonymous__14577<TPMGL(T)>::next(
    ...
    ::x10::regionarray::Array<TPMGL(T)>* this__126093 = ::x10aux::nullCheck(this->FMGL(out__))->FMGL(out__);
    ::x10::lang::Point* pt__126094 = ::x10::lang::Iterator< ::x10::lang::Point*>::next(::x10aux::nullCheck(this->FMGL(regIt)));
    
    //#line 524 "x10/regionarray/Array.x10"
    if ((true && !(::x10aux::nullCheck(this__126093)->FMGL(region)->contains(
                     pt__126094)))) {
        
        //#line 525 "x10/regionarray/Array.x10"
        ::x10::regionarray::Array<void>::raiseBoundsError(pt__126094);
    }
    
    //#line 425 "x10/regionarray/Array.x10"
    return ::x10aux::nullCheck(this__126093)->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__apply(
             (__extension__ ({
                 
                 //#line 1315 "x10/regionarray/Array.x10"
                 x10_long offset__126096 = ((::x10aux::nullCheck(pt__126094)->x10::lang::Point::__apply(
                                               ((x10_long)(((x10_int)0))))) - (::x10aux::nullCheck(this__126093)->FMGL(layout_min0)));
                 
                 //#line 1316 "x10/regionarray/Array.x10"
                 if (((::x10aux::nullCheck(pt__126094)->FMGL(rank)) > (((x10_long)1ll))))
                 {
                     
                     //#line 1317 "x10/regionarray/Array.x10"
                     offset__126096 = ((((((offset__126096) * (::x10aux::nullCheck(this__126093)->FMGL(layout_stride1)))) + (::x10aux::nullCheck(pt__126094)->x10::lang::Point::__apply(
                                                                                                                               ((x10_long)1ll))))) - (::x10aux::nullCheck(this__126093)->FMGL(layout_min1)));
                     
                     //#line 1318 "x10/regionarray/Array.x10"
                     x10_long i__124769max__126090 = ((::x10aux::nullCheck(pt__126094)->FMGL(rank)) - (((x10_long)1ll)));
                     {
                         x10_long i__126091;
                         for (i__126091 = ((x10_long)2ll);
                              ((i__126091) <= (i__124769max__126090));
                              i__126091 = ((i__126091) + (((x10_long)1ll))))
                         {
                             
                             //#line 1319 "x10/regionarray/Array.x10"
                             offset__126096 = ((((((offset__126096) * (::x10aux::nullCheck(::x10aux::nullCheck(this__126093)->FMGL(layout))->x10::lang::template Rail< x10_long >::__apply(
                                                                         ((((x10_long)2ll)) * (((i__126091) - (((x10_long)2ll))))))))) + (::x10aux::nullCheck(pt__126094)->x10::lang::Point::__apply(
                                                                                                                                            i__126091)))) - (::x10aux::nullCheck(::x10aux::nullCheck(this__126093)->FMGL(layout))->x10::lang::template Rail< x10_long >::__apply(
                                                                                                                                                               ((((((x10_long)2ll)) * (((i__126091) - (((x10_long)2ll)))))) + (((x10_long)1ll))))));
                         }
                     }
...
template<class TPMGL(T)> void x10::regionarray::Array__Anonymous__14520__Anonymous__14577<TPMGL(T)>::_constructor(
    ...
    this->FMGL(regIt) = (__extension__ ({
        ::x10::regionarray::Array<TPMGL(T)>* this__125779 =
          ::x10aux::nullCheck(this->FMGL(out__))->FMGL(out__);
        ::x10aux::nullCheck(this__125779)->FMGL(region)->iterator();
    }))
    ;
}
