...
class Unsafe_Strings {
  public:
    static ::x10::lang::String sl__165811;
};
...
#ifndef X10_LANG_UNSAFE_H_uncheckedRailApply_1353
#define X10_LANG_UNSAFE_H_uncheckedRailApply_1353
template<class TPMGL(T)> TPMGL(T) x10::lang::Unsafe::uncheckedRailApply(::x10::lang::Rail< TPMGL(T) >* r,
                                                                        x10_long i){
    return (r)->unchecked_apply(i);
}
#endif // X10_LANG_UNSAFE_H_uncheckedRailApply_1353
#ifndef X10_LANG_UNSAFE_H_uncheckedRailSet_1354
#define X10_LANG_UNSAFE_H_uncheckedRailSet_1354
...
#endif // X10_LANG_UNSAFE_H_uncheckedRailSet_1354
#ifndef X10_LANG_UNSAFE_H_dealloc_1355
#define X10_LANG_UNSAFE_H_dealloc_1355
template<class TPMGL(T)> void x10::lang::Unsafe::dealloc(TPMGL(T) o){
    ::x10aux::dealloc(o);
}
#endif // X10_LANG_UNSAFE_H_dealloc_1355
#ifndef X10_LANG_UNSAFE_H_getCongruentSibling_1356
#define X10_LANG_UNSAFE_H_getCongruentSibling_1356
...
#endif // X10_LANG_UNSAFE_H_getCongruentSibling_1356
#ifndef X10_LANG_UNSAFE_H_getCongruentSibling_1357
#define X10_LANG_UNSAFE_H_getCongruentSibling_1357
template<class TPMGL(T)> ::x10::lang::GlobalRail<TPMGL(T)>
  x10::lang::Unsafe::getCongruentSibling(::x10::lang::Rail< TPMGL(T) >* r,
    ...
    (globalRail)->::x10::lang::GlobalRail<TPMGL(T)>::_constructor(
      (x10_long)(::x10aux::nullCheck(r)->FMGL(size)), globalRef);
    
    //#line 62 "x10/lang/Unsafe.x10"
    return globalRail;
    
}
#endif // X10_LANG_UNSAFE_H_getCongruentSibling_1357
