...
class CUDAConstantRail_Strings {
  public:
    static ::x10::lang::String sl__165103;
    static ::x10::lang::String sl__165102;
};
...
template<class TPMGL(T)> ::x10::lang::String* x10::lang::CUDAConstantRail<TPMGL(T)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::lang::CUDAConstantRail_Strings::sl__165102), (&::x10::lang::CUDAConstantRail_Strings::sl__165103)), (*this)->FMGL(backing));
...
template<class TPMGL(T)> x10_boolean x10::lang::CUDAConstantRail<TPMGL(T)>::equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::CUDAConstantRail<TPMGL(T)> this__121093 =
      (*this);
    ::x10::lang::CUDAConstantRail<TPMGL(T)> other__121094 =
      ::x10aux::class_cast< ::x10::lang::CUDAConstantRail<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__121093->FMGL(backing),
                                    other__121094->FMGL(backing)));
...
template<class TPMGL(T)> x10_boolean x10::lang::CUDAConstantRail<TPMGL(T)>::_struct_equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::CUDAConstantRail<TPMGL(T)> this__121095 =
      (*this);
    ::x10::lang::CUDAConstantRail<TPMGL(T)> other__121096 =
      ::x10aux::class_cast< ::x10::lang::CUDAConstantRail<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__121095->FMGL(backing),
                                    other__121096->FMGL(backing)));
