...
template<class TPMGL(T)> void x10::lang::GlobalCell<TPMGL(T)>::_constructor(
    ...
    this->FMGL(root) = ::x10::lang::GlobalRef< ::x10::lang::Cell<TPMGL(T)>* >((__extension__ ({
        ::x10::lang::Cell<TPMGL(T)>* alloc__121133 =  (new (::x10aux::alloc_z< ::x10::lang::Cell<TPMGL(T)> >()) ::x10::lang::Cell<TPMGL(T)>());
        
        //#line 33 "x10/lang/Cell.x10"
        alloc__121133->FMGL(value) = v;
        alloc__121133;
    }))
    );
}
...
template<class TPMGL(T)> ::x10::lang::GlobalCell<TPMGL(T)>*
  x10::lang::GlobalCell<void>::make(TPMGL(T) x) {
    ...
    //#line 67 "x10/lang/GlobalCell.x10"
    ::x10::lang::GlobalCell<TPMGL(T)>* alloc__121142 =  (new (::x10aux::alloc_z< ::x10::lang::GlobalCell<TPMGL(T)> >()) ::x10::lang::GlobalCell<TPMGL(T)>());
    (alloc__121142)->::x10::lang::GlobalCell<TPMGL(T)>::_constructor(
      x);
    return alloc__121142;
