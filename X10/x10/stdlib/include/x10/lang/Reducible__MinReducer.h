...
class Reducible__MinReducer_Strings {
  public:
    static ::x10::lang::String sl__165683;
    static ::x10::lang::String sl__165684;
};
...
template<class TPMGL(T)> ::x10::lang::String* x10::lang::Reducible__MinReducer<TPMGL(T)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::lang::Reducible__MinReducer_Strings::sl__165683), (&::x10::lang::Reducible__MinReducer_Strings::sl__165684)), (*this)->FMGL(zeroVal));
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MinReducer<TPMGL(T)>::equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::Reducible__MinReducer<TPMGL(T)> this__122564 =
      (*this);
    ::x10::lang::Reducible__MinReducer<TPMGL(T)> other__122565 =
      ::x10aux::class_cast< ::x10::lang::Reducible__MinReducer<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__122564->FMGL(zeroVal),
                                    other__122565->FMGL(zeroVal)));
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MinReducer<TPMGL(T)>::_struct_equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::Reducible__MinReducer<TPMGL(T)> this__122566 =
      (*this);
    ::x10::lang::Reducible__MinReducer<TPMGL(T)> other__122567 =
      ::x10aux::class_cast< ::x10::lang::Reducible__MinReducer<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__122566->FMGL(zeroVal),
                                    other__122567->FMGL(zeroVal)));
