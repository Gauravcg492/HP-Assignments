...
class Accumulator_Strings {
  public:
    static ::x10::lang::String sl__164964;
    static ::x10::lang::String sl__164965;
    static ::x10::lang::String sl__164963;
};
...
template<class TPMGL(T)> class x10_lang_Accumulator__closure__1 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        ::x10::lang::Accumulator<TPMGL(T)>* me = saved_this->me();
        {
            ...
            ::x10::lang::CheckedThrowable* throwable__119748 = ::x10aux::class_cast_unchecked< ::x10::lang::CheckedThrowable*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL));
            try {
                {
                ...
                {
                    ::x10::lang::CheckedThrowable* formal__119749 =
                      __exc832;
                    {
                        throwable__119748 = formal__119749;
                    }
                }
            }
            if ((!::x10aux::struct_equals(throwable__119748,
                                          reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
            {
                if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__119748))
                {
                    ::x10aux::throwException(::x10aux::nullCheck(throwable__119748));
                }
            ...
            if ((!::x10aux::struct_equals(throwable__119748,
                                          reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
            {
                if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__119748)))
                {
                    ::x10aux::throwException(::x10aux::nullCheck(throwable__119748));
                }
...
template<class TPMGL(T)> class x10_lang_Accumulator__closure__2 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        ::x10::lang::Accumulator<TPMGL(T)>* me = saved_this->me();
        {
            ...
            ::x10::lang::CheckedThrowable* throwable__119751 = ::x10aux::class_cast_unchecked< ::x10::lang::CheckedThrowable*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL));
            try {
                {
                    ::x10::xrx::Runtime::enterAtomic();
                    {
                ...
                {
                    ::x10::lang::CheckedThrowable* formal__119752 = __exc834;
                    {
                        throwable__119751 = formal__119752;
                    }
                }
            }
            if ((!::x10aux::struct_equals(throwable__119751, reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
            {
                if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__119751))
                {
                    ::x10aux::throwException(::x10aux::nullCheck(throwable__119751));
                }
            ...
            if ((!::x10aux::struct_equals(throwable__119751,
                                          reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
            {
                if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__119751)))
                {
                    ::x10aux::throwException(::x10aux::nullCheck(throwable__119751));
                }
...
template<class TPMGL(T)> class x10_lang_Accumulator__closure__3 : public ::x10::lang::Closure {
    ...
    TPMGL(T) __apply(){
        ::x10::lang::Accumulator<TPMGL(T)>* this__119738 = saved_this->me();
        return ::x10aux::nullCheck(this__119738)->FMGL(curr);
...
template<class TPMGL(T)> ::x10::lang::Accumulator<TPMGL(T)>*
  x10::lang::Accumulator<TPMGL(T)>::me() {
    return ::x10aux::class_cast< ::x10::lang::Accumulator<TPMGL(T)>*>(((__extension__ ({
        ::x10::lang::GlobalRef< ::x10::lang::Acc* > t__119717 =
          this->FMGL(root);
        if (!((::x10aux::struct_equals(::x10::lang::Place::_make((t__119717)->location),
                                       ::x10::lang::Place::_make(::x10aux::here)))))
        {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::lang::Accumulator_Strings::sl__164965))));
        }
        t__119717;
    }))
    )->__apply());
