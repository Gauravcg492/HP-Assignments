...
template<class TPMGL(T)> ::x10::lang::String* x10::lang::Reducible__MaxReducer<TPMGL(T)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::lang::Reducible__MaxReducer_Strings::sl__165727), (&::x10::lang::Reducible__MaxReducer_Strings::sl__165728)), (*this)->FMGL(zeroVal));
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MaxReducer<TPMGL(T)>::equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::Reducible__MaxReducer<TPMGL(T)> this__122569 =
      (*this);
    ::x10::lang::Reducible__MaxReducer<TPMGL(T)> other__122570 =
      ::x10aux::class_cast< ::x10::lang::Reducible__MaxReducer<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__122569->FMGL(zeroVal),
                                    other__122570->FMGL(zeroVal)));
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MaxReducer<TPMGL(T)>::_struct_equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::Reducible__MaxReducer<TPMGL(T)> this__122571 =
      (*this);
    ::x10::lang::Reducible__MaxReducer<TPMGL(T)> other__122572 =
      ::x10aux::class_cast< ::x10::lang::Reducible__MaxReducer<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__122571->FMGL(zeroVal),
                                    other__122572->FMGL(zeroVal)));
