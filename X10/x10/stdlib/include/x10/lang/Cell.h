...
class Cell_Strings {
  public:
    static ::x10::lang::String sl__164978;
    static ::x10::lang::String sl__164977;
    static ::x10::lang::String sl__164979;
};
...
template<class TPMGL(T)> ::x10::lang::String* x10::lang::Cell<TPMGL(T)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::lang::Cell_Strings::sl__164977), (::x10aux::struct_equals(this->FMGL(value),
                                                                                                                                      reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)))
      ? ((&::x10::lang::Cell_Strings::sl__164978)) : (::x10aux::to_string(this->FMGL(value)))), (&::x10::lang::Cell_Strings::sl__164979));
...
template<class TPMGL(T)> void x10::lang::Cell<TPMGL(T)>::__set(
  TPMGL(T) x) {
    ::x10::lang::Cell<TPMGL(T)>* this__119895 = this;
    
    //#line 64 "x10/lang/Cell.x10"
    ::x10aux::nullCheck(this__119895)->FMGL(value) = x;
}
...
template<class TPMGL(T)> ::x10::lang::Cell<TPMGL(T)>* x10::lang::Cell<void>::make(TPMGL(T) x) {
    ...
    //#line 74 "x10/lang/Cell.x10"
    ::x10::lang::Cell<TPMGL(T)>* alloc__119898 =  (new (::x10aux::alloc_z< ::x10::lang::Cell<TPMGL(T)> >()) ::x10::lang::Cell<TPMGL(T)>());
    
    //#line 33 "x10/lang/Cell.x10"
    alloc__119898->FMGL(value) = x;
    
    //#line 74 "x10/lang/Cell.x10"
    return alloc__119898;
    
}
template<class TPMGL(W)> ::x10::lang::Cell<TPMGL(W)>* x10::lang::Cell<void>::__implicit_convert(TPMGL(W) x) {
    
    //#line 74 "x10/lang/Cell.x10"
    ::x10::lang::Cell<TPMGL(W)>* alloc__119900 =  (new (::x10aux::alloc_z< ::x10::lang::Cell<TPMGL(W)> >()) ::x10::lang::Cell<TPMGL(W)>());
    
    //#line 33 "x10/lang/Cell.x10"
    alloc__119900->FMGL(value) = x;
    
    //#line 83 "x10/lang/Cell.x10"
    return alloc__119900;
