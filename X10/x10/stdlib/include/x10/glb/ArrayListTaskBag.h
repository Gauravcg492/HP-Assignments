...
template<class TPMGL(T)> ::x10::glb::ArrayListTaskBag<TPMGL(T)>* x10::glb::ArrayListTaskBag<TPMGL(T)>::split(
    ...
    o->FMGL(bag) = (__extension__ ({
        ...
        //#line 21 "x10/glb/ArrayListTaskBag.x10"
        ::x10::util::ArrayList<TPMGL(T)>* alloc__108874 =  (new (::x10aux::alloc_z< ::x10::util::ArrayList<TPMGL(T)> >()) ::x10::util::ArrayList<TPMGL(T)>());
        (alloc__108874)->::x10::util::ArrayList<TPMGL(T)>::_constructor();
        alloc__108874;
    }))
    ;
    ...
    {
        x10_long i__108876;
        for (i__108876 = ((x10_long)1ll); ((i__108876) <= (size));
             i__108876 = ((i__108876) + (((x10_long)1ll)))) {
...
template<class TPMGL(T)> void x10::glb::ArrayListTaskBag<TPMGL(T)>::_constructor(
    ...
    ::x10::glb::ArrayListTaskBag<TPMGL(T)>* this__108879 =
      this;
    ::x10aux::nullCheck(this__108879)->FMGL(bag) = (__extension__ ({
        
        //#line 21 "x10/glb/ArrayListTaskBag.x10"
        ::x10::util::ArrayList<TPMGL(T)>* alloc__108878 =
           (new (::x10aux::alloc_z< ::x10::util::ArrayList<TPMGL(T)> >()) ::x10::util::ArrayList<TPMGL(T)>());
        (alloc__108878)->::x10::util::ArrayList<TPMGL(T)>::_constructor();
        alloc__108878;
    }))
    ;
}
...
template<class TPMGL(T)> void x10::glb::ArrayListTaskBag<TPMGL(T)>::__fieldInitializers_x10_glb_ArrayListTaskBag(
    ...
    this->FMGL(bag) = (__extension__ ({
        ...
        //#line 21 "x10/glb/ArrayListTaskBag.x10"
        ::x10::util::ArrayList<TPMGL(T)>* alloc__108407 =
           (new (::x10aux::alloc_z< ::x10::util::ArrayList<TPMGL(T)> >()) ::x10::util::ArrayList<TPMGL(T)>());
        (alloc__108407)->::x10::util::ArrayList<TPMGL(T)>::_constructor();
        alloc__108407;
    }))
    ;
}
