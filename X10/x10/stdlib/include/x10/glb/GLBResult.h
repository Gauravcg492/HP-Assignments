...
template<class TPMGL(R)> void x10::glb::GLBResult<TPMGL(R)>::_constructor(
    ...
    ::x10::glb::GLBResult<TPMGL(R)>* this__110019 = this;
    ::x10aux::nullCheck(this__110019)->FMGL(result) = (::x10aux::class_cast_unchecked< ::x10::lang::Rail< TPMGL(R) >*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__110019)->FMGL(op) = ((x10_int)-1);
}
