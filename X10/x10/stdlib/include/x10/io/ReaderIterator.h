...
template<class TPMGL(T)> void x10::io::ReaderIterator<TPMGL(T)>::_constructor(
    ...
    ::x10::io::ReaderIterator<TPMGL(T)>* this__119541 = this;
    ::x10aux::nullCheck(this__119541)->FMGL(next) = ::x10aux::zeroValue< TPMGL(T) >();
...
template<class TPMGL(T)> x10_boolean x10::io::ReaderIterator<TPMGL(T)>::hasNext(
    ...
    if ((::x10aux::struct_equals(this->FMGL(next), ::x10aux::zeroValue< TPMGL(T) >())))
    {
        ...
        try {
            ...
            this->FMGL(next) = (__extension__ ({
                ::x10::io::Reader* this__119539 = this->FMGL(r);
                ::x10::io::Marshal<TPMGL(T)>* m__119538 =
                  this->FMGL(m);
                ::x10::io::Marshal<TPMGL(T)>::read(::x10aux::nullCheck(m__119538), 
                  this__119539);
            }))
            ;
        }
        catch (::x10::lang::CheckedThrowable* __exc757) {
            if (::x10aux::instanceof< ::x10::io::IOException*>(__exc757)) {
                ::x10::io::IOException* id__130 = static_cast< ::x10::io::IOException*>(__exc757);
                {
