...
#ifndef X10_IO_READER_H_read_781
#define X10_IO_READER_H_read_781
...
#endif // X10_IO_READER_H_read_781
#ifndef X10_IO_READER_H_read_782
#define X10_IO_READER_H_read_782
...
#endif // X10_IO_READER_H_read_782
    ...
    //#line 144 "x10/io/Reader.x10"
    {
        ...
        for (i = off; ((i) < (((off) + (len)))); i = ((i) + (((x10_long)1ll))))
        {
            ...
            ::x10aux::nullCheck(a)->x10::lang::template Rail< TPMGL(T) >::__set(
              i, (__extension__ ({
                  ::x10::io::Reader* this__119549 = this;
