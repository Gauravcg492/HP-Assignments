...
class Array_Strings {
  public:
    static ::x10::lang::String sl__163795;
    static ::x10::lang::String sl__163796;
    static ::x10::lang::String sl__163794;
    static ::x10::lang::String sl__163793;
    static ::x10::lang::String sl__163792;
};
...
template<class TPMGL(T)> template<class TPMGL(U)> TPMGL(U) x10::array::Array<TPMGL(T)>::reduce(
  ::x10::lang::Fun_0_2<TPMGL(U), TPMGL(T), TPMGL(U)>* op, TPMGL(U) unit) {
    ...
    ::x10::lang::Rail< TPMGL(T) >* src__96742 = this->FMGL(raw);
    
    //#line 132 "x10/util/RailUtils.x10"
    TPMGL(U) accum__96745 = unit;
    
    //#line 133 "x10/util/RailUtils.x10"
    x10_long i__96596max__96739 = (x10_long)(::x10aux::nullCheck(src__96742)->FMGL(size));
    {
        x10_long i__96740;
        for (i__96740 = ((x10_long)0ll); ((i__96740) < (i__96596max__96739));
             i__96740 = ((i__96740) + (((x10_long)1ll)))) {
            
            //#line 134 "x10/util/RailUtils.x10"
            accum__96745 = ::x10::lang::Fun_0_2<TPMGL(U), TPMGL(T), TPMGL(U)>::__apply(::x10aux::nullCheck(op), 
              accum__96745, ::x10aux::nullCheck(src__96742)->x10::lang::template Rail< TPMGL(T) >::__apply(
                              i__96740));
        }
    }
...
template<class TPMGL(T)> template<class TPMGL(U)> ::x10::array::Array<TPMGL(U)>*
  x10::array::Array<TPMGL(T)>::map(::x10::array::Array<TPMGL(U)>* dst,
    ...
    ::x10::lang::Rail< TPMGL(T) >* src__96750 = this->FMGL(raw);
    ::x10::lang::Rail< TPMGL(U) >* dst__96751 = ::x10aux::nullCheck(dst)->FMGL(raw);
    
    //#line 180 "x10/util/RailUtils.x10"
    x10_long i__96634max__96747 = (x10_long)(::x10aux::nullCheck(src__96750)->FMGL(size));
    {
        x10_long i__96748;
        for (i__96748 = ((x10_long)0ll); ((i__96748) < (i__96634max__96747));
             i__96748 = ((i__96748) + (((x10_long)1ll))))
        {
            
            //#line 181 "x10/util/RailUtils.x10"
            ::x10aux::nullCheck(dst__96751)->x10::lang::template Rail< TPMGL(U) >::__set(
              i__96748, ::x10::lang::Fun_0_1<TPMGL(T), TPMGL(U)>::__apply(::x10aux::nullCheck(op), 
                ::x10aux::nullCheck(src__96750)->x10::lang::template Rail< TPMGL(T) >::__apply(
                  i__96748)));
        }
    }
...
::x10::array::Array<TPMGL(U)>* x10::array::Array<TPMGL(T)>::map(
  ...
  ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(S), TPMGL(U)>* op) {
    ...
    ::x10::lang::Rail< TPMGL(T) >* src__96757 = this->FMGL(raw);
    ::x10::lang::Rail< TPMGL(S) >* src__96758 = ::x10aux::nullCheck(src2)->FMGL(raw);
    ::x10::lang::Rail< TPMGL(U) >* dst__96759 = ::x10aux::nullCheck(dst)->FMGL(raw);
    
    //#line 203 "x10/util/RailUtils.x10"
    x10_long i__96653max__96754 = (x10_long)(::x10aux::nullCheck(src__96757)->FMGL(size));
    {
        x10_long i__96755;
        for (i__96755 = ((x10_long)0ll); ((i__96755) < (i__96653max__96754));
             i__96755 = ((i__96755) + (((x10_long)1ll))))
        {
            
            //#line 204 "x10/util/RailUtils.x10"
            ::x10aux::nullCheck(dst__96759)->x10::lang::template Rail< TPMGL(U) >::__set(
              i__96755, ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(S), TPMGL(U)>::__apply(::x10aux::nullCheck(op), 
                ::x10aux::nullCheck(src__96757)->x10::lang::template Rail< TPMGL(T) >::__apply(
                  i__96755), ::x10aux::nullCheck(src__96758)->x10::lang::template Rail< TPMGL(S) >::__apply(
                               i__96755)));
        }
    }
...
template<class TPMGL(T)> void x10::array::Array<TPMGL(T)>::modifyRaw(
  ::x10::lang::Rail< TPMGL(T) >* r) {
    ...
    if ((!::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(this->FMGL(raw))->FMGL(size)),
                                  this->FMGL(size)))) {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::IllegalArgumentException::_make((&::x10::array::Array_Strings::sl__163792))));
    }
    
    //#line 92 "x10/array/Array.x10"
    this->FMGL(raw) = (__extension__ ({
        ::x10::lang::Rail< TPMGL(T) >* t__91613 = r;
        if (!(((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__91613)->FMGL(size)),
                                        ::x10aux::nullCheck(this)->FMGL(size))) &&
            (!::x10aux::struct_equals(t__91613, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))))
        {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::array::Array_Strings::sl__163793))));
        }
        t__91613;
    }))
    ;
