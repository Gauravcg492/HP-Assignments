...
class DistArray_Block_1_Strings {
  public:
    static ::x10::lang::String sl__163874;
    static ::x10::lang::String sl__163875;
};
...
template<class TPMGL(T)> ::x10::array::DenseIterationSpace_1* x10::array::DistArray_Block_1<TPMGL(T)>::reloadLocalIndices(
    ...
    return (!::x10aux::struct_equals(ls, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)))
      ...
      : ((__extension__ ({
             ::x10::array::DenseIterationSpace_1* alloc__98424 =
                (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_1>()) ::x10::array::DenseIterationSpace_1());
             (alloc__98424)->::x10::array::DenseIterationSpace_1::_constructor(
...
template<class TPMGL(T)> void x10::array::DistArray_Block_1<TPMGL(T)>::_constructor(
    ...
    this->FMGL(globalIndices) = (__extension__ ({
        ::x10::array::DenseIterationSpace_1* alloc__98425 =
           (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_1>()) ::x10::array::DenseIterationSpace_1());
        (alloc__98425)->::x10::array::DenseIterationSpace_1::_constructor(
    ...
    this->FMGL(minLocalIndex) = (__extension__ ({
        ::x10::array::DistArray_Block_1<TPMGL(T)>* this__99171 =
          this;
        ::x10aux::nullCheck(this__99171)->FMGL(localIndices)->x10::array::DenseIterationSpace_1::min(
          ((x10_long)0ll));
    }))
    ;
    ...
    this->FMGL(maxLocalIndex) = (__extension__ ({
        ::x10::array::DistArray_Block_1<TPMGL(T)>* this__99173 =
          this;
        ::x10aux::nullCheck(this__99173)->FMGL(localIndices)->x10::array::DenseIterationSpace_1::max(
          ((x10_long)0ll));
    }))
    ;
}
...
template<class TPMGL(T)> ::x10::lang::Place x10::array::DistArray_Block_1<TPMGL(T)>::place(
  x10_long i) {
    ...
    x10_long tmp = ::x10::array::BlockingUtils::mapIndexToBlockPartition(
                     ...
                     (__extension__ ({
                         ::x10::lang::PlaceGroup* this__99472 =
                           this->FMGL(placeGroup);
                         ::x10aux::nullCheck(this__99472)->numPlaces();
                     }))
                     , i);
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_1<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    ::x10::array::DistArray_Block_1<TPMGL(T)>* this__99493 =
      this;
    x10_long i__99494 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                          ((x10_long)0ll));
    
    //#line 151 "x10/array/DistArray_Block_1.x10"
    if ((((i__99494) < (::x10aux::nullCheck(this__99493)->FMGL(minLocalIndex))) ||
        ((i__99494) > (::x10aux::nullCheck(this__99493)->FMGL(maxLocalIndex)))))
    {
        
        //#line 152 "x10/array/DistArray_Block_1.x10"
        if ((true && ((((i__99494) < (((x10_long)0ll))) ||
                      ((i__99494) >= (::x10aux::nullCheck(this__99493)->FMGL(size)))))))
        {
            ::x10::array::DistArray<void>::raiseBoundsError(
              i__99494);
        }
        ...
        //#line 153 "x10/array/DistArray_Block_1.x10"
        ::x10::array::DistArray<void>::raisePlaceError(i__99494);
    }
    
    //#line 167 "x10/array/DistArray_Block_1.x10"
    return (::x10aux::nullCheck(this__99493)->FMGL(raw))->unchecked_apply(((i__99494) - (::x10aux::nullCheck(this__99493)->FMGL(minLocalIndex))));
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_1<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    ::x10::array::DistArray_Block_1<TPMGL(T)>* this__99495 =
      this;
    x10_long i__99496 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                          ((x10_long)0ll));
    
    //#line 181 "x10/array/DistArray_Block_1.x10"
    if ((((i__99496) < (::x10aux::nullCheck(this__99495)->FMGL(minLocalIndex))) ||
        ((i__99496) > (::x10aux::nullCheck(this__99495)->FMGL(maxLocalIndex)))))
    {
        
        //#line 182 "x10/array/DistArray_Block_1.x10"
        if ((true && ((((i__99496) < (((x10_long)0ll))) ||
                      ((i__99496) >= (::x10aux::nullCheck(this__99495)->FMGL(size)))))))
        {
            ::x10::array::DistArray<void>::raiseBoundsError(
              i__99496);
        }
        ...
        //#line 183 "x10/array/DistArray_Block_1.x10"
        ::x10::array::DistArray<void>::raisePlaceError(i__99496);
    }
    
    //#line 199 "x10/array/DistArray_Block_1.x10"
    return (::x10aux::nullCheck(this__99495)->FMGL(raw))->unchecked_set(((i__99496) - (::x10aux::nullCheck(this__99495)->FMGL(minLocalIndex))), v);
...
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::array::DistArray_Block_1<TPMGL(T)>::getPatch(
  ::x10::array::IterationSpace* space) {
        ...
        ((::x10aux::nullCheck(r)->FMGL(max)) <= (this->FMGL(localIndices)->FMGL(max)))))))
    {
        ...
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::ArrayIndexOutOfBoundsException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::DistArray_Block_1_Strings::sl__163874), r), (&::x10::array::DistArray_Block_1_Strings::sl__163875)), this->FMGL(localIndices)))));
    }
    ...
    x10_long i__98429min__99500 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_1::min(
                                    ((x10_long)0ll));
    x10_long i__98429max__99501 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_1::max(
                                    ((x10_long)0ll));
    {
        x10_long i__99502;
        for (i__99502 = i__98429min__99500; ((i__99502) <= (i__98429max__99501));
             i__99502 = ((i__99502) + (((x10_long)1ll))))
        {
            
            //#line 219 "x10/array/DistArray_Block_1.x10"
            patch->x10::lang::template Rail< TPMGL(T) >::__set(
              (__extension__ ({
                  x10_long pre__99498 = patchIndex;
