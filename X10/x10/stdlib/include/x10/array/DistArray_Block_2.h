...
class DistArray_Block_2_Strings {
  public:
    static ::x10::lang::String sl__163912;
    static ::x10::lang::String sl__163913;
};
...
template<class TPMGL(T)> ::x10::array::DenseIterationSpace_2* x10::array::DistArray_Block_2<TPMGL(T)>::reloadLocalIndices(
    ...
    return (!::x10aux::struct_equals(ls, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)))
      ...
      : ((__extension__ ({
             ::x10::array::DenseIterationSpace_2* alloc__99856 =
                (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_2>()) ::x10::array::DenseIterationSpace_2());
             (alloc__99856)->::x10::array::DenseIterationSpace_2::_constructor(
...
template<class TPMGL(T)> void x10::array::DistArray_Block_2<TPMGL(T)>::_constructor(
    ...
    this->FMGL(globalIndices) = (__extension__ ({
        ::x10::array::DenseIterationSpace_2* alloc__99857 =
           (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_2>()) ::x10::array::DenseIterationSpace_2());
        (alloc__99857)->::x10::array::DenseIterationSpace_2::_constructor(
    ...
    this->FMGL(minIndex_1) = (__extension__ ({
        ::x10::array::DistArray_Block_2<TPMGL(T)>* this__99964 =
          this;
        ::x10aux::nullCheck(this__99964)->FMGL(localIndices)->x10::array::DenseIterationSpace_2::min(
          ((x10_long)0ll));
    }))
    ;
...
template<class TPMGL(T)> ::x10::lang::Place x10::array::DistArray_Block_2<TPMGL(T)>::place(
  x10_long i, x10_long j) {
    ...
    x10_long tmp = ::x10::array::BlockingUtils::mapIndexToBlockPartition(
                     ...
                     (__extension__ ({
                         ::x10::lang::PlaceGroup* this__99966 =
                           this->FMGL(placeGroup);
                         ::x10aux::nullCheck(this__99966)->numPlaces();
                     }))
                     , i);
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_2<TPMGL(T)>::__apply(
  x10_long i, x10_long j) {
    ...
    return (this->FMGL(raw))->unchecked_apply((__extension__ ({
        ::x10::array::DistArray_Block_2<TPMGL(T)>* this__99970 =
          this;
        ((j) + (((((i) - (::x10aux::nullCheck(this__99970)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__99970)->FMGL(numElems_2)))));
    }))
    );
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_2<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    ::x10::array::DistArray_Block_2<TPMGL(T)>* this__100005 =
      this;
    x10_long i__100006 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)0ll));
    x10_long j__100007 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)1ll));
    
    //#line 165 "x10/array/DistArray_Block_2.x10"
    ::x10aux::nullCheck(this__100005)->x10::array::template DistArray_Block_2<TPMGL(T)>::validateIndex(
      i__100006, j__100007);
    
    //#line 177 "x10/array/DistArray_Block_2.x10"
    return (::x10aux::nullCheck(this__100005)->FMGL(raw))->unchecked_apply(((j__100007) + (((((i__100006) - (::x10aux::nullCheck(this__100005)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__100005)->FMGL(numElems_2))))));
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_2<TPMGL(T)>::__set(
  x10_long i, x10_long j, TPMGL(T) v) {
    ...
    return (this->FMGL(raw))->unchecked_set((__extension__ ({
        ::x10::array::DistArray_Block_2<TPMGL(T)>* this__99981 =
          this;
        ((j) + (((((i) - (::x10aux::nullCheck(this__99981)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__99981)->FMGL(numElems_2)))));
    }))
    , v);
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_2<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    ::x10::array::DistArray_Block_2<TPMGL(T)>* this__100010 =
      this;
    x10_long i__100011 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)0ll));
    x10_long j__100012 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)1ll));
    
    //#line 191 "x10/array/DistArray_Block_2.x10"
    ::x10aux::nullCheck(this__100010)->x10::array::template DistArray_Block_2<TPMGL(T)>::validateIndex(
      i__100011, j__100012);
    
    //#line 205 "x10/array/DistArray_Block_2.x10"
    return (::x10aux::nullCheck(this__100010)->FMGL(raw))->unchecked_set(((j__100012) + (((((i__100011) - (::x10aux::nullCheck(this__100010)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__100010)->FMGL(numElems_2))))), v);
...
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::array::DistArray_Block_2<TPMGL(T)>::getPatch(
  ::x10::array::IterationSpace* space) {
        ...
        ((::x10aux::nullCheck(r)->FMGL(max1)) <= (this->FMGL(localIndices)->FMGL(max1)))))))
    {
        ...
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::ArrayIndexOutOfBoundsException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::DistArray_Block_2_Strings::sl__163912), r), (&::x10::array::DistArray_Block_2_Strings::sl__163913)), this->FMGL(localIndices)))));
    }
    ...
    x10_long i1__99861min__100021 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_2::min(
                                      ((x10_long)1ll));
    x10_long i1__99861max__100022 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_2::max(
                                      ((x10_long)1ll));
    x10_long i0__99892min__100023 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_2::min(
                                      ((x10_long)0ll));
    x10_long i0__99892max__100024 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_2::max(
                                      ((x10_long)0ll));
    {
        x10_long i__100025;
        for (i__100025 = i0__99892min__100023; ((i__100025) <= (i0__99892max__100024));
             i__100025 = ((i__100025) + (((x10_long)1ll))))
        {
            {
                x10_long i__100027;
                for (i__100027 = i1__99861min__100021; ((i__100027) <= (i1__99861max__100022));
                     i__100027 = ((i__100027) + (((x10_long)1ll))))
                {
                    
                    //#line 251 "x10/array/DistArray_Block_2.x10"
                    patch->x10::lang::template Rail< TPMGL(T) >::__set(
                      (__extension__ ({
                          x10_long pre__100016 = patchIndex;
                          patchIndex = ((patchIndex) + (((x10_long)1ll)));
                          pre__100016;
                      }))
                      , this->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__apply(
                          (__extension__ ({
                              ::x10::array::DistArray_Block_2<TPMGL(T)>* this__100017 =
                                this;
                              ((i__100027) + (((((i__100025) - (::x10aux::nullCheck(this__100017)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__100017)->FMGL(numElems_2)))));
                          }))
                          ));
                }
            }
