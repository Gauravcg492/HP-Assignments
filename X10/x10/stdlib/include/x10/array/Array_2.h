...
class Array_2_Strings {
  public:
    static ::x10::lang::String sl__163552;
    static ::x10::lang::String sl__163556;
    static ::x10::lang::String sl__163557;
    static ::x10::lang::String sl__163553;
    static ::x10::lang::String sl__163558;
    static ::x10::lang::String sl__163559;
    static ::x10::lang::String sl__163554;
    static ::x10::lang::String sl__163555;
    static ::x10::lang::String sl__163560;
};
...
template<class TPMGL(T)> void x10::array::Array_2<TPMGL(T)>::_constructor(
    ...
    x10_long i__93298max__93777 = ((m) - (((x10_long)1ll)));
    {
        x10_long i__93778;
        for (i__93778 = ((x10_long)0ll); ((i__93778) <= (i__93298max__93777));
             i__93778 = ((i__93778) + (((x10_long)1ll))))
        {
            
            //#line 63 "x10/array/Array_2.x10"
            x10_long i__93280max__93774 = ((n) - (((x10_long)1ll)));
            {
                x10_long i__93775;
                for (i__93775 = ((x10_long)0ll); ((i__93775) <= (i__93280max__93774));
                     i__93775 = ((i__93775) + (((x10_long)1ll))))
                {
                    
                    //#line 64 "x10/array/Array_2.x10"
                    this->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__set(
                      (__extension__ ({
                          ::x10::array::Array_2<TPMGL(T)>* this__93771 =
                            this;
                          ((i__93775) + (((i__93778) * (::x10aux::nullCheck(this__93771)->FMGL(numElems_2)))));
                      }))
...
template<class TPMGL(T)> void x10::array::Array_2<TPMGL(T)>::_constructor(
    ...
    ::x10::array::Array<TPMGL(T)>* this__93781 = this;
    ::x10::lang::Rail< TPMGL(T) >* r__93782 = ::x10::lang::Rail< TPMGL(T) >::_make(::x10aux::nullCheck(src)->FMGL(raw));
    
    //#line 65 "x10/array/Array.x10"
    ::x10aux::nullCheck(this__93781)->FMGL(size) = (x10_long)(::x10aux::nullCheck(r__93782)->FMGL(size));
    
    //#line 66 "x10/array/Array.x10"
    ::x10aux::nullCheck(this__93781)->FMGL(raw) = r__93782;
...
template<class TPMGL(T)> void x10::array::Array_2<TPMGL(T)>::_constructor(
    ...
    ::x10::array::Array<TPMGL(T)>* this__93784 = this;
    
    //#line 65 "x10/array/Array.x10"
    ::x10aux::nullCheck(this__93784)->FMGL(size) = (x10_long)(::x10aux::nullCheck(r)->FMGL(size));
    
    //#line 66 "x10/array/Array.x10"
    ::x10aux::nullCheck(this__93784)->FMGL(raw) = r;
...
template<class TPMGL(T)> ::x10::lang::String* x10::array::Array_2<TPMGL(T)>::toString(
  x10_long limit) {
    ...
    sb->add((&::x10::array::Array_2_Strings::sl__163555));
    
    //#line 112 "x10/array/Array_2.x10"
    x10_long printed = ((x10_long)0ll);
    
    //#line 113 "x10/array/Array_2.x10"
    x10_long i__93334max__93795 = ((this->FMGL(numElems_1)) - (((x10_long)1ll)));
    goto outer__93796; outer__93796: {
        x10_long i__93797;
        for (i__93797 = ((x10_long)0ll); ((i__93797) <= (i__93334max__93795));
             i__93797 = ((i__93797) + (((x10_long)1ll))))
        {
        {
            
            //#line 114 "x10/array/Array_2.x10"
            x10_long i__93316max__93792 = ((this->FMGL(numElems_2)) - (((x10_long)1ll)));
            {
                x10_long i__93793;
                for (i__93793 = ((x10_long)0ll); ((i__93793) <= (i__93316max__93792));
                     i__93793 = ((i__93793) + (((x10_long)1ll))))
                {
                    
                    //#line 115 "x10/array/Array_2.x10"
                    if ((!::x10aux::struct_equals(i__93793,
                                                  ((x10_long)0ll))))
                    {
                        sb->add((&::x10::array::Array_2_Strings::sl__163556));
                    }
                    ...
                    reinterpret_cast< ::x10::util::StringBuilder*>(sb->add(
                                                                     ::x10aux::class_cast_unchecked< ::x10::lang::Any*>((__extension__ ({
                                                                         ::x10::array::Array_2<TPMGL(T)>* this__93787 =
                                                                           this;
                                                                         
                                                                         //#line 152 "x10/array/Array_2.x10"
                                                                         if ((true &&
                                                                             ((((((i__93797) < (((x10_long)0ll))) ||
                                                                              ((i__93797) >= (::x10aux::nullCheck(this__93787)->FMGL(numElems_1)))) ||
                                                                              ((i__93793) < (((x10_long)0ll)))) ||
                                                                              ((i__93793) >= (::x10aux::nullCheck(this__93787)->FMGL(numElems_2)))))))
                                                                         {
                                                                         ...
                                                                         (::x10aux::nullCheck(this__93787)->FMGL(raw))->unchecked_apply(((i__93793) + (((i__93797) * (::x10aux::nullCheck(this__93787)->FMGL(numElems_2))))));
                                                                     }))
                                                                     )));
            ...
            sb->add((&::x10::array::Array_2_Strings::sl__163557));
        }
        goto outer__93796_next_; outer__93796_next_: ;
        }
        goto outer__93796_end_; outer__93796_end_: ;
    }
    ...
    if (((limit) < (this->FMGL(size)))) {
        ...
        sb->add(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::Array_2_Strings::sl__163558), ((this->FMGL(size)) - (limit))), (&::x10::array::Array_2_Strings::sl__163559)));
    }
    
    //#line 124 "x10/array/Array_2.x10"
    sb->add((&::x10::array::Array_2_Strings::sl__163560));
...
template<class TPMGL(T)> ::x10::array::IterationSpace* x10::array::Array_2<TPMGL(T)>::indices(
    ...
    ::x10::array::DenseIterationSpace_2* alloc__93799 =  (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_2>()) ::x10::array::DenseIterationSpace_2());
    (alloc__93799)->::x10::array::DenseIterationSpace_2::_constructor(
      ((x10_long)0ll), ((x10_long)0ll), ((this->FMGL(numElems_1)) - (((x10_long)1ll))),
      ((this->FMGL(numElems_2)) - (((x10_long)1ll))));
    return reinterpret_cast< ::x10::array::IterationSpace*>(alloc__93799);
...
template<class TPMGL(T)> TPMGL(T) x10::array::Array_2<TPMGL(T)>::__apply(
  x10_long i, x10_long j) {
    ...
    return (this->FMGL(raw))->unchecked_apply((__extension__ ({
        ::x10::array::Array_2<TPMGL(T)>* this__93747 = this;
        ((j) + (((i) * (::x10aux::nullCheck(this__93747)->FMGL(numElems_2)))));
    }))
    );
...
template<class TPMGL(T)> TPMGL(T) x10::array::Array_2<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    ::x10::array::Array_2<TPMGL(T)>* this__93800 = this;
    x10_long i__93801 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                          ((x10_long)0ll));
    x10_long j__93802 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                          ((x10_long)1ll));
    
    //#line 152 "x10/array/Array_2.x10"
    if ((true && ((((((i__93801) < (((x10_long)0ll))) || ((i__93801) >= (::x10aux::nullCheck(this__93800)->FMGL(numElems_1)))) ||
                  ((j__93802) < (((x10_long)0ll)))) || ((j__93802) >= (::x10aux::nullCheck(this__93800)->FMGL(numElems_2)))))))
    {
        
        //#line 154 "x10/array/Array_2.x10"
        ::x10::array::Array<void>::raiseBoundsError(i__93801,
                                                    j__93802);
    }
    
    //#line 166 "x10/array/Array_2.x10"
    return (::x10aux::nullCheck(this__93800)->FMGL(raw))->unchecked_apply(((j__93802) + (((i__93801) * (::x10aux::nullCheck(this__93800)->FMGL(numElems_2))))));
...
template<class TPMGL(T)> TPMGL(T) x10::array::Array_2<TPMGL(T)>::__set(
  x10_long i, x10_long j, TPMGL(T) v) {
    ...
    return (this->FMGL(raw))->unchecked_set((__extension__ ({
        ::x10::array::Array_2<TPMGL(T)>* this__93758 = this;
        ((j) + (((i) * (::x10aux::nullCheck(this__93758)->FMGL(numElems_2)))));
    }))
    , v);
...
template<class TPMGL(T)> TPMGL(T) x10::array::Array_2<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    ::x10::array::Array_2<TPMGL(T)>* this__93805 = this;
    x10_long i__93806 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                          ((x10_long)0ll));
    x10_long j__93807 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                          ((x10_long)1ll));
    
    //#line 179 "x10/array/Array_2.x10"
    if ((true && ((((((i__93806) < (((x10_long)0ll))) || ((i__93806) >= (::x10aux::nullCheck(this__93805)->FMGL(numElems_1)))) ||
                  ((j__93807) < (((x10_long)0ll)))) || ((j__93807) >= (::x10aux::nullCheck(this__93805)->FMGL(numElems_2)))))))
    {
        
        //#line 181 "x10/array/Array_2.x10"
        ::x10::array::Array<void>::raiseBoundsError(i__93806,
                                                    j__93807);
    }
    
    //#line 195 "x10/array/Array_2.x10"
    return (::x10aux::nullCheck(this__93805)->FMGL(raw))->unchecked_set(((j__93807) + (((i__93806) * (::x10aux::nullCheck(this__93805)->FMGL(numElems_2))))), v);
...
template<class TPMGL(T)> ::x10::array::Array_2<TPMGL(T)>*
  x10::array::Array_2<void>::makeView(::x10::lang::Rail< TPMGL(T) >* r,
    ...
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::IllegalOperationException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::Array_2_Strings::sl__163552), m), (&::x10::array::Array_2_Strings::sl__163553)), n), (&::x10::array::Array_2_Strings::sl__163554)), (x10_long)(::x10aux::nullCheck(r)->FMGL(size))))));
    }
    
    //#line 90 "x10/array/Array_2.x10"
    ::x10::array::Array_2<TPMGL(T)>* alloc__93786 =  (new (::x10aux::alloc_z< ::x10::array::Array_2<TPMGL(T)> >()) ::x10::array::Array_2<TPMGL(T)>());
    (alloc__93786)->::x10::array::Array_2<TPMGL(T)>::_constructor(
      r, m, n);
    return alloc__93786;
