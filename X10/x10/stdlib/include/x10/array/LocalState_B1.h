...
template<class TPMGL(S)> void x10::array::LocalState_B1<TPMGL(S)>::_constructor(
    ...
    ::x10::array::LocalState<TPMGL(S)>* this__99505 = this;
    
    //#line 301 "x10/array/DistArray.x10"
    ::x10aux::nullCheck(this__99505)->FMGL(pg) = pg;
    ::x10aux::nullCheck(this__99505)->FMGL(rail) = data;
    ::x10aux::nullCheck(this__99505)->FMGL(size) = size;
...
template<class TPMGL(S)> ::x10::array::LocalState_B1<TPMGL(S)>*
  x10::array::LocalState_B1<void>::make(::x10::lang::PlaceGroup* pg,
    ...
    if ((__extension__ ({
            ::x10::array::DenseIterationSpace_1* this__99490 =
              dist->FMGL(localIndices);
            ((this__99490->FMGL(max)) < (this__99490->FMGL(min)));
        }))
        ) {
        ...
        {
            x10_long i__99512;
            for (i__99512 = low; ((i__99512) <= (hi)); i__99512 =
                                                         ((i__99512) + (((x10_long)1ll))))
            {
                
                //#line 255 "x10/array/DistArray_Block_1.x10"
                x10_long offset__99509 = ((i__99512) - (low));
                
                //#line 256 "x10/array/DistArray_Block_1.x10"
                data->x10::lang::template Rail< TPMGL(S) >::__set(
                  offset__99509, ::x10::lang::Fun_0_1<x10_long, TPMGL(S)>::__apply(::x10aux::nullCheck(init), 
                    i__99512));
            }
        }
    ...
    ::x10::array::LocalState_B1<TPMGL(S)>* alloc__99514 =
       (new (::x10aux::alloc_z< ::x10::array::LocalState_B1<TPMGL(S)> >()) ::x10::array::LocalState_B1<TPMGL(S)>());
    (alloc__99514)->::x10::array::LocalState_B1<TPMGL(S)>::_constructor(
      pg, data, n, dist);
    return alloc__99514;
