...
class DistArray_BlockBlock_2_Strings {
  public:
    static ::x10::lang::String sl__164035;
    static ::x10::lang::String sl__164036;
};
...
template<class TPMGL(T)> ::x10::array::DenseIterationSpace_2* x10::array::DistArray_BlockBlock_2<TPMGL(T)>::reloadLocalIndices(
    ...
    return (!::x10aux::struct_equals(ls, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)))
      ...
      : ((__extension__ ({
             ::x10::array::DenseIterationSpace_2* alloc__101153 =
                (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_2>()) ::x10::array::DenseIterationSpace_2());
             (alloc__101153)->::x10::array::DenseIterationSpace_2::_constructor(
               ((x10_long)0ll), ((x10_long)0ll), ((x10_long)-1ll),
               ((x10_long)-1ll));
             alloc__101153;
         }))
         );
...
template<class TPMGL(T)> void x10::array::DistArray_BlockBlock_2<TPMGL(T)>::_constructor(
    ...
    this->FMGL(globalIndices) = (__extension__ ({
        ::x10::array::DenseIterationSpace_2* alloc__101154 =
           (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_2>()) ::x10::array::DenseIterationSpace_2());
        (alloc__101154)->::x10::array::DenseIterationSpace_2::_constructor(
    ...
    this->FMGL(minIndex_1) = (__extension__ ({
        ::x10::array::DistArray_BlockBlock_2<TPMGL(T)>* this__101261 =
          this;
        ::x10aux::nullCheck(this__101261)->FMGL(localIndices)->x10::array::DenseIterationSpace_2::min(
          ((x10_long)0ll));
    }))
    ;
    ...
    this->FMGL(minIndex_2) = (__extension__ ({
        ::x10::array::DistArray_BlockBlock_2<TPMGL(T)>* this__101263 =
          this;
        ::x10aux::nullCheck(this__101263)->FMGL(localIndices)->x10::array::DenseIterationSpace_2::min(
          ((x10_long)1ll));
    }))
    ;
...
template<class TPMGL(T)> ::x10::lang::Place x10::array::DistArray_BlockBlock_2<TPMGL(T)>::place(
  x10_long i, x10_long j) {
    ...
    x10_long tmp = ::x10::array::BlockingUtils::mapIndexToBlockBlockPartition(
                     ...
                     (__extension__ ({
                         ::x10::lang::PlaceGroup* this__101265 =
                           this->FMGL(placeGroup);
                         ::x10aux::nullCheck(this__101265)->numPlaces();
                     }))
                     , i, j);
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_2<TPMGL(T)>::__apply(
  x10_long i, x10_long j) {
    ...
    return (this->FMGL(raw))->unchecked_apply((__extension__ ({
        ::x10::array::DistArray_BlockBlock_2<TPMGL(T)>* this__101269 =
          this;
        ((((j) - (::x10aux::nullCheck(this__101269)->FMGL(minIndex_2)))) + (((((i) - (::x10aux::nullCheck(this__101269)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__101269)->FMGL(numElemsLocal_2)))));
    }))
    );
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_2<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    ::x10::array::DistArray_BlockBlock_2<TPMGL(T)>* this__101303 =
      this;
    x10_long i__101304 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)0ll));
    x10_long j__101305 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)1ll));
    
    //#line 173 "x10/array/DistArray_BlockBlock_2.x10"
    ::x10aux::nullCheck(this__101303)->x10::array::template DistArray_BlockBlock_2<TPMGL(T)>::validateIndex(
      i__101304, j__101305);
    
    //#line 185 "x10/array/DistArray_BlockBlock_2.x10"
    return (::x10aux::nullCheck(this__101303)->FMGL(raw))->unchecked_apply(((((j__101305) - (::x10aux::nullCheck(this__101303)->FMGL(minIndex_2)))) + (((((i__101304) - (::x10aux::nullCheck(this__101303)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__101303)->FMGL(numElemsLocal_2))))));
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_2<TPMGL(T)>::__set(
  x10_long i, x10_long j, TPMGL(T) v) {
    ...
    return (this->FMGL(raw))->unchecked_set((__extension__ ({
        ::x10::array::DistArray_BlockBlock_2<TPMGL(T)>* this__101280 =
          this;
        ((((j) - (::x10aux::nullCheck(this__101280)->FMGL(minIndex_2)))) + (((((i) - (::x10aux::nullCheck(this__101280)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__101280)->FMGL(numElemsLocal_2)))));
    }))
    , v);
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_2<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    ::x10::array::DistArray_BlockBlock_2<TPMGL(T)>* this__101308 =
      this;
    x10_long i__101309 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)0ll));
    x10_long j__101310 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)1ll));
    
    //#line 199 "x10/array/DistArray_BlockBlock_2.x10"
    ::x10aux::nullCheck(this__101308)->x10::array::template DistArray_BlockBlock_2<TPMGL(T)>::validateIndex(
      i__101309, j__101310);
    
    //#line 213 "x10/array/DistArray_BlockBlock_2.x10"
    return (::x10aux::nullCheck(this__101308)->FMGL(raw))->unchecked_set(((((j__101310) - (::x10aux::nullCheck(this__101308)->FMGL(minIndex_2)))) + (((((i__101309) - (::x10aux::nullCheck(this__101308)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__101308)->FMGL(numElemsLocal_2))))), v);
...
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::array::DistArray_BlockBlock_2<TPMGL(T)>::getPatch(
  ::x10::array::IterationSpace* space) {
        ...
        ((::x10aux::nullCheck(r)->FMGL(max1)) <= (this->FMGL(localIndices)->FMGL(max1)))))))
    {
        ...
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::ArrayIndexOutOfBoundsException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::DistArray_BlockBlock_2_Strings::sl__164035), r), (&::x10::array::DistArray_BlockBlock_2_Strings::sl__164036)), this->FMGL(localIndices)))));
    }
    ...
    x10_long i1__101158min__101319 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_2::min(
                                       ((x10_long)1ll));
    x10_long i1__101158max__101320 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_2::max(
                                       ((x10_long)1ll));
    x10_long i0__101189min__101321 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_2::min(
                                       ((x10_long)0ll));
    x10_long i0__101189max__101322 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_2::max(
                                       ((x10_long)0ll));
    {
        x10_long i__101323;
        for (i__101323 = i0__101189min__101321; ((i__101323) <= (i0__101189max__101322));
             i__101323 = ((i__101323) + (((x10_long)1ll))))
        {
            {
                x10_long i__101325;
                for (i__101325 = i1__101158min__101319; ((i__101325) <= (i1__101158max__101320));
                     i__101325 = ((i__101325) + (((x10_long)1ll))))
                {
                    
                    //#line 257 "x10/array/DistArray_BlockBlock_2.x10"
                    patch->x10::lang::template Rail< TPMGL(T) >::__set(
                      (__extension__ ({
                          x10_long pre__101314 = patchIndex;
                          patchIndex = ((patchIndex) + (((x10_long)1ll)));
                          pre__101314;
                      }))
                      , this->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__apply(
                          (__extension__ ({
                              ::x10::array::DistArray_BlockBlock_2<TPMGL(T)>* this__101315 =
                                this;
                              ((((i__101325) - (::x10aux::nullCheck(this__101315)->FMGL(minIndex_2)))) + (((((i__101323) - (::x10aux::nullCheck(this__101315)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__101315)->FMGL(numElemsLocal_2)))));
                          }))
                          ));
                }
            }
