...
class DistArray_Unique_Strings {
  public:
    static ::x10::lang::String sl__164162;
};
...
template<class TPMGL(T)> class x10_array_DistArray_Unique__closure__1 : public ::x10::lang::Closure {
    ...
    ::x10::array::LocalState<TPMGL(T)>* __apply(){
        ::x10::array::LocalState<TPMGL(T)>* alloc__102195 =  (new (::x10aux::alloc_z< ::x10::array::LocalState<TPMGL(T)> >()) ::x10::array::LocalState<TPMGL(T)>());
        ::x10::lang::Rail< TPMGL(T) >* rail__102193 = ::x10::lang::Rail< TPMGL(T) >::_make(((x10_long)1ll));
        x10_long size__102194 = pg->numPlaces();
        
        //#line 301 "x10/array/DistArray.x10"
        alloc__102195->FMGL(pg) = pg;
        alloc__102195->FMGL(rail) = rail__102193;
        alloc__102195->FMGL(size) = size__102194;
        
        //#line 37 "x10/array/DistArray_Unique.x10"
        return alloc__102195;
...
template<class TPMGL(T)> class x10_array_DistArray_Unique__closure__2 : public ::x10::lang::Closure {
    ...
    ::x10::array::LocalState<TPMGL(T)>* __apply(){
        ::x10::array::LocalState<TPMGL(T)>* alloc__102200 =  (new (::x10aux::alloc_z< ::x10::array::LocalState<TPMGL(T)> >()) ::x10::array::LocalState<TPMGL(T)>());
        ::x10::lang::Rail< TPMGL(T) >* rail__102198 = ::x10::lang::Rail< TPMGL(T) >::_make(((x10_long)1ll),
                                                                                           ::x10::lang::Fun_0_0<TPMGL(T)>::__apply(::x10aux::nullCheck(init)));
        x10_long size__102199 = pg->numPlaces();
        
        //#line 301 "x10/array/DistArray.x10"
        alloc__102200->FMGL(pg) = pg;
        alloc__102200->FMGL(rail) = rail__102198;
        alloc__102200->FMGL(size) = size__102199;
        
        //#line 54 "x10/array/DistArray_Unique.x10"
        return alloc__102200;
...
template<class TPMGL(T)> ::x10::array::IterationSpace* x10::array::DistArray_Unique<TPMGL(T)>::globalIndices(
    ...
    ::x10::array::DenseIterationSpace_1* alloc__102202 = 
    (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_1>()) ::x10::array::DenseIterationSpace_1());
    (alloc__102202)->::x10::array::DenseIterationSpace_1::_constructor(
      ((x10_long)0ll), (((__extension__ ({
          ::x10::lang::PlaceGroup* this__102203 = this->FMGL(placeGroup);
          ::x10aux::nullCheck(this__102203)->numPlaces();
      }))
      ) - (((x10_long)1ll))));
    return reinterpret_cast< ::x10::array::IterationSpace*>(alloc__102202);
...
template<class TPMGL(T)> ::x10::array::IterationSpace* x10::array::DistArray_Unique<TPMGL(T)>::localIndices(
    ...
    ::x10::array::DenseIterationSpace_1* alloc__102204 = 
    (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_1>()) ::x10::array::DenseIterationSpace_1());
    (alloc__102204)->::x10::array::DenseIterationSpace_1::_constructor(
      idx, idx);
    return reinterpret_cast< ::x10::array::IterationSpace*>(alloc__102204);
...
template<class TPMGL(T)> ::x10::lang::Place x10::array::DistArray_Unique<TPMGL(T)>::place(
  x10_long i) {
    return (((i) >= (((x10_long)0ll))) && ((i) < ((__extension__ ({
        ::x10::lang::PlaceGroup* this__102163 = this->FMGL(placeGroup);
        ::x10aux::nullCheck(this__102163)->numPlaces();
    }))
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Unique<TPMGL(T)>::__apply(
  x10_long i) {
    ...
    ::x10::array::DistArray_Unique<TPMGL(T)>* this__102206 =
      this;
    
    //#line 159 "x10/array/DistArray_Unique.x10"
    if ((!::x10aux::struct_equals(::x10aux::nullCheck(::x10aux::nullCheck(this__102206)->FMGL(placeGroup))->indexOf(
                                    ::x10::lang::Place::_make(::x10aux::here)),
                                  i))) {
        
        //#line 160 "x10/array/DistArray_Unique.x10"
        if ((true && ((((i) < (((x10_long)0ll))) || ((i) >= ((__extension__ ({
                          ::x10::lang::PlaceGroup* this__102205 =
                            ::x10aux::nullCheck(this__102206)->FMGL(placeGroup);
                          ::x10aux::nullCheck(this__102205)->numPlaces();
                      }))
                      )))))) {
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Unique<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    ::x10::array::DistArray_Unique<TPMGL(T)>* this__102210 =
      this;
    x10_long i__102211 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)0ll));
    
    //#line 159 "x10/array/DistArray_Unique.x10"
    if ((!::x10aux::struct_equals(::x10aux::nullCheck(::x10aux::nullCheck(this__102210)->FMGL(placeGroup))->indexOf(
                                    ::x10::lang::Place::_make(::x10aux::here)),
                                  i__102211))) {
        
        //#line 160 "x10/array/DistArray_Unique.x10"
        if ((true && ((((i__102211) < (((x10_long)0ll))) ||
                      ((i__102211) >= ((__extension__ ({
                          ::x10::lang::PlaceGroup* this__102208 =
                            ::x10aux::nullCheck(this__102210)->FMGL(placeGroup);
                          ::x10aux::nullCheck(this__102208)->numPlaces();
                      }))
                      )))))) {
            ::x10::array::DistArray<void>::raiseBoundsError(
              i__102211);
        ...
        //#line 161 "x10/array/DistArray_Unique.x10"
        ::x10::array::DistArray<void>::raisePlaceError(i__102211);
    }
    
    //#line 119 "x10/array/DistArray_Unique.x10"
    return ::x10aux::nullCheck(this__102210)->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__apply(
             ((x10_long)0ll));
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Unique<TPMGL(T)>::__set(
  x10_long i, TPMGL(T) v) {
    ...
    ::x10::array::DistArray_Unique<TPMGL(T)>* this__102213 =
      this;
    
    //#line 159 "x10/array/DistArray_Unique.x10"
    if ((!::x10aux::struct_equals(::x10aux::nullCheck(::x10aux::nullCheck(this__102213)->FMGL(placeGroup))->indexOf(
                                    ::x10::lang::Place::_make(::x10aux::here)),
                                  i))) {
        
        //#line 160 "x10/array/DistArray_Unique.x10"
        if ((true && ((((i) < (((x10_long)0ll))) || ((i) >= ((__extension__ ({
                          ::x10::lang::PlaceGroup* this__102212 =
                            ::x10aux::nullCheck(this__102213)->FMGL(placeGroup);
                          ::x10aux::nullCheck(this__102212)->numPlaces();
                      }))
                      )))))) {
            ::x10::array::DistArray<void>::raiseBoundsError(
              i);
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Unique<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    ::x10::array::DistArray_Unique<TPMGL(T)>* this__102217 =
      this;
    x10_long i__102218 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)0ll));
    
    //#line 159 "x10/array/DistArray_Unique.x10"
    if ((!::x10aux::struct_equals(::x10aux::nullCheck(::x10aux::nullCheck(this__102217)->FMGL(placeGroup))->indexOf(
                                    ::x10::lang::Place::_make(::x10aux::here)),
                                  i__102218))) {
        
        //#line 160 "x10/array/DistArray_Unique.x10"
        if ((true && ((((i__102218) < (((x10_long)0ll))) ||
                      ((i__102218) >= ((__extension__ ({
                          ::x10::lang::PlaceGroup* this__102215 =
                            ::x10aux::nullCheck(this__102217)->FMGL(placeGroup);
                          ::x10aux::nullCheck(this__102215)->numPlaces();
                      }))
                      )))))) {
            ::x10::array::DistArray<void>::raiseBoundsError(
              i__102218);
        ...
        //#line 161 "x10/array/DistArray_Unique.x10"
        ::x10::array::DistArray<void>::raisePlaceError(i__102218);
    }
    
    //#line 133 "x10/array/DistArray_Unique.x10"
    ::x10aux::nullCheck(this__102217)->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__set(
      ((x10_long)0ll), v);
...
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::array::DistArray_Unique<TPMGL(T)>::getPatch(
  ::x10::array::IterationSpace* space) {
    ...
    ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::UnsupportedOperationException::_make((&::x10::array::DistArray_Unique_Strings::sl__164162))));
}
...
template<class TPMGL(T)> void x10::array::DistArray_Unique<TPMGL(T)>::validateIndex(
  x10_long i) {
    ...
    if ((!::x10aux::struct_equals(::x10aux::nullCheck(this->FMGL(placeGroup))->indexOf(
        ...
        //#line 160 "x10/array/DistArray_Unique.x10"
        if ((true && ((((i) < (((x10_long)0ll))) || ((i) >= ((__extension__ ({
                          ::x10::lang::PlaceGroup* this__102220 =
                            this->FMGL(placeGroup);
                          ::x10aux::nullCheck(this__102220)->numPlaces();
                      }))
                      )))))) {
            ::x10::array::DistArray<void>::raiseBoundsError(
              i);
