...
class DistArray_Block_3_Strings {
  public:
    static ::x10::lang::String sl__163965;
    static ::x10::lang::String sl__163966;
};
...
template<class TPMGL(T)> ::x10::array::DenseIterationSpace_3* x10::array::DistArray_Block_3<TPMGL(T)>::reloadLocalIndices(
    ...
    return (!::x10aux::struct_equals(ls, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)))
      ...
      : ((__extension__ ({
             ::x10::array::DenseIterationSpace_3* alloc__100533 =
                (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_3>()) ::x10::array::DenseIterationSpace_3());
             (alloc__100533)->::x10::array::DenseIterationSpace_3::_constructor(
...
template<class TPMGL(T)> void x10::array::DistArray_Block_3<TPMGL(T)>::_constructor(
    ...
    this->FMGL(globalIndices) = (__extension__ ({
        ::x10::array::DenseIterationSpace_3* alloc__100534 =
           (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_3>()) ::x10::array::DenseIterationSpace_3());
        (alloc__100534)->::x10::array::DenseIterationSpace_3::_constructor(
          ((x10_long)0ll), ((x10_long)0ll), ((x10_long)0ll),
    ...
    this->FMGL(minIndex_1) = (__extension__ ({
        ::x10::array::DistArray_Block_3<TPMGL(T)>* this__100691 =
          this;
        ::x10aux::nullCheck(this__100691)->FMGL(localIndices)->x10::array::DenseIterationSpace_3::min(
          ((x10_long)0ll));
    }))
    ;
...
template<class TPMGL(T)> ::x10::lang::Place x10::array::DistArray_Block_3<TPMGL(T)>::place(
  x10_long i, x10_long j, x10_long k) {
    ...
    x10_long tmp = ::x10::array::BlockingUtils::mapIndexToBlockPartition(
                     ...
                     (__extension__ ({
                         ::x10::lang::PlaceGroup* this__100693 =
                           this->FMGL(placeGroup);
                         ::x10aux::nullCheck(this__100693)->numPlaces();
                     }))
                     , i);
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_3<TPMGL(T)>::__apply(
  x10_long i, x10_long j, x10_long k) {
    ...
    return (this->FMGL(raw))->unchecked_apply((__extension__ ({
        ::x10::array::DistArray_Block_3<TPMGL(T)>* this__100698 =
          this;
        ((k) + (((::x10aux::nullCheck(this__100698)->FMGL(numElems_3)) * (((j) + (((((i) - (::x10aux::nullCheck(this__100698)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__100698)->FMGL(numElems_2)))))))));
    }))
    );
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_3<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    ::x10::array::DistArray_Block_3<TPMGL(T)>* this__100739 =
      this;
    x10_long i__100740 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)0ll));
    x10_long j__100741 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)1ll));
    x10_long k__100742 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)2ll));
    
    //#line 174 "x10/array/DistArray_Block_3.x10"
    ::x10aux::nullCheck(this__100739)->x10::array::template DistArray_Block_3<TPMGL(T)>::validateIndex(
      i__100740, j__100741, k__100742);
    
    //#line 186 "x10/array/DistArray_Block_3.x10"
    return (::x10aux::nullCheck(this__100739)->FMGL(raw))->unchecked_apply(((k__100742) + (((::x10aux::nullCheck(this__100739)->FMGL(numElems_3)) * (((j__100741) + (((((i__100740) - (::x10aux::nullCheck(this__100739)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__100739)->FMGL(numElems_2))))))))));
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_3<TPMGL(T)>::__set(
  x10_long i, x10_long j, x10_long k, TPMGL(T) v) {
    ...
    return (this->FMGL(raw))->unchecked_set((__extension__ ({
        ::x10::array::DistArray_Block_3<TPMGL(T)>* this__100712 =
          this;
        ((k) + (((::x10aux::nullCheck(this__100712)->FMGL(numElems_3)) * (((j) + (((((i) - (::x10aux::nullCheck(this__100712)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__100712)->FMGL(numElems_2)))))))));
    }))
    , v);
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_Block_3<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    ::x10::array::DistArray_Block_3<TPMGL(T)>* this__100746 =
      this;
    x10_long i__100747 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)0ll));
    x10_long j__100748 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)1ll));
    x10_long k__100749 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)2ll));
    
    //#line 201 "x10/array/DistArray_Block_3.x10"
    ::x10aux::nullCheck(this__100746)->x10::array::template DistArray_Block_3<TPMGL(T)>::validateIndex(
      i__100747, j__100748, k__100749);
    
    //#line 215 "x10/array/DistArray_Block_3.x10"
    return (::x10aux::nullCheck(this__100746)->FMGL(raw))->unchecked_set(((k__100749) + (((::x10aux::nullCheck(this__100746)->FMGL(numElems_3)) * (((j__100748) + (((((i__100747) - (::x10aux::nullCheck(this__100746)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__100746)->FMGL(numElems_2))))))))), v);
...
template<class TPMGL(T)> void x10::array::DistArray_Block_3<TPMGL(T)>::validateIndex(
  x10_long i, x10_long j, x10_long k) {
    ...
    if ((true && ((((((j) < (((x10_long)0ll))) || ((j) >= (this->FMGL(numElems_2)))) ||
                  ((k) < (((x10_long)0ll)))) || ((k) >= (this->FMGL(numElems_3)))))))
    {
...
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::array::DistArray_Block_3<TPMGL(T)>::getPatch(
  ::x10::array::IterationSpace* space) {
        ...
        ((::x10aux::nullCheck(r)->FMGL(max2)) <= (this->FMGL(localIndices)->FMGL(max2)))))))
    {
        ...
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::ArrayIndexOutOfBoundsException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::DistArray_Block_3_Strings::sl__163965), r), (&::x10::array::DistArray_Block_3_Strings::sl__163966)), this->FMGL(localIndices)))));
    }
    ...
    x10_long i2__100538min__100760 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::min(
                                       ((x10_long)2ll));
    x10_long i2__100538max__100761 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::max(
                                       ((x10_long)2ll));
    x10_long i1__100569min__100762 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::min(
                                       ((x10_long)1ll));
    x10_long i1__100569max__100763 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::max(
                                       ((x10_long)1ll));
    x10_long i0__100600min__100764 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::min(
                                       ((x10_long)0ll));
    x10_long i0__100600max__100765 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::max(
                                       ((x10_long)0ll));
    {
        x10_long i__100766;
        for (i__100766 = i0__100600min__100764; ((i__100766) <= (i0__100600max__100765));
             i__100766 = ((i__100766) + (((x10_long)1ll))))
        {
            {
                x10_long i__100768;
                for (i__100768 = i1__100569min__100762; ((i__100768) <= (i1__100569max__100763));
                     i__100768 = ((i__100768) + (((x10_long)1ll))))
                {
                    {
                        x10_long i__100770;
                        for (i__100770 = i2__100538min__100760;
                             ((i__100770) <= (i2__100538max__100761));
                             i__100770 = ((i__100770) + (((x10_long)1ll))))
                        {
                            
                            //#line 262 "x10/array/DistArray_Block_3.x10"
                            patch->x10::lang::template Rail< TPMGL(T) >::__set(
                              (__extension__ ({
                                  x10_long pre__100754 = patchIndex;
                                  patchIndex = ((patchIndex) + (((x10_long)1ll)));
                                  pre__100754;
                              }))
                              , this->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                  (__extension__ ({
                                      ::x10::array::DistArray_Block_3<TPMGL(T)>* this__100755 =
                                        this;
                                      ((i__100770) + (((::x10aux::nullCheck(this__100755)->FMGL(numElems_3)) * (((i__100768) + (((((i__100766) - (::x10aux::nullCheck(this__100755)->FMGL(minIndex_1)))) * (::x10aux::nullCheck(this__100755)->FMGL(numElems_2)))))))));
                                  }))
                                  ));
                        }
                    }
