...
class DistArray_Strings {
  public:
    static ::x10::lang::String sl__164194;
    static ::x10::lang::String sl__164190;
    static ::x10::lang::String sl__164189;
    static ::x10::lang::String sl__164191;
    static ::x10::lang::String sl__164195;
    static ::x10::lang::String sl__164193;
    static ::x10::lang::String sl__164192;
    static ::x10::lang::String sl__164196;
};
...
template<class TPMGL(T), class TPMGL(U)> class x10_array_DistArray__closure__1 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        TPMGL(U) localRes = (__extension__ ({
            ::x10::lang::Rail< TPMGL(T) >* src__102229 = (__extension__ ({
                ::x10::array::DistArray<TPMGL(T)>* this__102227 = saved_this;
                ::x10aux::nullCheck(this__102227)->FMGL(raw);
            }))
            ;
            
            //#line 132 "x10/util/RailUtils.x10"
            TPMGL(U) accum__102232 = unit;
            
            //#line 133 "x10/util/RailUtils.x10"
            x10_long i__96596max__102269 = (x10_long)(::x10aux::nullCheck(src__102229)->FMGL(size));
            {
                x10_long i__102270;
                for (i__102270 = ((x10_long)0ll); ((i__102270) < (i__96596max__102269));
                     i__102270 = ((i__102270) + (((x10_long)1ll))))
                {
                    
                    //#line 134 "x10/util/RailUtils.x10"
                    accum__102232 = ::x10::lang::Fun_0_2<TPMGL(U), TPMGL(T), TPMGL(U)>::__apply(::x10aux::nullCheck(lop), 
                      accum__102232, ::x10aux::nullCheck(src__102229)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                       i__102270));
                }
            }
            accum__102232;
...
template<class TPMGL(T), class TPMGL(U)> class x10_array_DistArray__closure__2 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        ::x10::lang::Rail< TPMGL(T) >* s = (__extension__ ({
            ::x10::array::DistArray<TPMGL(T)>* this__102239 = saved_this;
            ::x10aux::nullCheck(this__102239)->FMGL(raw);
        }))
        ;
        ...
        x10_long i__96634max__102276 = (x10_long)(::x10aux::nullCheck(s)->FMGL(size));
        {
            x10_long i__102277;
            for (i__102277 = ((x10_long)0ll); ((i__102277) < (i__96634max__102276));
                 i__102277 = ((i__102277) + (((x10_long)1ll)))) {
                
                //#line 181 "x10/util/RailUtils.x10"
                d->x10::lang::template Rail< TPMGL(U) >::__set(i__102277,
...
template<class TPMGL(T), class TPMGL(S), class TPMGL(U)> class x10_array_DistArray__closure__3 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        ::x10::lang::Rail< TPMGL(T) >* s1 = (__extension__ ({
            ::x10::array::DistArray<TPMGL(T)>* this__102251 = saved_this;
            ::x10aux::nullCheck(this__102251)->FMGL(raw);
        }))
        ;
                                      ...
                                      (x10_long)(::x10aux::nullCheck(s2)->FMGL(size)))))
        {
            ...
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::IllegalArgumentException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::DistArray_Strings::sl__164189), (x10_long)(::x10aux::nullCheck(s1)->FMGL(size))), (&::x10::array::DistArray_Strings::sl__164190)), (x10_long)(::x10aux::nullCheck(s2)->FMGL(size))), (&::x10::array::DistArray_Strings::sl__164191)), ::x10::lang::Place::_make(::x10aux::here)))));
        }
        
        //#line 267 "x10/array/DistArray.x10"
        ::x10::lang::Rail< TPMGL(S) >* src__102287 = (__extension__ ({
            ::x10::lang::Rail< TPMGL(S) >* t__102288 = s2;
            if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__102288)->FMGL(size)),
                                           (x10_long)(::x10aux::nullCheck(s1)->FMGL(size))))))
            {
                ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::array::DistArray_Strings::sl__164192))));
            }
            t__102288;
        }))
        ;
        ...
        x10_long i__96653max__102283 = (x10_long)(::x10aux::nullCheck(s1)->FMGL(size));
        {
            x10_long i__102284;
            for (i__102284 = ((x10_long)0ll); ((i__102284) < (i__96653max__102283));
                 i__102284 = ((i__102284) + (((x10_long)1ll))))
            {
                
                //#line 204 "x10/util/RailUtils.x10"
                d->x10::lang::template Rail< TPMGL(U) >::__set(
                  i__102284, ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(S), TPMGL(U)>::__apply(::x10aux::nullCheck(op), 
                    s1->x10::lang::template Rail< TPMGL(T) >::__apply(
                      i__102284), ::x10aux::nullCheck(src__102287)->x10::lang::template Rail< TPMGL(S) >::__apply(
                                    i__102284)));
            }
        }
...
template<class TPMGL(T)> template<class TPMGL(U)> TPMGL(U) x10::array::DistArray<TPMGL(T)>::reduce(
  ...
  TPMGL(U) unit) {
    ...
    ::x10::array::DistArray<TPMGL(T)>* out__102272 = this;
    
    //#line 39 "x10/array/DistArray.x10"
    reducer->FMGL(out__) = out__102272;
    ...
    TPMGL(U) result;
    {
        ::x10::xrx::FinishState* fs__102299 = ::x10aux::class_cast_unchecked< ::x10::xrx::FinishState*>(::x10::xrx::Runtime::template startCollectingFinish< TPMGL(U) >(
        ...
        try {
            {
                ...
                {
                    ::x10::lang::Iterator< ::x10::lang::Place>* where__99168;
                    for (where__99168 = ::x10aux::nullCheck(this->FMGL(placeGroup))->iterator();
                         ::x10::lang::Iterator< ::x10::lang::Place>::hasNext(::x10aux::nullCheck(where__99168));
                         ) {
                        ::x10::lang::Place where = ::x10::lang::Iterator< ::x10::lang::Place>::next(::x10aux::nullCheck(where__99168));
