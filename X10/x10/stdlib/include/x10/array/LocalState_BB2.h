...
template<class TPMGL(S)> void x10::array::LocalState_BB2<TPMGL(S)>::_constructor(
    ...
    ::x10::array::LocalState<TPMGL(S)>* this__101328 = this;
    
    //#line 301 "x10/array/DistArray.x10"
    ::x10aux::nullCheck(this__101328)->FMGL(pg) = pg;
    ::x10aux::nullCheck(this__101328)->FMGL(rail) = data;
    ::x10aux::nullCheck(this__101328)->FMGL(size) = size;
...
template<class TPMGL(S)> ::x10::array::LocalState_BB2<TPMGL(S)>*
  x10::array::LocalState_BB2<void>::make(::x10::lang::PlaceGroup* pg,
    ...
    ::x10::array::Dist_BlockBlock_2* dist =  (new (::x10aux::alloc_z< ::x10::array::Dist_BlockBlock_2>()) ::x10::array::Dist_BlockBlock_2());
    (dist)->::x10::array::Dist_BlockBlock_2::_constructor(
      pg, globalSpace);
    ...
    if (dist->FMGL(localIndices)->x10::array::DenseIterationSpace_2::isEmpty())
    {
        ...
        {
            x10_long i__101339;
            for (i__101339 = low1; ((i__101339) <= (hi1));
                 i__101339 = ((i__101339) + (((x10_long)1ll))))
            {
                
                //#line 296 "x10/array/DistArray_BlockBlock_2.x10"
                {
                    x10_long i__101335;
                    for (i__101335 = low2; ((i__101335) <= (hi2));
                         i__101335 = ((i__101335) + (((x10_long)1ll))))
                    {
                        
                        //#line 297 "x10/array/DistArray_BlockBlock_2.x10"
                        x10_long offset__101332 = ((((i__101335) - (low2))) + (((((i__101339) - (low1))) * (localSize2))));
                        
                        //#line 298 "x10/array/DistArray_BlockBlock_2.x10"
                        data->x10::lang::template Rail< TPMGL(S) >::__set(
                          offset__101332, ::x10::lang::Fun_0_2<x10_long, x10_long, TPMGL(S)>::__apply(::x10aux::nullCheck(init), 
                            i__101339, i__101335));
                    }
                }
    ...
    ::x10::array::LocalState_BB2<TPMGL(S)>* alloc__101341 =
       (new (::x10aux::alloc_z< ::x10::array::LocalState_BB2<TPMGL(S)> >()) ::x10::array::LocalState_BB2<TPMGL(S)>());
    (alloc__101341)->::x10::array::LocalState_BB2<TPMGL(S)>::_constructor(
      pg, data, ((m) * (n)), dist);
    return alloc__101341;
