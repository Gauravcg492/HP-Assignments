...
template<class TPMGL(S)> void x10::array::LocalState_B2<TPMGL(S)>::_constructor(
    ...
    ::x10::array::LocalState<TPMGL(S)>* this__100030 = this;
    
    //#line 301 "x10/array/DistArray.x10"
    ::x10aux::nullCheck(this__100030)->FMGL(pg) = pg;
    ::x10aux::nullCheck(this__100030)->FMGL(rail) = data;
    ::x10aux::nullCheck(this__100030)->FMGL(size) = size;
...
template<class TPMGL(S)> ::x10::array::LocalState_B2<TPMGL(S)>*
  x10::array::LocalState_B2<void>::make(::x10::lang::PlaceGroup* pg,
    ...
    if (dist->FMGL(localIndices)->x10::array::DenseIterationSpace_2::isEmpty())
    {
        ...
        {
            x10_long i__100041;
            for (i__100041 = low1; ((i__100041) <= (hi1));
                 i__100041 = ((i__100041) + (((x10_long)1ll))))
            {
                
                //#line 290 "x10/array/DistArray_Block_2.x10"
                {
                    x10_long i__100037;
                    for (i__100037 = low2; ((i__100037) <= (hi2));
                         i__100037 = ((i__100037) + (((x10_long)1ll))))
                    {
                        
                        //#line 291 "x10/array/DistArray_Block_2.x10"
                        x10_long offset__100034 = ((((i__100037) - (low2))) + (((((i__100041) - (low1))) * (localSize2))));
                        
                        //#line 292 "x10/array/DistArray_Block_2.x10"
                        data->x10::lang::template Rail< TPMGL(S) >::__set(
                          offset__100034, ::x10::lang::Fun_0_2<x10_long, x10_long, TPMGL(S)>::__apply(::x10aux::nullCheck(init), 
                            i__100041, i__100037));
                    }
                }
    ...
    ::x10::array::LocalState_B2<TPMGL(S)>* alloc__100043 =
       (new (::x10aux::alloc_z< ::x10::array::LocalState_B2<TPMGL(S)> >()) ::x10::array::LocalState_B2<TPMGL(S)>());
    (alloc__100043)->::x10::array::LocalState_B2<TPMGL(S)>::_constructor(
      pg, data, ((m) * (n)), dist);
    return alloc__100043;
