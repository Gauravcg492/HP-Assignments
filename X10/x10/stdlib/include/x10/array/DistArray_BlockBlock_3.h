...
class DistArray_BlockBlock_3_Strings {
  public:
    static ::x10::lang::String sl__164091;
    static ::x10::lang::String sl__164092;
};
...
template<class TPMGL(T)> ::x10::array::DenseIterationSpace_3* x10::array::DistArray_BlockBlock_3<TPMGL(T)>::reloadLocalIndices(
    ...
    return (!::x10aux::struct_equals(ls, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)))
      ...
      : ((__extension__ ({
             ::x10::array::DenseIterationSpace_3* alloc__101845 =
                (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_3>()) ::x10::array::DenseIterationSpace_3());
             (alloc__101845)->::x10::array::DenseIterationSpace_3::_constructor(
...
template<class TPMGL(T)> void x10::array::DistArray_BlockBlock_3<TPMGL(T)>::_constructor(
    ...
    this->FMGL(globalIndices) = (__extension__ ({
        ::x10::array::DenseIterationSpace_3* alloc__101846 =
           (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_3>()) ::x10::array::DenseIterationSpace_3());
        (alloc__101846)->::x10::array::DenseIterationSpace_3::_constructor(
          ((x10_long)0ll), ((x10_long)0ll), ((x10_long)0ll),
    ...
    this->FMGL(minIndex_1) = (__extension__ ({
        ::x10::array::DistArray_BlockBlock_3<TPMGL(T)>* this__102003 =
          this;
        ::x10aux::nullCheck(this__102003)->FMGL(localIndices)->x10::array::DenseIterationSpace_3::min(
          ((x10_long)0ll));
    }))
    ;
    ...
    this->FMGL(minIndex_2) = (__extension__ ({
        ::x10::array::DistArray_BlockBlock_3<TPMGL(T)>* this__102005 =
          this;
        ::x10aux::nullCheck(this__102005)->FMGL(localIndices)->x10::array::DenseIterationSpace_3::min(
          ((x10_long)1ll));
    }))
    ;
...
template<class TPMGL(T)> ::x10::lang::Place x10::array::DistArray_BlockBlock_3<TPMGL(T)>::place(
  x10_long i, x10_long j, x10_long k) {
    ...
    x10_long tmp = ::x10::array::BlockingUtils::mapIndexToBlockBlockPartition(
                     ...
                     (__extension__ ({
                         ::x10::lang::PlaceGroup* this__102007 =
                           this->FMGL(placeGroup);
                         ::x10aux::nullCheck(this__102007)->numPlaces();
                     }))
                     , i, j);
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_3<TPMGL(T)>::__apply(
  x10_long i, x10_long j, x10_long k) {
    ...
    return (this->FMGL(raw))->unchecked_apply((__extension__ ({
        ::x10::array::DistArray_BlockBlock_3<TPMGL(T)>* this__102012 =
          this;
        ((k) + (((::x10aux::nullCheck(this__102012)->FMGL(numElems_3)) * (((((j) - (::x10aux::nullCheck(this__102012)->FMGL(minIndex_2)))) + (((::x10aux::nullCheck(this__102012)->FMGL(numElemsLocal_2)) * (((i) - (::x10aux::nullCheck(this__102012)->FMGL(minIndex_1)))))))))));
    }))
    );
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_3<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    ::x10::array::DistArray_BlockBlock_3<TPMGL(T)>* this__102053 =
      this;
    x10_long i__102054 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)0ll));
    x10_long j__102055 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)1ll));
    x10_long k__102056 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)2ll));
    
    //#line 183 "x10/array/DistArray_BlockBlock_3.x10"
    ::x10aux::nullCheck(this__102053)->x10::array::template DistArray_BlockBlock_3<TPMGL(T)>::validateIndex(
      i__102054, j__102055, k__102056);
    
    //#line 195 "x10/array/DistArray_BlockBlock_3.x10"
    return (::x10aux::nullCheck(this__102053)->FMGL(raw))->unchecked_apply(((k__102056) + (((::x10aux::nullCheck(this__102053)->FMGL(numElems_3)) * (((((j__102055) - (::x10aux::nullCheck(this__102053)->FMGL(minIndex_2)))) + (((::x10aux::nullCheck(this__102053)->FMGL(numElemsLocal_2)) * (((i__102054) - (::x10aux::nullCheck(this__102053)->FMGL(minIndex_1))))))))))));
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_3<TPMGL(T)>::__set(
  x10_long i, x10_long j, x10_long k, TPMGL(T) v) {
    ...
    return (this->FMGL(raw))->unchecked_set((__extension__ ({
        ::x10::array::DistArray_BlockBlock_3<TPMGL(T)>* this__102026 =
          this;
        ((k) + (((::x10aux::nullCheck(this__102026)->FMGL(numElems_3)) * (((((j) - (::x10aux::nullCheck(this__102026)->FMGL(minIndex_2)))) + (((::x10aux::nullCheck(this__102026)->FMGL(numElemsLocal_2)) * (((i) - (::x10aux::nullCheck(this__102026)->FMGL(minIndex_1)))))))))));
    }))
    , v);
...
template<class TPMGL(T)> TPMGL(T) x10::array::DistArray_BlockBlock_3<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    ::x10::array::DistArray_BlockBlock_3<TPMGL(T)>* this__102060 =
      this;
    x10_long i__102061 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)0ll));
    x10_long j__102062 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)1ll));
    x10_long k__102063 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                           ((x10_long)2ll));
    
    //#line 210 "x10/array/DistArray_BlockBlock_3.x10"
    ::x10aux::nullCheck(this__102060)->x10::array::template DistArray_BlockBlock_3<TPMGL(T)>::validateIndex(
      i__102061, j__102062, k__102063);
    
    //#line 224 "x10/array/DistArray_BlockBlock_3.x10"
    return (::x10aux::nullCheck(this__102060)->FMGL(raw))->unchecked_set(((k__102063) + (((::x10aux::nullCheck(this__102060)->FMGL(numElems_3)) * (((((j__102062) - (::x10aux::nullCheck(this__102060)->FMGL(minIndex_2)))) + (((::x10aux::nullCheck(this__102060)->FMGL(numElemsLocal_2)) * (((i__102061) - (::x10aux::nullCheck(this__102060)->FMGL(minIndex_1))))))))))), v);
...
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::array::DistArray_BlockBlock_3<TPMGL(T)>::getPatch(
  ::x10::array::IterationSpace* space) {
        ...
        ((::x10aux::nullCheck(r)->FMGL(max2)) <= (this->FMGL(localIndices)->FMGL(max2)))))))
    {
        ...
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::ArrayIndexOutOfBoundsException::_make(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::array::DistArray_BlockBlock_3_Strings::sl__164091), r), (&::x10::array::DistArray_BlockBlock_3_Strings::sl__164092)), this->FMGL(localIndices)))));
    }
    ...
    x10_long i2__101850min__102074 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::min(
                                       ((x10_long)2ll));
    x10_long i2__101850max__102075 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::max(
                                       ((x10_long)2ll));
    x10_long i1__101881min__102076 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::min(
                                       ((x10_long)1ll));
    x10_long i1__101881max__102077 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::max(
                                       ((x10_long)1ll));
    x10_long i0__101912min__102078 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::min(
                                       ((x10_long)0ll));
    x10_long i0__101912max__102079 = ::x10aux::nullCheck(r)->x10::array::DenseIterationSpace_3::max(
                                       ((x10_long)0ll));
    {
        x10_long i__102080;
        for (i__102080 = i0__101912min__102078; ((i__102080) <= (i0__101912max__102079));
             i__102080 = ((i__102080) + (((x10_long)1ll))))
        {
            {
                x10_long i__102082;
                for (i__102082 = i1__101881min__102076; ((i__102082) <= (i1__101881max__102077));
                     i__102082 = ((i__102082) + (((x10_long)1ll))))
                {
                    {
                        x10_long i__102084;
                        for (i__102084 = i2__101850min__102074;
                             ((i__102084) <= (i2__101850max__102075));
                             i__102084 = ((i__102084) + (((x10_long)1ll))))
                        {
                            
                            //#line 272 "x10/array/DistArray_BlockBlock_3.x10"
                            patch->x10::lang::template Rail< TPMGL(T) >::__set(
                              (__extension__ ({
                                  x10_long pre__102068 = patchIndex;
                                  patchIndex = ((patchIndex) + (((x10_long)1ll)));
                                  pre__102068;
                              }))
                              , this->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                  (__extension__ ({
                                      ::x10::array::DistArray_BlockBlock_3<TPMGL(T)>* this__102069 =
                                        this;
                                      ((i__102084) + (((::x10aux::nullCheck(this__102069)->FMGL(numElems_3)) * (((((i__102082) - (::x10aux::nullCheck(this__102069)->FMGL(minIndex_2)))) + (((::x10aux::nullCheck(this__102069)->FMGL(numElemsLocal_2)) * (((i__102080) - (::x10aux::nullCheck(this__102069)->FMGL(minIndex_1)))))))))));
                                  }))
                                  ));
                        }
                    }
