...
template<class TPMGL(S)> void x10::array::LocalState_B3<TPMGL(S)>::_constructor(
    ...
    ::x10::array::LocalState<TPMGL(S)>* this__100773 = this;
    
    //#line 301 "x10/array/DistArray.x10"
    ::x10aux::nullCheck(this__100773)->FMGL(pg) = pg;
    ::x10aux::nullCheck(this__100773)->FMGL(rail) = data;
    ::x10aux::nullCheck(this__100773)->FMGL(size) = size;
...
template<class TPMGL(S)> ::x10::array::LocalState_B3<TPMGL(S)>*
  x10::array::LocalState_B3<void>::make(::x10::lang::PlaceGroup* pg,
    ...
    if (dist->FMGL(localIndices)->x10::array::DenseIterationSpace_3::isEmpty())
    {
        ...
        {
            x10_long i__100788;
            for (i__100788 = low1; ((i__100788) <= (hi1));
                 i__100788 = ((i__100788) + (((x10_long)1ll))))
            {
                
                //#line 304 "x10/array/DistArray_Block_3.x10"
                {
                    x10_long i__100784;
                    for (i__100784 = low2; ((i__100784) <= (hi2));
                         i__100784 = ((i__100784) + (((x10_long)1ll))))
                    {
                        
                        //#line 305 "x10/array/DistArray_Block_3.x10"
                        {
                            x10_long i__100780;
                            for (i__100780 = low3; ((i__100780) <= (hi3));
                                 i__100780 = ((i__100780) + (((x10_long)1ll))))
                            {
                                
                                //#line 306 "x10/array/DistArray_Block_3.x10"
                                x10_long offset__100777 =
                                  ((((i__100780) - (low3))) + (((localSize3) * (((((i__100784) - (low2))) + (((((i__100788) - (low1))) * (localSize2))))))));
                                
                                //#line 307 "x10/array/DistArray_Block_3.x10"
                                data->x10::lang::template Rail< TPMGL(S) >::__set(
                                  offset__100777, ::x10::lang::Fun_0_3<x10_long, x10_long, x10_long, TPMGL(S)>::__apply(::x10aux::nullCheck(init), 
                                    i__100788, i__100784,
                                    i__100780));
                            }
                        }
    ...
    ::x10::array::LocalState_B3<TPMGL(S)>* alloc__100790 =
       (new (::x10aux::alloc_z< ::x10::array::LocalState_B3<TPMGL(S)> >()) ::x10::array::LocalState_B3<TPMGL(S)>());
    (alloc__100790)->::x10::array::LocalState_B3<TPMGL(S)>::_constructor(
      pg, data, ((((m) * (n))) * (p)), dist);
    return alloc__100790;
