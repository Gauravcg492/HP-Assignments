...
template<class TPMGL(T)> void x10::array::Array_1<TPMGL(T)>::_constructor(
    ...
    ::x10::lang::Rail< TPMGL(T) >* rail__92941 = this->FMGL(raw);
    x10_long i__91593max__92942 = (x10_long)(::x10aux::nullCheck(rail__92941)->FMGL(size));
    {
        x10_long i__92943;
        for (i__92943 = ((x10_long)0ll); ((i__92943) < (i__91593max__92942));
             i__92943 = ((i__92943) + (((x10_long)1ll))))
        {
            
            //#line 48 "x10/array/Array_1.x10"
            this->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__set(
              i__92943, ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>::__apply(::x10aux::nullCheck(init), 
                i__92943));
        }
    }
...
template<class TPMGL(T)> void x10::array::Array_1<TPMGL(T)>::_constructor(
    ...
    ::x10::array::Array<TPMGL(T)>* this__92946 = this;
    ::x10::lang::Rail< TPMGL(T) >* r__92947 = ::x10::lang::Rail< TPMGL(T) >::_make(::x10aux::nullCheck(src)->FMGL(raw));
    
    //#line 65 "x10/array/Array.x10"
    ::x10aux::nullCheck(this__92946)->FMGL(size) = (x10_long)(::x10aux::nullCheck(r__92947)->FMGL(size));
    
    //#line 66 "x10/array/Array.x10"
    ::x10aux::nullCheck(this__92946)->FMGL(raw) = r__92947;
...
template<class TPMGL(T)> void x10::array::Array_1<TPMGL(T)>::_constructor(
    ...
    ::x10::array::Array<TPMGL(T)>* this__92949 = this;
    
    //#line 65 "x10/array/Array.x10"
    ::x10aux::nullCheck(this__92949)->FMGL(size) = (x10_long)(::x10aux::nullCheck(r)->FMGL(size));
    
    //#line 66 "x10/array/Array.x10"
    ::x10aux::nullCheck(this__92949)->FMGL(raw) = r;
...
template<class TPMGL(T)> ::x10::array::IterationSpace* x10::array::Array_1<TPMGL(T)>::indices(
    ...
    ::x10::array::DenseIterationSpace_1* alloc__92952 =  (new (::x10aux::alloc_z< ::x10::array::DenseIterationSpace_1>()) ::x10::array::DenseIterationSpace_1());
    (alloc__92952)->::x10::array::DenseIterationSpace_1::_constructor(
      ((x10_long)0ll), ((this->FMGL(size)) - (((x10_long)1ll))));
    return reinterpret_cast< ::x10::array::IterationSpace*>(alloc__92952);
...
template<class TPMGL(T)> TPMGL(T) x10::array::Array_1<TPMGL(T)>::__apply(
  ::x10::lang::Point* p) {
    ::x10::array::Array_1<TPMGL(T)>* this__92953 = this;
    x10_long i__92954 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                          ((x10_long)0ll));
    return ::x10aux::nullCheck(this__92953)->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__apply(
             i__92954);
...
template<class TPMGL(T)> TPMGL(T) x10::array::Array_1<TPMGL(T)>::__set(
  ::x10::lang::Point* p, TPMGL(T) v) {
    ::x10::array::Array_1<TPMGL(T)>* this__92955 = this;
    x10_long i__92956 = ::x10aux::nullCheck(p)->x10::lang::Point::__apply(
                          ((x10_long)0ll));
    
    //#line 121 "x10/array/Array_1.x10"
    ::x10aux::nullCheck(this__92955)->FMGL(raw)->x10::lang::template Rail< TPMGL(T) >::__set(
      i__92956, v);
...
template<class TPMGL(T)> ::x10::array::Array_1<TPMGL(T)>*
  x10::array::Array_1<void>::makeView(::x10::lang::Rail< TPMGL(T) >* r) {
    ...
    ::x10::array::Array_1<TPMGL(T)>* alloc__92951 =  (new (::x10aux::alloc_z< ::x10::array::Array_1<TPMGL(T)> >()) ::x10::array::Array_1<TPMGL(T)>());
    (alloc__92951)->::x10::array::Array_1<TPMGL(T)>::_constructor(
      r);
    return alloc__92951;
