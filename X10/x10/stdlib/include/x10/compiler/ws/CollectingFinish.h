...
template<class TPMGL(T)> ::x10::compiler::ws::Frame* x10::compiler::ws::CollectingFinish<TPMGL(T)>::realloc(
                                  ...
                                  this->FMGL(exceptions))))
    {
        ...
        ::x10aux::nullCheck(tmp)->FMGL(exceptions) = (__extension__ ({
            ::x10::util::GrowableRail< ::x10::lang::CheckedThrowable*>* alloc__107133 =
            ...
            (alloc__107133)->::x10::util::GrowableRail< ::x10::lang::CheckedThrowable*>::_constructor(
              ((x10_long)0ll));
            alloc__107133;
        }))
        ;
        ...
        while (!((__extension__ ({
                   ::x10::util::GrowableRail< ::x10::lang::CheckedThrowable*>* this__107262 =
                     this->FMGL(exceptions);
                   (::x10aux::struct_equals(::x10aux::nullCheck(this__107262)->FMGL(size),
                                            ((x10_long)0ll)));
               }))
               )) {
    ...
    }
    {
        ...
        ::x10::lang::CheckedThrowable* throwable__107266 =
        ...
        try {
            ...
            {
                ::x10::lang::CheckedThrowable* formal__107267 =
                  __exc395;
                {
                    throwable__107266 = formal__107267;
                }
            }
        }
        if ((!::x10aux::struct_equals(throwable__107266, reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
        {
            if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__107266))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__107266));
            }
        ...
        if ((!::x10aux::struct_equals(throwable__107266, reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL))))
        {
            if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__107266)))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__107266));
            }
