...
template<class TPMGL(T)> class x10_compiler_WorkerLocal__closure__1 : public ::x10::lang::Closure {
    ...
    static x10::lang::Reference* _deserialize(::x10aux::deserialization_buffer &buf) {
        ...
        TPMGL(T) that_t__106297 = buf.read<TPMGL(T)>();
        x10_compiler_WorkerLocal__closure__1<TPMGL(T) >* this_ = new (storage) x10_compiler_WorkerLocal__closure__1<TPMGL(T) >(that_op, that_t__106297);
        return this_;
    }
    
    x10_compiler_WorkerLocal__closure__1(::x10::lang::VoidFun_0_1<TPMGL(T)>* op, TPMGL(T) t__106297) : op(op), t__106297(t__106297) { }
...
template<class TPMGL(T)> void x10::compiler::WorkerLocal<TPMGL(T)>::_constructor(
    ...
    ::x10::compiler::WorkerLocal<TPMGL(T)>* this__106296 = this;
    ::x10aux::nullCheck(this__106296)->FMGL(init) = (::x10aux::class_cast_unchecked< ::x10::lang::Fun_0_0<TPMGL(T)>*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
  ...
  ::x10::lang::VoidFun_0_1<TPMGL(T)>* op) {
    {
        ...
        ::x10::xrx::FinishState* fs__106312 = ::x10::xrx::Runtime::startFinish();
        try {
            {
                x10_long i__104978max__106298 = (((x10_long)(::x10aux::nullCheck(this->FMGL(store))->FMGL(size))) - (((x10_long)1ll)));
                {
                    x10_long i__106299;
                    for (i__106299 = ((x10_long)0ll); ((i__106299) <= (i__104978max__106298));
                         i__106299 = ((i__106299) + (((x10_long)1ll))))
                    {
                        
                        //#line 58 "x10/compiler/WorkerLocal.x10"
                        TPMGL(T) t__106297 = ::x10aux::nullCheck(this->FMGL(store))->x10::lang::template Rail< TPMGL(T) >::__apply(
                                               i__106299);
                        
                        //#line 59 "x10/compiler/WorkerLocal.x10"
                        if ((!::x10aux::struct_equals(t__106297,
                                                      reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
                        {
                            
                            //#line 60 "x10/compiler/WorkerLocal.x10"
                            ::x10::xrx::Runtime::runAsync(
                              reinterpret_cast< ::x10::lang::VoidFun_0_0*>((new (::x10aux::alloc< ::x10::lang::VoidFun_0_0>(sizeof(x10_compiler_WorkerLocal__closure__1<TPMGL(T)>)))x10_compiler_WorkerLocal__closure__1<TPMGL(T)>(op, t__106297))));
                        }
            ...
            {
                ::x10::lang::CheckedThrowable* ct__106310 =
                  __exc377;
                {
                    ::x10::xrx::Runtime::pushException(ct__106310);
                }
            }
        }
        ::x10::xrx::Runtime::stopFinish(fs__106312);
    }
...
template<class TPMGL(T)> TPMGL(T) x10::compiler::WorkerLocal<TPMGL(T)>::reduce(
  ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* op) {
    ...
    x10_long i__104996max__106302 = (((x10_long)(::x10aux::nullCheck(this->FMGL(store))->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__106303;
        for (i__106303 = ((x10_long)0ll); ((i__106303) <= (i__104996max__106302));
             i__106303 = ((i__106303) + (((x10_long)1ll))))
        {
            
            //#line 72 "x10/compiler/WorkerLocal.x10"
            TPMGL(T) t__106301 = ::x10aux::nullCheck(this->FMGL(store))->x10::lang::template Rail< TPMGL(T) >::__apply(
                                   i__106303);
            
            //#line 73 "x10/compiler/WorkerLocal.x10"
            if ((!::x10aux::struct_equals(t__106301, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
            {
...
template<class TPMGL(T)> TPMGL(T) x10::compiler::WorkerLocal<TPMGL(T)>::reduce(
  TPMGL(T) result, ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* op) {
    ...
    x10_long i__105014max__106306 = (((x10_long)(::x10aux::nullCheck(this->FMGL(store))->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__106307;
        for (i__106307 = ((x10_long)0ll); ((i__106307) <= (i__105014max__106306));
             i__106307 = ((i__106307) + (((x10_long)1ll))))
        {
            
            //#line 92 "x10/compiler/WorkerLocal.x10"
            TPMGL(T) t__106305 = ::x10aux::nullCheck(this->FMGL(store))->x10::lang::template Rail< TPMGL(T) >::__apply(
                                   i__106307);
            
            //#line 93 "x10/compiler/WorkerLocal.x10"
            if ((!::x10aux::struct_equals(t__106305, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
            {
