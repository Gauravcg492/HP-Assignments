...
class ArrayList_Strings {
  public:
    static ::x10::lang::String sl__168085;
    static ::x10::lang::String sl__168086;
    static ::x10::lang::String sl__168087;
    static ::x10::lang::String sl__168083;
    static ::x10::lang::String sl__168084;
    static ::x10::lang::String sl__168088;
};
...
template<class TPMGL(T)> x10_boolean x10::util::ArrayList<TPMGL(T)>::contains(
  TPMGL(T) v) {
    ...
    x10_long i__108791max__136424 = (((__extension__ ({
        ::x10::util::GrowableRail<TPMGL(T)>* this__136425 = this->FMGL(a);
        ::x10aux::nullCheck(this__136425)->FMGL(size);
    }))
    ) - (((x10_long)1ll)));
    {
        x10_long i__136426;
        for (i__136426 = ((x10_long)0ll); ((i__136426) <= (i__108791max__136424));
             i__136426 = ((i__136426) + (((x10_long)1ll)))) {
...
template<class TPMGL(T)> void x10::util::ArrayList<TPMGL(T)>::clear(
    ...
    ::x10::util::GrowableRail<TPMGL(T)>* this__136428 = this->FMGL(a);
    
    //#line 186 "x10/util/GrowableRail.x10"
    (::x10aux::nullCheck(this__136428)->FMGL(data))->clear();
    
    //#line 187 "x10/util/GrowableRail.x10"
    ::x10aux::nullCheck(this__136428)->FMGL(size) = ((x10_long)0ll);
}
...
template<class TPMGL(T)> x10_boolean x10::util::ArrayList<TPMGL(T)>::remove(
  TPMGL(T) v) {
    ...
    x10_long i__108809max__136429 = (((__extension__ ({
        ::x10::util::GrowableRail<TPMGL(T)>* this__136430 =
          this->FMGL(a);
        ::x10aux::nullCheck(this__136430)->FMGL(size);
    }))
    ) - (((x10_long)1ll)));
    {
        x10_long i__136431;
        for (i__136431 = ((x10_long)0ll); ((i__136431) <= (i__108809max__136429));
             i__136431 = ((i__136431) + (((x10_long)1ll))))
        {
...
template<class TPMGL(T)> void x10::util::ArrayList<TPMGL(T)>::addBefore(
  x10_long i, TPMGL(T) v) {
    ...
    //#line 65 "x10/util/ArrayList.x10"
    {
        x10_long j;
        for (j = (((__extension__ ({
                 ::x10::util::GrowableRail<TPMGL(T)>* this__136363 =
                   this->FMGL(a);
                 ::x10aux::nullCheck(this__136363)->FMGL(size);
             }))
  ...
  x10_long i) {
    ...
    //#line 80 "x10/util/ArrayList.x10"
    {
        ...
        for (j = ((i) + (((x10_long)1ll))); ((j) < ((__extension__ ({
                                                ::x10::util::GrowableRail<TPMGL(T)>* this__136365 =
                                                  this->FMGL(a);
                                                ::x10aux::nullCheck(this__136365)->FMGL(size);
                                            }))
                                            )); j = ((j) + (((x10_long)1ll))))
        {
...
template<class TPMGL(T)> x10_long x10::util::ArrayList<TPMGL(T)>::size(
    ...
    ::x10::util::GrowableRail<TPMGL(T)>* this__136433 = this->FMGL(a);
    return ::x10aux::nullCheck(this__136433)->FMGL(size);
...
template<class TPMGL(T)> void x10::util::ArrayList<TPMGL(T)>::_constructor(
    ...
    this->FMGL(a) = (__extension__ ({
        ::x10::util::GrowableRail<TPMGL(T)>* alloc__108787 =
           (new (::x10aux::alloc_z< ::x10::util::GrowableRail<TPMGL(T)> >()) ::x10::util::GrowableRail<TPMGL(T)>());
        (alloc__108787)->::x10::util::GrowableRail<TPMGL(T)>::_constructor(
          size);
        alloc__108787;
    }))
    ;
...
template<class TPMGL(T)> TPMGL(T) x10::util::ArrayList<TPMGL(T)>::removeLast(
    ...
    return this->removeAt((((__extension__ ({
                              ::x10::util::GrowableRail<TPMGL(T)>* this__136374 =
                                this->FMGL(a);
                              ::x10aux::nullCheck(this__136374)->FMGL(size);
                          }))
                          ) - (((x10_long)1ll))));
...
template<class TPMGL(T)> TPMGL(T) x10::util::ArrayList<TPMGL(T)>::getLast(
    ...
    return this->get((((__extension__ ({
                         ::x10::util::GrowableRail<TPMGL(T)>* this__136376 =
                           this->FMGL(a);
                         ::x10aux::nullCheck(this__136376)->FMGL(size);
                     }))
                     ) - (((x10_long)1ll))));
...
template<class TPMGL(T)> ::x10::util::List<x10_long>* x10::util::ArrayList<TPMGL(T)>::indices(
    ...
    x10_long i__108827max__136436 = (((__extension__ ({
        ::x10::util::GrowableRail<TPMGL(T)>* this__136437 =
          this->FMGL(a);
        ::x10aux::nullCheck(this__136437)->FMGL(size);
    }))
    ) - (((x10_long)1ll)));
    {
        x10_long i__136438;
        for (i__136438 = ((x10_long)0ll); ((i__136438) <= (i__108827max__136436));
             i__136438 = ((i__136438) + (((x10_long)1ll))))
        {
  ...
  x10_long begin, x10_long end) {
    ...
    //#line 120 "x10/util/ArrayList.x10"
    {
        ...
        for (i = begin; (((i) < ((__extension__ ({
                            ::x10::util::GrowableRail<TPMGL(T)>* this__136380 =
                              this->FMGL(a);
                            ::x10aux::nullCheck(this__136380)->FMGL(size);
                        }))
  ...
  x10_long index, TPMGL(T) v) {
    ...
    //#line 131 "x10/util/ArrayList.x10"
    {
        ...
        for (i = index; ((i) < ((__extension__ ({
                            ::x10::util::GrowableRail<TPMGL(T)>* this__136382 =
                              this->FMGL(a);
                            ::x10aux::nullCheck(this__136382)->FMGL(size);
                        }))
                        )); i = ((i) + (((x10_long)1ll))))
        {
...
template<class TPMGL(T)> x10_long x10::util::ArrayList<TPMGL(T)>::lastIndexOf(
  TPMGL(T) v) {
    ...
    return this->lastIndexOf((((__extension__ ({
                                 ::x10::util::GrowableRail<TPMGL(T)>* this__136384 =
                                   this->FMGL(a);
                                 ::x10aux::nullCheck(this__136384)->FMGL(size);
                             }))
                             ) - (((x10_long)1ll))), v);
...
template<class TPMGL(T)> void x10::util::ArrayList<TPMGL(T)>::resize(
  x10_long newSize, TPMGL(T) value) {
    ...
    x10_long oldSize = (__extension__ ({
        ::x10::util::GrowableRail<TPMGL(T)>* this__136386 =
          this->FMGL(a);
        ::x10aux::nullCheck(this__136386)->FMGL(size);
    }))
    ;
    ...
    if (((newSize) > (oldSize))) {
        ...
        if (((newSize) > ((__extension__ ({
                ::x10::util::GrowableRail<TPMGL(T)>* this__136388 =
                  this->FMGL(a);
                (x10_long)(::x10aux::nullCheck(::x10aux::nullCheck(this__136388)->FMGL(data))->FMGL(size));
            }))
            ))) {
        ...
        x10_long i__108845max__136441 = ((newSize) - (((x10_long)1ll)));
        {
            x10_long i__136442;
            for (i__136442 = oldSize; ((i__136442) <= (i__108845max__136441));
                 i__136442 = ((i__136442) + (((x10_long)1ll))))
            {
...
template<class TPMGL(T)> ::x10::lang::Iterator<TPMGL(T)>*
  x10::util::ArrayList<TPMGL(T)>::iterator() {
    ...
    ::x10::util::ArrayList__It<TPMGL(T)>* alloc__136449 =
       (new (::x10aux::alloc_z< ::x10::util::ArrayList__It<TPMGL(T)> >()) ::x10::util::ArrayList__It<TPMGL(T)>());
    ::x10::util::ArrayList<TPMGL(T)>* al__136448 = this;
    
    //#line 188 "x10/util/ArrayList.x10"
    alloc__136449->FMGL(i) = ((x10_long)0ll);
    
    //#line 198 "x10/util/ArrayList.x10"
    alloc__136449->FMGL(al) = al__136448;
    
    //#line 199 "x10/util/ArrayList.x10"
    alloc__136449->FMGL(i) = ((x10_long)-1ll);
    
    //#line 240 "x10/util/ArrayList.x10"
    return reinterpret_cast< ::x10::lang::Iterator<TPMGL(T)>*>(reinterpret_cast< ::x10::util::ListIterator<TPMGL(T)>*>(alloc__136449));
...
template<class TPMGL(T)> ::x10::util::ListIterator<TPMGL(T)>*
  x10::util::ArrayList<TPMGL(T)>::iteratorFrom(x10_long i) {
    ...
    ::x10::util::ArrayList__It<TPMGL(T)>* alloc__136452 =
       (new (::x10aux::alloc_z< ::x10::util::ArrayList__It<TPMGL(T)> >()) ::x10::util::ArrayList__It<TPMGL(T)>());
    ::x10::util::ArrayList<TPMGL(T)>* al__136450 = this;
    
    //#line 188 "x10/util/ArrayList.x10"
    alloc__136452->FMGL(i) = ((x10_long)0ll);
    
    //#line 198 "x10/util/ArrayList.x10"
    alloc__136452->FMGL(al) = al__136450;
    
    //#line 199 "x10/util/ArrayList.x10"
    alloc__136452->FMGL(i) = i;
    
    //#line 244 "x10/util/ArrayList.x10"
    return reinterpret_cast< ::x10::util::ListIterator<TPMGL(T)>*>(alloc__136452);
...
template<class TPMGL(T)> void x10::util::ArrayList<TPMGL(T)>::reverse(
    ...
    x10_long length = (__extension__ ({
        ::x10::util::GrowableRail<TPMGL(T)>* this__136407 =
          this->FMGL(a);
        ::x10aux::nullCheck(this__136407)->FMGL(size);
    }))
    ;
...
template<class TPMGL(T)> void x10::util::ArrayList<TPMGL(T)>::sort(
  ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), x10_int>* cmp) {
    ::x10::util::RailUtils::template qsort< TPMGL(T) >((__extension__ ({
                                                           ::x10::util::GrowableRail<TPMGL(T)>* this__136409 =
                                                             this->FMGL(a);
                                                           ::x10aux::nullCheck(this__136409)->FMGL(data);
                                                       }))
                                                       , ((x10_long)0ll),
                                                       (((__extension__ ({
                                                           ::x10::util::GrowableRail<TPMGL(T)>* this__136411 =
                                                             this->FMGL(a);
                                                           ::x10aux::nullCheck(this__136411)->FMGL(size);
                                                       }))
                                                       ) - (((x10_long)1ll))),
                                                       cmp);
}
...
template<class TPMGL(T)> x10_long x10::util::ArrayList<TPMGL(T)>::binarySearch(
  TPMGL(T) key, ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), x10_int>* cmp) {
    return ::x10::util::RailUtils::template binarySearch< TPMGL(T) >(
             (__extension__ ({
                 ::x10::util::GrowableRail<TPMGL(T)>* this__136413 =
                   this->FMGL(a);
                 ::x10aux::nullCheck(this__136413)->FMGL(data);
             }))
             , key, ((x10_long)0ll), (__extension__ ({
                 ::x10::util::GrowableRail<TPMGL(T)>* this__136415 =
                   this->FMGL(a);
                 ::x10aux::nullCheck(this__136415)->FMGL(size);
             }))
             , cmp);
...
template<class TPMGL(T)> x10_long x10::util::ArrayList<TPMGL(T)>::binarySearch(
  TPMGL(T) key) {
    ...
    return ::x10::util::RailUtils::template binarySearch< TPMGL(T) >(
             (__extension__ ({
                 ::x10::util::GrowableRail<TPMGL(T)>* this__136417 =
                   this->FMGL(a);
                 ::x10aux::nullCheck(this__136417)->FMGL(data);
             }))
             , key, ((x10_long)0ll), (__extension__ ({
                 ::x10::util::GrowableRail<TPMGL(T)>* this__136419 =
                   this->FMGL(a);
                 ::x10aux::nullCheck(this__136419)->FMGL(size);
             }))
...
template<class TPMGL(T)> ::x10::lang::String* x10::util::ArrayList<TPMGL(T)>::toString(
    ...
    sb->add((&::x10::util::ArrayList_Strings::sl__168083));
    
    //#line 288 "x10/util/ArrayList.x10"
    x10_long sz = (__extension__ ({
        x10_long a__136421 = this->size();
        ((a__136421) < (((x10_long)10ll))) ? (a__136421) : (((x10_long)10ll));
    }))
    ;
    ...
    //#line 289 "x10/util/ArrayList.x10"
    {
        ...
        for (i = ((x10_long)0ll); ((i) < (sz)); i = ((i) + (((x10_long)1ll))))
        {
            ...
            if (((i) > (((x10_long)0ll)))) {
                sb->add((&::x10::util::ArrayList_Strings::sl__168084));
            }
            
            //#line 291 "x10/util/ArrayList.x10"
            sb->add(::x10::lang::String::__plus((&::x10::util::ArrayList_Strings::sl__168085), this->__apply(
                                                                                                 i)));
        }
    }
    ...
    if (((sz) < (this->size()))) {
        sb->add(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::util::ArrayList_Strings::sl__168086), ((this->size()) - (sz))), (&::x10::util::ArrayList_Strings::sl__168087)));
    }
    
    //#line 294 "x10/util/ArrayList.x10"
    sb->add((&::x10::util::ArrayList_Strings::sl__168088));
