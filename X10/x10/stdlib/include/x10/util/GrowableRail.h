...
class GrowableRail_Strings {
  public:
    static ::x10::lang::String sl__168902;
    static ::x10::lang::String sl__168903;
    static ::x10::lang::String sl__168904;
    static ::x10::lang::String sl__168909;
    static ::x10::lang::String sl__168910;
    static ::x10::lang::String sl__168906;
    static ::x10::lang::String sl__168905;
    static ::x10::lang::String sl__168907;
    static ::x10::lang::String sl__168908;
    static ::x10::lang::String sl__168911;
};
...
template<class TPMGL(T)> void x10::util::GrowableRail<TPMGL(T)>::_constructor(
    ...
    ::x10::util::GrowableRail<TPMGL(T)>* this__140063 = this;
    ::x10aux::nullCheck(this__140063)->FMGL(data) = (::x10aux::class_cast_unchecked< ::x10::lang::Rail< TPMGL(T) >*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__140063)->FMGL(size) = ((x10_long)0ll);
...
template<class TPMGL(T)> void x10::util::GrowableRail<TPMGL(T)>::_constructor(
    ...
    //#line 32 "x10/util/GrowableRail.x10"
    ::x10::util::GrowableRail<TPMGL(T)>* this__140064 = this;
    ::x10aux::nullCheck(this__140064)->FMGL(data) = (::x10aux::class_cast_unchecked< ::x10::lang::Rail< TPMGL(T) >*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__140064)->FMGL(size) = ((x10_long)0ll);
...
template<class TPMGL(T)> void x10::util::GrowableRail<TPMGL(T)>::add(
  TPMGL(T) v) {
    ...
    if (((((this->FMGL(size)) + (((x10_long)1ll)))) > ((__extension__ ({
            ::x10::util::GrowableRail<TPMGL(T)>* this__140043 =
              this;
            (x10_long)(::x10aux::nullCheck(::x10aux::nullCheck(this__140043)->FMGL(data))->FMGL(size));
        }))
        ))) {
...
template<class TPMGL(T)> void x10::util::GrowableRail<TPMGL(T)>::addAll(
  ::x10::lang::Rail< TPMGL(T) >* x) {
    ...
    if (((((this->FMGL(size)) + ((x10_long)(::x10aux::nullCheck(x)->FMGL(size))))) > ((__extension__ ({
            ::x10::util::GrowableRail<TPMGL(T)>* this__140045 =
              this;
            (x10_long)(::x10aux::nullCheck(::x10aux::nullCheck(this__140045)->FMGL(data))->FMGL(size));
        }))
        ))) {
        this->x10::util::template GrowableRail<TPMGL(T)>::grow(
    ...
    x10_long i__106869max__140065 = (((x10_long)(::x10aux::nullCheck(x)->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__140066;
        for (i__140066 = ((x10_long)0ll); ((i__140066) <= (i__106869max__140065));
             i__140066 = ((i__140066) + (((x10_long)1ll))))
        {
...
template<class TPMGL(T)> void x10::util::GrowableRail<TPMGL(T)>::insert(
  x10_long p, ::x10::lang::Rail< TPMGL(T) >* items) {
    ...
    if ((true && ((movLen) < (((x10_long)0ll))))) {
        ::x10::util::GrowableRail<void>::illegalGap(p, this->FMGL(size));
    }
    
    //#line 114 "x10/util/GrowableRail.x10"
    if (((newLen) > ((__extension__ ({
            ::x10::util::GrowableRail<TPMGL(T)>* this__140047 =
              this;
            (x10_long)(::x10aux::nullCheck(::x10aux::nullCheck(this__140047)->FMGL(data))->FMGL(size));
        }))
        ))) {
        this->x10::util::template GrowableRail<TPMGL(T)>::grow(
          newLen);
...
template<class TPMGL(T)> x10_boolean x10::util::GrowableRail<TPMGL(T)>::contains(
  TPMGL(T) v) {
    ...
    if ((::x10aux::struct_equals(v, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
    {
        ...
        x10_long i__106887max__140068 = (((__extension__ ({
            ::x10::util::GrowableRail<TPMGL(T)>* this__140069 =
              this;
            ::x10aux::nullCheck(this__140069)->FMGL(size);
        }))
        ) - (((x10_long)1ll)));
        {
            x10_long i__140070;
            for (i__140070 = ((x10_long)0ll); ((i__140070) <= (i__106887max__140068));
                 i__140070 = ((i__140070) + (((x10_long)1ll))))
            {
        ...
        x10_long i__106905max__140072 = (((__extension__ ({
            ::x10::util::GrowableRail<TPMGL(T)>* this__140073 =
              this;
            ::x10aux::nullCheck(this__140073)->FMGL(size);
        }))
        ) - (((x10_long)1ll)));
        {
            x10_long i__140074;
            for (i__140074 = ((x10_long)0ll); ((i__140074) <= (i__106905max__140072));
                 i__140074 = ((i__140074) + (((x10_long)1ll))))
            {
...
template<class TPMGL(T)> void x10::util::GrowableRail<TPMGL(T)>::grow(
  x10_long newCapacity) {
    ...
    x10_long oldCapacity = (__extension__ ({
        ::x10::util::GrowableRail<TPMGL(T)>* this__140053 =
          this;
        (x10_long)(::x10aux::nullCheck(::x10aux::nullCheck(this__140053)->FMGL(data))->FMGL(size));
    }))
    ;
...
template<class TPMGL(T)> void x10::util::GrowableRail<TPMGL(T)>::shrink(
  x10_long newCapacity) {
    ...
    this->FMGL(size) = (__extension__ ({
        x10_long a__140055 = this->FMGL(size);
        ((a__140055) < (newCapacity)) ? (a__140055) : (newCapacity);
    }))
    ;
    
    //#line 252 "x10/util/GrowableRail.x10"
    x10_long cap = ((newCapacity) < (((x10_long)8ll))) ? (((x10_long)8ll))
      : (newCapacity);
    
    //#line 253 "x10/util/GrowableRail.x10"
    if (((cap) <= ((((__extension__ ({
            ::x10::util::GrowableRail<TPMGL(T)>* this__140061 =
              this;
            (x10_long)(::x10aux::nullCheck(::x10aux::nullCheck(this__140061)->FMGL(data))->FMGL(size));
        }))
        ) / ::x10aux::zeroCheck(((x10_long)4ll)))))) {
...
template<class TPMGL(T)> ::x10::lang::String* x10::util::GrowableRail<TPMGL(T)>::toString(
    ...
    sb->add((&::x10::util::GrowableRail_Strings::sl__168907));
    ...
    //#line 275 "x10/util/GrowableRail.x10"
    {
        ...
        for (i = ((x10_long)0ll); ((i) < (sz)); i = ((i) + (((x10_long)1ll))))
        {
            ...
            if (((i) > (((x10_long)0ll)))) {
                ...
                sb->add((&::x10::util::GrowableRail_Strings::sl__168908));
            }
    ...
    if (((sz) < (this->FMGL(size)))) {
        ...
        sb->add(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::util::GrowableRail_Strings::sl__168909), ((this->FMGL(size)) - (sz))), (&::x10::util::GrowableRail_Strings::sl__168910)));
    }
    
    //#line 282 "x10/util/GrowableRail.x10"
    sb->add((&::x10::util::GrowableRail_Strings::sl__168911));
