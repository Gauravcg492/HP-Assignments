...
class Store_Strings {
  public:
    static ::x10::lang::String sl__170724;
    static ::x10::lang::String sl__170725;
};
...
template<class TPMGL(V)> ::x10::util::resilient::store::Store<TPMGL(V)>*
  x10::util::resilient::store::Store<void>::make(::x10::lang::String* name,
    ...
    if (::x10aux::equals((&::x10::util::resilient::store::Store_Strings::sl__170724),(&::x10::util::resilient::store::Store_Strings::sl__170725)))
    {
        
        //#line 48 "x10/util/resilient/store/Store.x10"
        ::x10::util::resilient::store::HazelcastStore<TPMGL(V)>* alloc__150594 =
           (new (::x10aux::alloc_z< ::x10::util::resilient::store::HazelcastStore<TPMGL(V)> >()) ::x10::util::resilient::store::HazelcastStore<TPMGL(V)>());
        (alloc__150594)->::x10::util::resilient::store::HazelcastStore<TPMGL(V)>::_constructor(
          name, activePlaces);
        return alloc__150594;
        
    } else {
        
        //#line 50 "x10/util/resilient/store/Store.x10"
        ::x10::util::resilient::store::NativeStore<TPMGL(V)>* alloc__150595 =
           (new (::x10aux::alloc_z< ::x10::util::resilient::store::NativeStore<TPMGL(V)> >()) ::x10::util::resilient::store::NativeStore<TPMGL(V)>());
        (alloc__150595)->::x10::util::resilient::store::NativeStore<TPMGL(V)>::_constructor(
          name, activePlaces);
        return alloc__150595;
