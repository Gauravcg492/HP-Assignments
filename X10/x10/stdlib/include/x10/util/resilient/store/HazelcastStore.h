...
class HazelcastStore_Strings {
  public:
    static ::x10::lang::String sl__170701;
    static ::x10::lang::String sl__170699;
    static ::x10::lang::String sl__170698;
    static ::x10::lang::String sl__170700;
};
...
template<class TPMGL(V)> void x10::util::resilient::store::HazelcastStore<TPMGL(V)>::_constructor(
    ...
    ::x10::util::resilient::store::HazelcastStore<TPMGL(V)>* this__150437 =
      this;
    ::x10aux::nullCheck(this__150437)->FMGL(group) = (::x10aux::class_cast_unchecked< ::x10::lang::PlaceGroup*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ...
    this->FMGL(map) = ::x10::util::resilient::ResilientMap<void, void>::template getMap< ::x10::lang::String*,
                      TPMGL(V) >(::x10::lang::String::__plus((&::x10::util::resilient::store::HazelcastStore_Strings::sl__170698), name));
    ...
    this->FMGL(log) = ::x10::util::resilient::ResilientMap<void, void>::template getMap< ::x10::lang::String*,
                      ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>* >(
                        ::x10::lang::String::__plus((&::x10::util::resilient::store::HazelcastStore_Strings::sl__170699), name));
...
template<class TPMGL(V)> ::x10::lang::String* x10::util::resilient::store::HazelcastStore<TPMGL(V)>::k(
  ::x10::lang::Place place, ::x10::lang::String* key) {
    return ::x10::lang::String::__plus(::x10::lang::String::__plus(((::x10aux::nullCheck(this->FMGL(group))->indexOf(
                                                                       place)) << (0x3f & (x10_int)(((x10_long)32ll)))), (&::x10::util::resilient::store::HazelcastStore_Strings::sl__170700)), key);
...
template<class TPMGL(V)> void x10::util::resilient::store::HazelcastStore<TPMGL(V)>::set2(
  ...
  ::x10::lang::String* key2, TPMGL(V) value2) {
    ...
    ::x10aux::nullCheck(this->FMGL(log))->set(k1, (__extension__ ({
                                                  ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>* alloc__150426 =
                                                  ...
                                                  (alloc__150426)->::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>::_constructor(
                                                    k1, value,
                                                    k2, value2);
                                                  alloc__150426;
                                              }))
...
template<class TPMGL(V)> void x10::util::resilient::store::HazelcastStore<TPMGL(V)>::updateForChangedPlaces(
  ::x10::util::resilient::PlaceManager__ChangeDescription changes) {
    ...
    {
        ::x10::lang::Iterator< ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>*>* entry__150428;
        for (entry__150428 = ::x10::util::Collection< ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>*>::iterator(::x10aux::nullCheck(::x10aux::nullCheck(this->FMGL(log))->values()));
             ::x10::lang::Iterator< ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>*>::hasNext(::x10aux::nullCheck(entry__150428));
             ) {
            ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>* entry =
              ::x10::lang::Iterator< ::x10::util::resilient::store::HazelcastStore__LogEntry<TPMGL(V)>*>::next(::x10aux::nullCheck(entry__150428));
            
            //#line 81 "x10/util/resilient/store/HazelcastStore.x10"
            ::x10::io::Console::FMGL(ERR__get)()->x10::io::Printer::println(
              reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((&::x10::util::resilient::store::HazelcastStore_Strings::sl__170701), ::x10aux::nullCheck(entry)->FMGL(key))));
