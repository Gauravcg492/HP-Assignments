...
template<class TPMGL(V)> ::x10::util::resilient::localstore::Cloneable*
  x10::util::resilient::store::NativeStore__NativeLogEntry<TPMGL(V)>::clone(
    ...
    ::x10::util::resilient::store::NativeStore__NativeLogEntry<TPMGL(V)>* alloc__150574 =
    ...
    (alloc__150574)->::x10::util::resilient::store::NativeStore__NativeLogEntry<TPMGL(V)>::_constructor(
      this->FMGL(value), this->FMGL(placeId), this->FMGL(key2),
      this->FMGL(value2));
    return reinterpret_cast< ::x10::util::resilient::localstore::Cloneable*>(alloc__150574);
