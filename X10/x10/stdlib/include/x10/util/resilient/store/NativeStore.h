...
class NativeStore_Strings {
  public:
    static ::x10::lang::String sl__170716;
    static ::x10::lang::String sl__170715;
    static ::x10::lang::String sl__170714;
};
...
template<class TPMGL(V)> class x10_util_resilient_store_NativeStore__closure__2 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        {
            ::x10::lang::Iterator< ::x10::lang::String*>* key__150565;
            for (key__150565 = ::x10::util::Set< ::x10::lang::String*>::iterator(::x10aux::nullCheck(::x10aux::nullCheck(saved_this->FMGL(log))->keySet()));
                 ::x10::lang::Iterator< ::x10::lang::String*>::hasNext(::x10aux::nullCheck(key__150565));
                 ) {
                ::x10::lang::String* key = ::x10::lang::Iterator< ::x10::lang::String*>::next(::x10aux::nullCheck(key__150565));
                
                //#line 83 "x10/util/resilient/store/NativeStore.x10"
                ::x10::io::Console::FMGL(ERR__get)()->x10::io::Printer::println(
                  reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((&::x10::util::resilient::store::NativeStore_Strings::sl__170716), key)));
                                                                                                                 ...
                                                                                                                 key));
                {
                    ...
                    ::x10::xrx::FinishState* fs__150589 =
                    ...
                    try {
                        ...
                        {
                            ::x10::lang::CheckedThrowable* ct__150587 =
                              __exc2807;
                            {
                    ...
                    ::x10::xrx::Runtime::stopFinish(fs__150589);
                }
...
template<class TPMGL(V)> void x10::util::resilient::store::NativeStore<TPMGL(V)>::_constructor(
    ...
    this->FMGL(map) = ::x10aux::nullCheck(this->FMGL(store))->makeMap(
                        ::x10::lang::String::__plus((&::x10::util::resilient::store::NativeStore_Strings::sl__170714), name));
    
    //#line 45 "x10/util/resilient/store/NativeStore.x10"
    this->FMGL(log) = ::x10aux::nullCheck(this->FMGL(store))->makeMap(
                        ::x10::lang::String::__plus((&::x10::util::resilient::store::NativeStore_Strings::sl__170715), name));
}
...
template<class TPMGL(V)> void x10::util::resilient::store::NativeStore<TPMGL(V)>::set2(
  ...
  ::x10::lang::String* key2, TPMGL(V) value2) {
    ...
    ::x10aux::nullCheck(this->FMGL(log))->set(key, reinterpret_cast< ::x10::util::resilient::localstore::Cloneable*>((__extension__ ({
                                                  ::x10::util::resilient::store::NativeStore__NativeLogEntry<TPMGL(V)>* alloc__150563 =
                                                  ...
                                                  (alloc__150563)->::x10::util::resilient::store::NativeStore__NativeLogEntry<TPMGL(V)>::_constructor(
                                                    value,
                                                    placeId,
                                                    key2,
                                                    value2);
                                              ...
                                              ));
    {
        ...
        ::x10::xrx::Runtime::ensureNotInAtomic();
        ::x10::xrx::FinishState* fs__150582 = ::x10::xrx::Runtime::startFinish();
        try {
            {
        ...
        catch (::x10::lang::CheckedThrowable* __exc2804) {
            {
                ::x10::lang::CheckedThrowable* ct__150580 =
                  __exc2804;
                {
                    ::x10::xrx::Runtime::pushException(ct__150580);
                }
            }
        }
        ::x10::xrx::Runtime::stopFinish(fs__150582);
    }
