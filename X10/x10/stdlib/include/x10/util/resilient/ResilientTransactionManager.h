...
class ResilientTransactionManager_Strings {
  public:
    static ::x10::lang::String sl__170697;
};
...
#ifndef X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runTransaction_2782
#define X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runTransaction_2782
template<class TPMGL(T)> TPMGL(T) x10::util::resilient::ResilientTransactionManager::runTransaction(
  ::x10::lang::Fun_0_1< ::x10::util::resilient::ResilientTransactionManager*, TPMGL(T)>* run) {
    ...
    ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::Exception::_make((&::x10::util::resilient::ResilientTransactionManager_Strings::sl__170697))));
}
#endif // X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runTransaction_2782
#ifndef X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runLocalTransaction_2783
#define X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runLocalTransaction_2783
...
#endif // X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_runLocalTransaction_2783
#ifndef X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_getMap_2784
#define X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_getMap_2784
...
#endif // X10_UTIL_RESILIENT_RESILIENTTRANSACTIONMANAGER_H_getMap_2784
