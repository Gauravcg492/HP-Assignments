...
class HashMap__EntriesIterator_Strings {
  public:
    static ::x10::lang::String sl__169072;
    static ::x10::lang::String sl__169073;
};
...
template<class TPMGL(Key), class TPMGL(Value)> void x10::util::HashMap__EntriesIterator<TPMGL(Key), TPMGL(Value)>::_constructor(
    ...
    ::x10::util::HashMap__EntriesIterator<TPMGL(Key), TPMGL(Value)>* this__140105 =
      this;
    ::x10aux::nullCheck(this__140105)->FMGL(i) = ((x10_long)0ll);
    ::x10aux::nullCheck(this__140105)->FMGL(originalModCount) =
      ((x10_long)0ll);
...
template<class TPMGL(Key), class TPMGL(Value)> ::x10::util::Map__Entry<TPMGL(Key), TPMGL(Value)>*
  x10::util::HashMap__EntriesIterator<TPMGL(Key), TPMGL(Value)>::next(
    ...
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::Exception::_make(::x10::lang::String::__plus(::x10::lang::String::__plus((&::x10::util::HashMap__EntriesIterator_Strings::sl__169072), ((::x10aux::nullCheck(this->FMGL(map))->FMGL(modCount)) - (this->FMGL(originalModCount)))), (&::x10::util::HashMap__EntriesIterator_Strings::sl__169073)))));
    }
