...
template<class TPMGL(T)> class x10_util_RailUtils__closure__1 : public ::x10::lang::Closure {
    ...
    x10_int __apply(TPMGL(T) x__144421, TPMGL(T) y__144422){
        
        //#line 33 "x10/util/RailUtils.x10"
        return ::x10::lang::Comparable< TPMGL(T) >::compareTo(x__144421, y__144422);
...
#ifndef X10_UTIL_RAILUTILS_H_sort_2529
#define X10_UTIL_RAILUTILS_H_sort_2529
...
#endif // X10_UTIL_RAILUTILS_H_sort_2529
#ifndef X10_UTIL_RAILUTILS_H_sort_2530
#define X10_UTIL_RAILUTILS_H_sort_2530
...
#endif // X10_UTIL_RAILUTILS_H_sort_2530
#ifndef X10_UTIL_RAILUTILS_H_qsort_2531
#define X10_UTIL_RAILUTILS_H_qsort_2531
...
#endif // X10_UTIL_RAILUTILS_H_qsort_2531
#ifndef X10_UTIL_RAILUTILS_H_exch_2532
#define X10_UTIL_RAILUTILS_H_exch_2532
...
#endif // X10_UTIL_RAILUTILS_H_exch_2532
#ifndef X10_UTIL_RAILUTILS_H_binarySearch_2533
#define X10_UTIL_RAILUTILS_H_binarySearch_2533
...
#endif // X10_UTIL_RAILUTILS_H_binarySearch_2533
#ifndef X10_UTIL_RAILUTILS_H_binarySearch_2534
#define X10_UTIL_RAILUTILS_H_binarySearch_2534
template<class TPMGL(T)> x10_long x10::util::RailUtils::binarySearch(
...
#endif // X10_UTIL_RAILUTILS_H_binarySearch_2534
#ifndef X10_UTIL_RAILUTILS_H_binarySearch_2535
#define X10_UTIL_RAILUTILS_H_binarySearch_2535
template<class TPMGL(T)> x10_long x10::util::RailUtils::binarySearch(
  ::x10::lang::Rail< TPMGL(T) >* a, TPMGL(T) key, x10_long min,
  x10_long max, ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), x10_int>* cmp) {
...
#endif // X10_UTIL_RAILUTILS_H_binarySearch_2535
...
#ifndef X10_UTIL_RAILUTILS_H_reduce_2537
#define X10_UTIL_RAILUTILS_H_reduce_2537
template<class TPMGL(T), class TPMGL(U)> TPMGL(U) x10::util::RailUtils::reduce(
  ...
  TPMGL(U) unit) {
    ...
    x10_long i__96596max__144425 = (x10_long)(::x10aux::nullCheck(src)->FMGL(size));
    {
        x10_long i__144426;
        for (i__144426 = ((x10_long)0ll); ((i__144426) < (i__96596max__144425));
             i__144426 = ((i__144426) + (((x10_long)1ll))))
        {
...
#endif // X10_UTIL_RAILUTILS_H_reduce_2537
#ifndef X10_UTIL_RAILUTILS_H_reduce_2538
#define X10_UTIL_RAILUTILS_H_reduce_2538
template<class TPMGL(T), class TPMGL(U)> TPMGL(U) x10::util::RailUtils::reduce(
  ...
  TPMGL(U) accumUnit, ::x10::lang::Fun_0_1<TPMGL(T), TPMGL(T)>* elemOp) {
    ...
    x10_long i__96615max__144429 = (x10_long)(::x10aux::nullCheck(src)->FMGL(size));
    {
        x10_long i__144430;
        for (i__144430 = ((x10_long)0ll); ((i__144430) < (i__96615max__144429));
             i__144430 = ((i__144430) + (((x10_long)1ll))))
        {
...
#endif // X10_UTIL_RAILUTILS_H_reduce_2538
#ifndef X10_UTIL_RAILUTILS_H_map_2539
#define X10_UTIL_RAILUTILS_H_map_2539
template<class TPMGL(T), class TPMGL(U)> ::x10::lang::Rail< TPMGL(U) >*
  x10::util::RailUtils::map(::x10::lang::Rail< TPMGL(T) >* src,
    ...
    x10_long i__96634max__144433 = (x10_long)(::x10aux::nullCheck(src)->FMGL(size));
    {
        x10_long i__144434;
        for (i__144434 = ((x10_long)0ll); ((i__144434) < (i__96634max__144433));
             i__144434 = ((i__144434) + (((x10_long)1ll))))
        {
            
            //#line 181 "x10/util/RailUtils.x10"
            ::x10aux::nullCheck(dst)->x10::lang::template Rail< TPMGL(U) >::__set(
              i__144434, ::x10::lang::Fun_0_1<TPMGL(T), TPMGL(U)>::__apply(::x10aux::nullCheck(op), 
                ::x10aux::nullCheck(src)->x10::lang::template Rail< TPMGL(T) >::__apply(
                  i__144434)));
        }
    }
...
#endif // X10_UTIL_RAILUTILS_H_map_2539
#ifndef X10_UTIL_RAILUTILS_H_map_2540
#define X10_UTIL_RAILUTILS_H_map_2540
template<class TPMGL(S), class TPMGL(T), class TPMGL(U)> ::x10::lang::Rail< TPMGL(U) >*
  x10::util::RailUtils::map(::x10::lang::Rail< TPMGL(S) >* src1,
    ...
    x10_long i__96653max__144437 = (x10_long)(::x10aux::nullCheck(src1)->FMGL(size));
    {
        x10_long i__144438;
        for (i__144438 = ((x10_long)0ll); ((i__144438) < (i__96653max__144437));
             i__144438 = ((i__144438) + (((x10_long)1ll))))
        {
            
            //#line 204 "x10/util/RailUtils.x10"
            ::x10aux::nullCheck(dst)->x10::lang::template Rail< TPMGL(U) >::__set(
              i__144438, ::x10::lang::Fun_0_2<TPMGL(S), TPMGL(T), TPMGL(U)>::__apply(::x10aux::nullCheck(op), 
                ::x10aux::nullCheck(src1)->x10::lang::template Rail< TPMGL(S) >::__apply(
                  i__144438), ::x10aux::nullCheck(src2)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                i__144438)));
        }
    }
...
#endif // X10_UTIL_RAILUTILS_H_map_2540
#ifndef X10_UTIL_RAILUTILS_H_scan_2541
#define X10_UTIL_RAILUTILS_H_scan_2541
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::util::RailUtils::scan(
  ...
  TPMGL(T) unit) {
    ...
    x10_long i__96672max__144440 = (((x10_long)(::x10aux::nullCheck(src)->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__144441;
        for (i__144441 = ((x10_long)0ll); ((i__144441) <= (i__96672max__144440));
             i__144441 = ((i__144441) + (((x10_long)1ll))))
        {
...
#endif // X10_UTIL_RAILUTILS_H_scan_2541
#ifndef X10_UTIL_RAILUTILS_H_scan_2542
#define X10_UTIL_RAILUTILS_H_scan_2542
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::util::RailUtils::scan(
  ...
  TPMGL(T) unit) {
    ...
    //#line 225 "x10/util/RailUtils.x10"
    TPMGL(T) accum__144450 = unit;
    
    //#line 226 "x10/util/RailUtils.x10"
    x10_long i__96672max__144443 = (((x10_long)(::x10aux::nullCheck(src)->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__144444;
        for (i__144444 = ((x10_long)0ll); ((i__144444) <= (i__96672max__144443));
             i__144444 = ((i__144444) + (((x10_long)1ll))))
        {
            
            //#line 227 "x10/util/RailUtils.x10"
            accum__144450 = ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>::__apply(::x10aux::nullCheck(op), 
              accum__144450, ::x10aux::nullCheck(src)->x10::lang::template Rail< TPMGL(T) >::__apply(
                               i__144444));
            
            //#line 228 "x10/util/RailUtils.x10"
            dst->x10::lang::template Rail< TPMGL(T) >::__set(
              i__144444, accum__144450);
        }
    }
...
#endif // X10_UTIL_RAILUTILS_H_scan_2542
#ifndef X10_UTIL_RAILUTILS_H_scanExclusive_2543
#define X10_UTIL_RAILUTILS_H_scanExclusive_2543
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::util::RailUtils::scanExclusive(
  ...
  TPMGL(T) unit) {
    ...
    x10_long i__96690max__144451 = (((x10_long)(::x10aux::nullCheck(src)->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__144452;
        for (i__144452 = ((x10_long)1ll); ((i__144452) <= (i__96690max__144451));
             i__144452 = ((i__144452) + (((x10_long)1ll))))
        {
            
            //#line 267 "x10/util/RailUtils.x10"
            accum = ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>::__apply(::x10aux::nullCheck(op), 
              accum, ::x10aux::nullCheck(src)->x10::lang::template Rail< TPMGL(T) >::__apply(
                       ((i__144452) - (((x10_long)1ll)))));
...
#endif // X10_UTIL_RAILUTILS_H_scanExclusive_2543
#ifndef X10_UTIL_RAILUTILS_H_scanExclusive_2544
#define X10_UTIL_RAILUTILS_H_scanExclusive_2544
template<class TPMGL(T)> ::x10::lang::Rail< TPMGL(T) >* x10::util::RailUtils::scanExclusive(
  ::x10::lang::Rail< TPMGL(T) >* src, ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* op,
  TPMGL(T) unit) {
    ...
    //#line 266 "x10/util/RailUtils.x10"
    x10_long i__96690max__144454 = (((x10_long)(::x10aux::nullCheck(src)->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__144455;
        for (i__144455 = ((x10_long)1ll); ((i__144455) <= (i__96690max__144454));
             i__144455 = ((i__144455) + (((x10_long)1ll))))
        {
            
            //#line 267 "x10/util/RailUtils.x10"
            accum__144461 = ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>::__apply(::x10aux::nullCheck(op), 
              accum__144461, ::x10aux::nullCheck(src)->x10::lang::template Rail< TPMGL(T) >::__apply(
                               ((i__144455) - (((x10_long)1ll)))));
            
            //#line 268 "x10/util/RailUtils.x10"
            dst->x10::lang::template Rail< TPMGL(T) >::__set(
              i__144455, accum__144461);
        }
    }
...
#endif // X10_UTIL_RAILUTILS_H_scanExclusive_2544
