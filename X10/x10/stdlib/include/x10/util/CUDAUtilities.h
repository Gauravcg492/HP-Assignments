...
class CUDAUtilities_Strings {
  public:
    static ::x10::lang::String sl__168625;
};
...
template<class TPMGL(T)> class x10_util_CUDAUtilities__closure__1 : public ::x10::lang::Closure {
    ...
    ::x10::lang::GlobalRail<TPMGL(T)> __apply(){
        ::x10::lang::GlobalRail<TPMGL(T)> alloc__136951 =  ::x10::lang::GlobalRail<TPMGL(T)>::_alloc();
        (alloc__136951)->::x10::lang::GlobalRail<TPMGL(T)>::_constructor(
...
template<class TPMGL(T)> class x10_util_CUDAUtilities__closure__3 : public ::x10::lang::Closure {
    ...
    ::x10::lang::GlobalRail<TPMGL(T)> __apply(){
        ::x10::lang::GlobalRail<TPMGL(T)> alloc__136954 =  ::x10::lang::GlobalRail<TPMGL(T)>::_alloc();
        (alloc__136954)->::x10::lang::GlobalRail<TPMGL(T)>::_constructor(
          ::x10::lang::Rail< TPMGL(T) >::_make(numElements, init));
        return alloc__136954;
...
template<class TPMGL(T)> class x10_util_CUDAUtilities__closure__4 : public ::x10::lang::Closure {
    ...
    ::x10::lang::GlobalRail<TPMGL(T)> __apply(){
        ::x10::lang::GlobalRail<TPMGL(T)> alloc__136956 =  ::x10::lang::GlobalRail<TPMGL(T)>::_alloc();
        (alloc__136956)->::x10::lang::GlobalRail<TPMGL(T)>::_constructor(
...
#ifndef X10_UTIL_CUDAUTILITIES_H_initCUDARail_2184
#define X10_UTIL_CUDAUTILITIES_H_initCUDARail_2184
template<class TPMGL(T)> void x10::util::CUDAUtilities::initCUDARail(::x10::lang::Rail< TPMGL(T) >* local,
                                                                     ...
                                                                     x10_long numElements) {
    {
        ...
        ::x10::xrx::FinishState* fs__136962 = ::x10::xrx::Runtime::startFinish();
        try {
            {
        ...
        catch (::x10::lang::CheckedThrowable* __exc2185) {
            {
                ::x10::lang::CheckedThrowable* ct__136960 =
                  __exc2185;
                {
                    ::x10::xrx::Runtime::pushException(ct__136960);
                }
            }
        }
        ::x10::xrx::Runtime::stopFinish(fs__136962);
    }
}
#endif // X10_UTIL_CUDAUTILITIES_H_initCUDARail_2184
#ifndef X10_UTIL_CUDAUTILITIES_H_makeCUDARail_2186
#define X10_UTIL_CUDAUTILITIES_H_makeCUDARail_2186
...
#endif // X10_UTIL_CUDAUTILITIES_H_makeCUDARail_2186
#ifndef X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2187
#define X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2187
template<class TPMGL(T)> ::x10::lang::GlobalRail<TPMGL(T)>
  x10::util::CUDAUtilities::makeGlobalRail(::x10::lang::Place place,
    ...
    if (::x10aux::is_cuda((x10_int)((place)->FMGL(id)))) {
        ...
        ::x10::lang::GlobalRail<TPMGL(T)> t__136953 = ::x10::xrx::Runtime::template evalAt< ::x10::lang::GlobalRail<TPMGL(T)> >(
                                                        place,
        ...
        if (!((::x10aux::struct_equals(::x10::lang::Place::_make((t__136953->FMGL(rail))->location),
                                       place)))) {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::util::CUDAUtilities_Strings::sl__168625))));
        }
        return t__136953;
...
#endif // X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2187
#ifndef X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2188
#define X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2188
template<class TPMGL(T)> ::x10::lang::GlobalRail<TPMGL(T)>
  x10::util::CUDAUtilities::makeGlobalRail(::x10::lang::Place place,
                                           x10_long numElements) {
...
#endif // X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2188
#ifndef X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2189
#define X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2189
template<class TPMGL(T)> ::x10::lang::GlobalRail<TPMGL(T)>
  x10::util::CUDAUtilities::makeGlobalRail(::x10::lang::Place place,
                                           x10_long numElements,
                                           TPMGL(T) init) {
    ...
    if (::x10aux::is_cuda((x10_int)((place)->FMGL(id)))) {
        ...
        ::x10::lang::GlobalRail<TPMGL(T)> t__136955 = ::x10::xrx::Runtime::template evalAt< ::x10::lang::GlobalRail<TPMGL(T)> >(
                                                        place,
                                                        ...
                                                        ::x10aux::class_cast_unchecked< ::x10::xrx::Runtime__Profile*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
        if (!((::x10aux::struct_equals(::x10::lang::Place::_make((t__136955->FMGL(rail))->location),
                                       place)))) {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::util::CUDAUtilities_Strings::sl__168625))));
        }
        return t__136955;
...
#endif // X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2189
#ifndef X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2190
#define X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2190
template<class TPMGL(T)> ::x10::lang::GlobalRail<TPMGL(T)>
  x10::util::CUDAUtilities::makeGlobalRail(::x10::lang::Place place,
                                           x10_long numElements,
                                           ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>* init) {
    ...
    if (::x10aux::is_cuda((x10_int)((place)->FMGL(id)))) {
        ...
        ::x10::lang::GlobalRail<TPMGL(T)> t__136958 = ::x10::xrx::Runtime::template evalAt< ::x10::lang::GlobalRail<TPMGL(T)> >(
                                                        place,
                                                        ...
                                                        ::x10aux::class_cast_unchecked< ::x10::xrx::Runtime__Profile*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
        if (!((::x10aux::struct_equals(::x10::lang::Place::_make((t__136958->FMGL(rail))->location),
                                       place)))) {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((&::x10::util::CUDAUtilities_Strings::sl__168625))));
        }
        return t__136958;
...
#endif // X10_UTIL_CUDAUTILITIES_H_makeGlobalRail_2190
#ifndef X10_UTIL_CUDAUTILITIES_H_deleteGlobalRail_2191
#define X10_UTIL_CUDAUTILITIES_H_deleteGlobalRail_2191
template<class TPMGL(T)> void x10::util::CUDAUtilities::deleteGlobalRail(
  ::x10::lang::GlobalRail<TPMGL(T)> arr) {
    
    //#line 104 "x10/util/CUDAUtilities.x10"
    ::x10::lang::Place place = ::x10::lang::Place::_make((arr->FMGL(rail))->location);
...
#endif // X10_UTIL_CUDAUTILITIES_H_deleteGlobalRail_2191
