...
template<class TPMGL(T)> x10_boolean x10::util::AbstractCollection<TPMGL(T)>::addAllWhere(
  ::x10::util::Container<TPMGL(T)>* c, ::x10::lang::Fun_0_1<TPMGL(T), x10_boolean>* p) {
    ...
    {
        ::x10::lang::Iterator<TPMGL(T)>* x__108865;
        for (x__108865 = ::x10::util::Container<TPMGL(T)>::iterator(::x10aux::nullCheck(c));
             ::x10::lang::Iterator<TPMGL(T)>::hasNext(::x10aux::nullCheck(x__108865));
             ) {
            TPMGL(T) x = ::x10::lang::Iterator<TPMGL(T)>::next(::x10aux::nullCheck(x__108865));
...
template<class TPMGL(T)> x10_boolean x10::util::AbstractCollection<TPMGL(T)>::removeAllWhere(
  ::x10::lang::Fun_0_1<TPMGL(T), x10_boolean>* p) {
    ...
    {
        ::x10::lang::Iterator<TPMGL(T)>* x__108867;
        for (x__108867 = ::x10::util::Collection<TPMGL(T)>::iterator(::x10aux::nullCheck(reinterpret_cast< ::x10::util::Collection<TPMGL(T)>*>(this->clone())));
             ::x10::lang::Iterator<TPMGL(T)>::hasNext(::x10aux::nullCheck(x__108867));
             ) {
            TPMGL(T) x = ::x10::lang::Iterator<TPMGL(T)>::next(::x10aux::nullCheck(x__108867));
