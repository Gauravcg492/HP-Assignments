...
template<class TPMGL(U)> void x10::util::WorkerLocalHandle__State<TPMGL(U)>::_constructor(
    ...
    ::x10::util::WorkerLocalHandle__State<TPMGL(U)>* this__154261 =
      this;
    ::x10aux::nullCheck(this__154261)->FMGL(init) = (::x10aux::class_cast_unchecked< ::x10::lang::Fun_0_0<TPMGL(U)>*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
