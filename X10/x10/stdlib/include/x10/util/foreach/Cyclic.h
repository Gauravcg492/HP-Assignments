...
template<class TPMGL(T)> class x10_util_foreach_Cyclic__closure__2 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        TPMGL(T) myRes__139906 = identity;
        
        //#line 66 "x10/util/foreach/Cyclic.x10"
        {
            x10_long i__139907;
            for (i__139907 = ((min) + (t__139910)); ((i__139907) <= (max));
                 i__139907 = ((i__139907) + (((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)())))))
            {
                
                //#line 67 "x10/util/foreach/Cyclic.x10"
                myRes__139906 = ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>::__apply(::x10aux::nullCheck(reduce), 
                  myRes__139906, ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>::__apply(::x10aux::nullCheck(body), 
                    i__139907));
            }
        }
    ...
    static x10::lang::Reference* _deserialize(::x10aux::deserialization_buffer &buf) {
        ...
        x10_long that_t__139910 = buf.read<x10_long>();
        ...
        x10_util_foreach_Cyclic__closure__2<TPMGL(T) >* this_ = new (storage) x10_util_foreach_Cyclic__closure__2<TPMGL(T) >(that_identity, that_min, that_t__139910, that_max, that_reduce, that_body, that_results);
        return this_;
    }
    
    x10_util_foreach_Cyclic__closure__2(TPMGL(T) identity, x10_long min, x10_long t__139910, x10_long max, ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* reduce, ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>* body, ::x10::lang::Rail< TPMGL(T) >* results) : identity(identity), min(min), t__139910(t__139910), max(max), reduce(reduce), body(body), results(results) { }
...
#ifndef X10_UTIL_FOREACH_CYCLIC_H__kwd__for_2274
#define X10_UTIL_FOREACH_CYCLIC_H__kwd__for_2274
template<class TPMGL(T)> TPMGL(T) x10::util::foreach::Cyclic::_kwd__for(::x10::lang::LongRange range,
    ...
    if ((::x10aux::struct_equals(::x10::xrx::Runtime::FMGL(NTHREADS__get)(),
        ...
        TPMGL(T) myRes__139905 = identity;
        
        //#line 72 "x10/util/foreach/Sequential.x10"
        x10_long i__137243min__139897 = range->FMGL(min);
        x10_long i__137243max__139898 = range->FMGL(max);
        {
            x10_long i__139899;
            for (i__139899 = i__137243min__139897; ((i__139899) <= (i__137243max__139898));
                 i__139899 = ((i__139899) + (((x10_long)1ll))))
            {
                
                //#line 73 "x10/util/foreach/Sequential.x10"
                myRes__139905 = ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>::__apply(::x10aux::nullCheck(reduce), 
                  myRes__139905, ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>::__apply(::x10aux::nullCheck(body), 
                    i__139899));
            }
        }
        
        //#line 59 "x10/util/foreach/Cyclic.x10"
        return myRes__139905;
        ...
        ::x10::lang::Rail< TPMGL(T) >* results = ::x10::lang::Rail< TPMGL(T) >::_makeUnsafe(((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)())), false);
        {
            ...
            ::x10::xrx::FinishState* fs__139940 = ::x10::xrx::Runtime::startFinish();
            try {
                {
                    x10_long i__139789max__139908 = ((((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)()))) - (((x10_long)1ll)));
                    {
                        x10_long i__139909;
                        for (i__139909 = ((x10_long)0ll);
                             ((i__139909) <= (i__139789max__139908));
                             i__139909 = ((i__139909) + (((x10_long)1ll))))
                        {
                            x10_long t__139910 = i__139909;
                            ::x10::xrx::Runtime::runAsync(
                              reinterpret_cast< ::x10::lang::VoidFun_0_0*>((new (::x10aux::alloc< ::x10::lang::VoidFun_0_0>(sizeof(x10_util_foreach_Cyclic__closure__2<TPMGL(T)>)))x10_util_foreach_Cyclic__closure__2<TPMGL(T)>(identity, min, t__139910, max, reduce, body, results))));
                        }
                    }
                    
                }
            }
            catch (::x10::lang::CheckedThrowable* __exc2275) {
                {
                    ::x10::lang::CheckedThrowable* ct__139938 =
                      __exc2275;
                    {
            ...
            ::x10::xrx::Runtime::stopFinish(fs__139940);
        }
        ...
        x10_long i__139807max__139911 = ((((x10_long)(::x10::xrx::Runtime::FMGL(NTHREADS__get)()))) - (((x10_long)1ll)));
        {
            x10_long i__139912;
            for (i__139912 = ((x10_long)1ll); ((i__139912) <= (i__139807max__139911));
                 i__139912 = ((i__139912) + (((x10_long)1ll))))
            {
...
#endif // X10_UTIL_FOREACH_CYCLIC_H__kwd__for_2274
