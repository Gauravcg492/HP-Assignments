...
template<class TPMGL(T)> TPMGL(T) x10::util::foreach::Sequential__Reducer<TPMGL(T)>::value(
    ...
    ::x10::lang::Cell<TPMGL(T)>* this__140019 = this->FMGL(result);
    return ::x10aux::nullCheck(this__140019)->FMGL(value);
...
template<class TPMGL(T)> void x10::util::foreach::Sequential__Reducer<TPMGL(T)>::_constructor(
    ...
    ::x10::util::foreach::Sequential__Reducer<TPMGL(T)>* this__140020 =
      this;
    ::x10aux::nullCheck(this__140020)->FMGL(result) = (::x10aux::class_cast_unchecked< ::x10::lang::Cell<TPMGL(T)>*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
...
template<class TPMGL(T)> void x10::util::foreach::Sequential__Reducer<TPMGL(T)>::_constructor(
    ...
    //#line 112 "x10/util/foreach/Sequential.x10"
    ::x10::util::foreach::Sequential__Reducer<TPMGL(T)>* this__140021 =
      this;
    ::x10aux::nullCheck(this__140021)->FMGL(result) = (::x10aux::class_cast_unchecked< ::x10::lang::Cell<TPMGL(T)>*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
...
template<class TPMGL(T)> TPMGL(T) x10::util::foreach::Sequential__Reducer<TPMGL(T)>::_kwd__for(
  ::x10::lang::LongRange range, ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>* body) {
    ...
    TPMGL(T) res = (__extension__ ({
        ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* reduce__139957 =
          this->FMGL(reduce);
        TPMGL(T) identity__139958 = this->FMGL(identity);
        
        //#line 71 "x10/util/foreach/Sequential.x10"
        TPMGL(T) myRes__139960 = identity__139958;
        
        //#line 72 "x10/util/foreach/Sequential.x10"
        x10_long i__137243min__140023 = range->FMGL(min);
        x10_long i__137243max__140024 = range->FMGL(max);
        {
            x10_long i__140025;
            for (i__140025 = i__137243min__140023; ((i__140025) <= (i__137243max__140024));
                 i__140025 = ((i__140025) + (((x10_long)1ll))))
            {
                
                //#line 73 "x10/util/foreach/Sequential.x10"
                myRes__139960 = ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>::__apply(::x10aux::nullCheck(reduce__139957), 
                  myRes__139960, ::x10::lang::Fun_0_1<x10_long, TPMGL(T)>::__apply(::x10aux::nullCheck(body), 
                    i__140025));
            }
        }
        myRes__139960;
    ...
    this->FMGL(result) = (__extension__ ({
        ::x10::lang::Cell<TPMGL(T)>* alloc__137157 =  (new (::x10aux::alloc_z< ::x10::lang::Cell<TPMGL(T)> >()) ::x10::lang::Cell<TPMGL(T)>());
        
        //#line 33 "x10/lang/Cell.x10"
        alloc__137157->FMGL(value) = res;
        alloc__137157;
    }))
    ;
...
template<class TPMGL(T)> TPMGL(T) x10::util::foreach::Sequential__Reducer<TPMGL(T)>::_kwd__for(
  ::x10::array::DenseIterationSpace_2* space, ::x10::lang::Fun_0_2<x10_long, x10_long, TPMGL(T)>* body) {
    ...
    TPMGL(T) res = (__extension__ ({
        ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* reduce__139971 =
          this->FMGL(reduce);
        TPMGL(T) identity__139972 = this->FMGL(identity);
        
        //#line 88 "x10/util/foreach/Sequential.x10"
        TPMGL(T) myRes__139974 = identity__139972;
        
        //#line 89 "x10/util/foreach/Sequential.x10"
        x10_long j__137263min__140029 = ::x10aux::nullCheck(space)->x10::array::DenseIterationSpace_2::min(
                                          ((x10_long)1ll));
        x10_long j__137263max__140030 = ::x10aux::nullCheck(space)->x10::array::DenseIterationSpace_2::max(
                                          ((x10_long)1ll));
        x10_long i__137294min__140031 = ::x10aux::nullCheck(space)->x10::array::DenseIterationSpace_2::min(
                                          ((x10_long)0ll));
        x10_long i__137294max__140032 = ::x10aux::nullCheck(space)->x10::array::DenseIterationSpace_2::max(
                                          ((x10_long)0ll));
        {
            x10_long i__140033;
            for (i__140033 = i__137294min__140031; ((i__140033) <= (i__137294max__140032));
                 i__140033 = ((i__140033) + (((x10_long)1ll))))
            {
                {
                    x10_long j__140035;
                    for (j__140035 = j__137263min__140029;
                         ((j__140035) <= (j__137263max__140030));
                         j__140035 = ((j__140035) + (((x10_long)1ll))))
                    {
                        
                        //#line 90 "x10/util/foreach/Sequential.x10"
                        myRes__139974 = ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>::__apply(::x10aux::nullCheck(reduce__139971), 
                          myRes__139974, ::x10::lang::Fun_0_2<x10_long, x10_long, TPMGL(T)>::__apply(::x10aux::nullCheck(body), 
                            i__140033, j__140035));
                    }
                }
    ...
    this->FMGL(result) = (__extension__ ({
        ::x10::lang::Cell<TPMGL(T)>* alloc__137158 =  (new (::x10aux::alloc_z< ::x10::lang::Cell<TPMGL(T)> >()) ::x10::lang::Cell<TPMGL(T)>());
        
        //#line 33 "x10/lang/Cell.x10"
        alloc__137158->FMGL(value) = res;
        alloc__137158;
    }))
    ;
