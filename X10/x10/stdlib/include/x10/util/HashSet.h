...
template<class TPMGL(T)> void x10::util::HashSet<TPMGL(T)>::_constructor(
    ...
    (this)->::x10::util::MapSet<TPMGL(T)>::_constructor(reinterpret_cast< ::x10::util::Map<TPMGL(T), x10_boolean>*>((__extension__ ({
                                                            ::x10::util::HashMap<TPMGL(T), x10_boolean>* alloc__122578 =
                                                               (new (::x10aux::alloc_z< ::x10::util::HashMap<TPMGL(T), x10_boolean> >()) ::x10::util::HashMap<TPMGL(T), x10_boolean>());
                                                            (alloc__122578)->::x10::util::HashMap<TPMGL(T), x10_boolean>::_constructor();
                                                            alloc__122578;
                                                        }))
                                                        ));
...
template<class TPMGL(T)> void x10::util::HashSet<TPMGL(T)>::_constructor(
                           x10_int sz) {
    (this)->::x10::util::MapSet<TPMGL(T)>::_constructor(reinterpret_cast< ::x10::util::Map<TPMGL(T), x10_boolean>*>((__extension__ ({
                                                            ::x10::util::HashMap<TPMGL(T), x10_boolean>* alloc__122579 =
                                                              
                                                            (new (::x10aux::alloc_z< ::x10::util::HashMap<TPMGL(T), x10_boolean> >()) ::x10::util::HashMap<TPMGL(T), x10_boolean>());
                                                            (alloc__122579)->::x10::util::HashMap<TPMGL(T), x10_boolean>::_constructor(
                                                              ((x10_long)(sz)));
                                                            alloc__122579;
                                                        }))
                                                        ));
...
template<class TPMGL(T)> ::x10::util::Container<TPMGL(T)>*
  x10::util::HashSet<TPMGL(T)>::clone() {
    ...
    ::x10::util::HashMap<TPMGL(T), x10_boolean>* tmp =  (new (::x10aux::alloc_z< ::x10::util::HashMap<TPMGL(T), x10_boolean> >()) ::x10::util::HashMap<TPMGL(T), x10_boolean>());
    (tmp)->::x10::util::HashMap<TPMGL(T), x10_boolean>::_constructor(
      ::x10::util::Map<TPMGL(T), x10_boolean>::size(::x10aux::nullCheck(this->FMGL(map))));
    
    //#line 20 "x10/util/HashSet.x10"
    {
        ::x10::lang::Iterator< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>* e__122582;
        for (e__122582 = ::x10::util::Set< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>::iterator(::x10aux::nullCheck(::x10::util::Map<TPMGL(T), x10_boolean>::entries(::x10aux::nullCheck(this->FMGL(map)))));
             ::x10::lang::Iterator< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>::hasNext(::x10aux::nullCheck(e__122582));
             ) {
            ::x10::util::Map__Entry<TPMGL(T), x10_boolean>* e =
              ::x10::lang::Iterator< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>::next(::x10aux::nullCheck(e__122582));
    ...
    ::x10::util::HashSet<TPMGL(T)>* alloc__140124 =  (new (::x10aux::alloc_z< ::x10::util::HashSet<TPMGL(T)> >()) ::x10::util::HashSet<TPMGL(T)>());
    (alloc__140124)->::x10::util::HashSet<TPMGL(T)>::_constructor(
      tmp);
    return reinterpret_cast< ::x10::util::Container<TPMGL(T)>*>(alloc__140124);
