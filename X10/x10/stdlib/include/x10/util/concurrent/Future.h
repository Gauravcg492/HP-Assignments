...
template<class TPMGL(T)> TPMGL(T) x10::util::concurrent::Future<TPMGL(T)>::forceLocal(
    ...
    if ((((__extension__ ({
            ::x10::util::GrowableRail< ::x10::lang::Exception*>* this__136551 =
              this->FMGL(exception);
            this__136551->FMGL(size);
        }))
        ) > (((x10_long)0ll)))) {
    ...
    try {
        {
            ...
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__136565 = ::x10::xrx::Runtime::startFinish();
            try {
                {
            ...
            catch (::x10::lang::CheckedThrowable* __exc2142) {
                {
                    ::x10::lang::CheckedThrowable* ct__136563 =
                      __exc2142;
                    {
            ...
            ::x10::xrx::Runtime::stopFinish(fs__136565);
        }
        
        //#line 75 "x10/util/concurrent/Future.x10"
        this->FMGL(latch)->release();
    }
    catch (::x10::lang::CheckedThrowable* __exc2143) {
        if (::x10aux::instanceof< ::x10::lang::Exception*>(__exc2143)) {
            ::x10::lang::Exception* t = static_cast< ::x10::lang::Exception*>(__exc2143);
            {
...
template<class TPMGL(T)> void x10::util::concurrent::Future<TPMGL(T)>::__fieldInitializers_x10_util_concurrent_Future(
    ...
    this->FMGL(exception) = (__extension__ ({
        ...
        //#line 38 "x10/util/concurrent/Future.x10"
        ::x10::util::GrowableRail< ::x10::lang::Exception*>* alloc__136506 =
        ...
        (alloc__136506)->::x10::util::GrowableRail< ::x10::lang::Exception*>::_constructor(
          ((x10_long)0ll));
        alloc__136506;
    }))
    ;
    this->FMGL(result) = (__extension__ ({
        ...
        //#line 39 "x10/util/concurrent/Future.x10"
        ::x10::util::GrowableRail<TPMGL(T)>* alloc__136507 =
           (new (::x10aux::alloc_z< ::x10::util::GrowableRail<TPMGL(T)> >()) ::x10::util::GrowableRail<TPMGL(T)>());
        
        //#line 50 "x10/util/GrowableRail.x10"
        (alloc__136507)->::x10::util::GrowableRail<TPMGL(T)>::_constructor(
          ((x10_long)0ll));
        alloc__136507;
    }))
    ;
