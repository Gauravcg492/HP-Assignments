...
template<class TPMGL(Key), class TPMGL(Value)> class x10_util_HashMap__KeySet__closure__1 : public ::x10::lang::Closure {
    ...
    TPMGL(Key) __apply(::x10::util::Map__Entry<TPMGL(Key), TPMGL(Value)>* e__140107){
        
        //#line 270 "x10/util/HashMap.x10"
        return ::x10::util::Map__Entry<TPMGL(Key), TPMGL(Value)>::getKey(::x10aux::nullCheck(e__140107));
...
template<class TPMGL(Key), class TPMGL(Value)> ::x10::lang::Iterator<TPMGL(Key)>*
  x10::util::HashMap__KeySet<TPMGL(Key), TPMGL(Value)>::iterator(
    ...
    //#line 270 "x10/util/HashMap.x10"
    ::x10::util::MapIterator< ::x10::util::Map__Entry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)>* alloc__140109 =
    ...
    ::x10::lang::Iterator< ::x10::util::Map__Entry<TPMGL(Key), TPMGL(Value)>*>* i__140108 =
      ::x10aux::nullCheck(this->FMGL(map))->entriesIterator();
    
    //#line 19 "x10/util/MapIterator.x10"
    alloc__140109->FMGL(i) = i__140108;
    
    //#line 20 "x10/util/MapIterator.x10"
    alloc__140109->FMGL(f) = reinterpret_cast< ::x10::lang::Fun_0_1< ::x10::util::Map__Entry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)>*>((new (::x10aux::alloc< ::x10::lang::Fun_0_1< ::x10::util::Map__Entry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)> >(sizeof(x10_util_HashMap__KeySet__closure__1<TPMGL(Key),TPMGL(Value)>)))x10_util_HashMap__KeySet__closure__1<TPMGL(Key),TPMGL(Value)>()));
    
    //#line 270 "x10/util/HashMap.x10"
    return reinterpret_cast< ::x10::lang::Iterator<TPMGL(Key)>*>(alloc__140109);
