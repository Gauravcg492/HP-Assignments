...
template<class TPMGL(T)> void x10::util::RailBuilder<TPMGL(T)>::_constructor(
    ...
    this->FMGL(buf) = (__extension__ ({
        ::x10::util::GrowableRail<TPMGL(T)>* alloc__142894 =  (new (::x10aux::alloc_z< ::x10::util::GrowableRail<TPMGL(T)> >()) ::x10::util::GrowableRail<TPMGL(T)>());
        
        //#line 50 "x10/util/GrowableRail.x10"
        (alloc__142894)->::x10::util::GrowableRail<TPMGL(T)>::_constructor(
          ((x10_long)0ll));
        alloc__142894;
    }))
    ;
...
template<class TPMGL(T)> void x10::util::RailBuilder<TPMGL(T)>::_constructor(
    ...
    this->FMGL(buf) = (__extension__ ({
        ::x10::util::GrowableRail<TPMGL(T)>* alloc__142895 =  (new (::x10aux::alloc_z< ::x10::util::GrowableRail<TPMGL(T)> >()) ::x10::util::GrowableRail<TPMGL(T)>());
        (alloc__142895)->::x10::util::GrowableRail<TPMGL(T)>::_constructor(
          size);
        alloc__142895;
    }))
    ;
...
template<class TPMGL(T)> x10_long x10::util::RailBuilder<TPMGL(T)>::length(
    ...
    ::x10::util::GrowableRail<TPMGL(T)>* this__144395 = this->FMGL(buf);
    return ::x10aux::nullCheck(this__144395)->FMGL(size);
