...
template<class TPMGL(T)> class x10_util_WorkerLocalHandle__closure__1 : public ::x10::lang::Closure {
    ...
    ::x10::util::WorkerLocalHandle__State<TPMGL(T)>* __apply(){
        ::x10::util::WorkerLocalHandle__State<TPMGL(T)>* alloc__154263 = 
        (new (::x10aux::alloc_z< ::x10::util::WorkerLocalHandle__State<TPMGL(T)> >()) ::x10::util::WorkerLocalHandle__State<TPMGL(T)>());
        (alloc__154263)->::x10::util::WorkerLocalHandle__State<TPMGL(T)>::_constructor(
          init);
        return alloc__154263;
...
template<class TPMGL(T)> class x10_util_WorkerLocalHandle__closure__2 : public ::x10::lang::Closure {
    ...
    static x10::lang::Reference* _deserialize(::x10aux::deserialization_buffer &buf) {
        ...
        TPMGL(T) that_t__154264 = buf.read<TPMGL(T)>();
        x10_util_WorkerLocalHandle__closure__2<TPMGL(T) >* this_ = new (storage) x10_util_WorkerLocalHandle__closure__2<TPMGL(T) >(that_op, that_t__154264);
        return this_;
    }
    
    x10_util_WorkerLocalHandle__closure__2(::x10::lang::VoidFun_0_1<TPMGL(T)>* op, TPMGL(T) t__154264) : op(op), t__154264(t__154264) { }
...
template<class TPMGL(T)> void x10::util::WorkerLocalHandle<TPMGL(T)>::applyLocal(
  ::x10::lang::VoidFun_0_1<TPMGL(T)>* op) {
    ...
    ::x10::lang::Rail< TPMGL(T) >* localStore = ::x10aux::nullCheck(this->FMGL(state)->x10::lang::template PlaceLocalHandle< ::x10::util::WorkerLocalHandle__State<TPMGL(T)>*>::__apply())->FMGL(store);
    {
        ...
        ::x10::xrx::FinishState* fs__154279 = ::x10::xrx::Runtime::startFinish();
        try {
            {
                x10_long i__154198max__154265 = (((x10_long)(::x10aux::nullCheck(localStore)->FMGL(size))) - (((x10_long)1ll)));
                {
                    x10_long i__154266;
                    for (i__154266 = ((x10_long)0ll); ((i__154266) <= (i__154198max__154265));
                         i__154266 = ((i__154266) + (((x10_long)1ll))))
                    {
                        
                        //#line 72 "x10/util/WorkerLocalHandle.x10"
                        TPMGL(T) t__154264 = ::x10aux::nullCheck(localStore)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                               i__154266);
                        
                        //#line 73 "x10/util/WorkerLocalHandle.x10"
                        if ((!::x10aux::struct_equals(t__154264,
                                                      reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
                        {
                            
                            //#line 74 "x10/util/WorkerLocalHandle.x10"
                            ::x10::xrx::Runtime::runAsync(
                              reinterpret_cast< ::x10::lang::VoidFun_0_0*>((new (::x10aux::alloc< ::x10::lang::VoidFun_0_0>(sizeof(x10_util_WorkerLocalHandle__closure__2<TPMGL(T)>)))x10_util_WorkerLocalHandle__closure__2<TPMGL(T)>(op, t__154264))));
                        }
        ...
        catch (::x10::lang::CheckedThrowable* __exc3094) {
            {
                ::x10::lang::CheckedThrowable* ct__154277 =
                  __exc3094;
                {
                    ::x10::xrx::Runtime::pushException(ct__154277);
                }
            }
        }
        ::x10::xrx::Runtime::stopFinish(fs__154279);
    }
...
template<class TPMGL(T)> TPMGL(T) x10::util::WorkerLocalHandle<TPMGL(T)>::reduceLocal(
  ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* op) {
    ...
    x10_long i__154216max__154269 = (((x10_long)(::x10aux::nullCheck(localStore)->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__154270;
        for (i__154270 = ((x10_long)0ll); ((i__154270) <= (i__154216max__154269));
             i__154270 = ((i__154270) + (((x10_long)1ll))))
        {
            
            //#line 89 "x10/util/WorkerLocalHandle.x10"
            TPMGL(T) t__154268 = ::x10aux::nullCheck(localStore)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                   i__154270);
            
            //#line 90 "x10/util/WorkerLocalHandle.x10"
            if ((!::x10aux::struct_equals(t__154268, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
            {
...
template<class TPMGL(T)> TPMGL(T) x10::util::WorkerLocalHandle<TPMGL(T)>::reduceLocal(
  TPMGL(T) result, ::x10::lang::Fun_0_2<TPMGL(T), TPMGL(T), TPMGL(T)>* op) {
    ...
    x10_long i__154234max__154273 = (((x10_long)(::x10aux::nullCheck(localStore)->FMGL(size))) - (((x10_long)1ll)));
    {
        x10_long i__154274;
        for (i__154274 = ((x10_long)0ll); ((i__154274) <= (i__154234max__154273));
             i__154274 = ((i__154274) + (((x10_long)1ll))))
        {
            
            //#line 111 "x10/util/WorkerLocalHandle.x10"
            TPMGL(T) t__154272 = ::x10aux::nullCheck(localStore)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                   i__154274);
            
            //#line 112 "x10/util/WorkerLocalHandle.x10"
            if ((!::x10aux::struct_equals(t__154272, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
            {
