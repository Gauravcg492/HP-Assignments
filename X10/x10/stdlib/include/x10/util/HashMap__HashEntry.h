...
template<class TPMGL(Key), class TPMGL(Value)> void x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>::_constructor(
    ...
    ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>* this__140098 =
      this;
    ::x10aux::nullCheck(this__140098)->FMGL(value) = ::x10aux::zeroValue< TPMGL(Value) >();
    ::x10aux::nullCheck(this__140098)->FMGL(removed) = false;
