...
template<class TPMGL(S)> void x10::util::ArrayList__It<TPMGL(S)>::_constructor(
    ...
    ::x10::util::ArrayList__It<TPMGL(S)>* this__136444 = this;
    
    //#line 188 "x10/util/ArrayList.x10"
    ::x10aux::nullCheck(this__136444)->FMGL(i) = ((x10_long)0ll);
    
    //#line 198 "x10/util/ArrayList.x10"
    ::x10aux::nullCheck(this__136444)->FMGL(al) = al;
    
    //#line 199 "x10/util/ArrayList.x10"
    ::x10aux::nullCheck(this__136444)->FMGL(i) = ((x10_long)-1ll);
}
...
template<class TPMGL(S)> void x10::util::ArrayList__It<TPMGL(S)>::_constructor(
    ...
    //#line 188 "x10/util/ArrayList.x10"
    ::x10::util::ArrayList__It<TPMGL(S)>* this__136446 = this;
    ::x10aux::nullCheck(this__136446)->FMGL(i) = ((x10_long)0ll);
