...
class HashMap_Strings {
  public:
    static ::x10::lang::String sl__168931;
    static ::x10::lang::String sl__168932;
};
...
template<class TPMGL(K), class TPMGL(V)> void x10::util::HashMap<TPMGL(K), TPMGL(V)>::_constructor(
    ...
    ::x10::util::HashMap<TPMGL(K), TPMGL(V)>* this__140099 = this;
    ::x10aux::nullCheck(this__140099)->FMGL(table) = (::x10aux::class_cast_unchecked< ::x10::lang::Rail< ::x10::util::HashMap__HashEntry<TPMGL(K), TPMGL(V)>* >*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__140099)->FMGL(size) = ((x10_long)0ll);
    ::x10aux::nullCheck(this__140099)->FMGL(occupation) = ((x10_long)0ll);
    ::x10aux::nullCheck(this__140099)->FMGL(mask) = ((x10_long)0ll);
    ::x10aux::nullCheck(this__140099)->FMGL(modCount) = ((x10_long)0ll);
...
template<class TPMGL(K), class TPMGL(V)> void x10::util::HashMap<TPMGL(K), TPMGL(V)>::_constructor(
    ...
    //#line 19 "x10/util/HashMap.x10"
    ::x10::util::HashMap<TPMGL(K), TPMGL(V)>* this__140100 =
      this;
    ::x10aux::nullCheck(this__140100)->FMGL(table) = (::x10aux::class_cast_unchecked< ::x10::lang::Rail< ::x10::util::HashMap__HashEntry<TPMGL(K), TPMGL(V)>* >*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__140100)->FMGL(size) = ((x10_long)0ll);
    ::x10aux::nullCheck(this__140100)->FMGL(occupation) =
      ((x10_long)0ll);
    ::x10aux::nullCheck(this__140100)->FMGL(mask) = ((x10_long)0ll);
    ::x10aux::nullCheck(this__140100)->FMGL(modCount) = ((x10_long)0ll);
    
    //#line 60 "x10/util/HashMap.x10"
    if (((sz) > (((x10_long)1152921504606846976ll)))) {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::OutOfMemoryError::_make(::x10::lang::String::__plus((&::x10::util::HashMap_Strings::sl__168931), sz))));
    }
...
template<class TPMGL(K), class TPMGL(V)> TPMGL(V) x10::util::HashMap<TPMGL(K), TPMGL(V)>::getOrThrow(
  TPMGL(K) k) {
    ...
    if (((::x10aux::struct_equals(e, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))) ||
        ::x10aux::nullCheck(e)->FMGL(removed))) {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::util::NoSuchElementException::_make(::x10::lang::String::__plus((&::x10::util::HashMap_Strings::sl__168932), k))));
    }
...
template<class TPMGL(K), class TPMGL(V)> TPMGL(V) x10::util::HashMap<TPMGL(K), TPMGL(V)>::putInternal(
  TPMGL(K) k, TPMGL(V) v, x10_boolean mayRehash) {
    ...
    x10_int h = ((::x10aux::hash_code(k)) * (((x10_int)17)));
    ...
    while (true) {
        ...
        if ((::x10aux::struct_equals(e, reinterpret_cast< ::x10::lang::NullType*>(X10_NULL))))
        {
            ...
            ::x10aux::nullCheck(this->FMGL(table))->x10::lang::template Rail< ::x10::util::HashMap__HashEntry<TPMGL(K), TPMGL(V)>* >::__set(
              j, (__extension__ ({
                  ::x10::util::HashMap__HashEntry<TPMGL(K), TPMGL(V)>* alloc__120526 =
                     (new (::x10aux::alloc_z< ::x10::util::HashMap__HashEntry<TPMGL(K), TPMGL(V)> >()) ::x10::util::HashMap__HashEntry<TPMGL(K), TPMGL(V)>());
                  (alloc__120526)->::x10::util::HashMap__HashEntry<TPMGL(K), TPMGL(V)>::_constructor(
                    k, v, h);
                  alloc__120526;
              }))
              );
...
template<class TPMGL(K), class TPMGL(V)> ::x10::util::Set<TPMGL(K)>*
  x10::util::HashMap<TPMGL(K), TPMGL(V)>::keySet() {
    ::x10::util::HashMap__KeySet<TPMGL(K), TPMGL(V)>* alloc__140103 =
       (new (::x10aux::alloc_z< ::x10::util::HashMap__KeySet<TPMGL(K), TPMGL(V)> >()) ::x10::util::HashMap__KeySet<TPMGL(K), TPMGL(V)>());
    (alloc__140103)->::x10::util::HashMap__KeySet<TPMGL(K), TPMGL(V)>::_constructor(
      this);
    return reinterpret_cast< ::x10::util::Set<TPMGL(K)>*>(alloc__140103);
...
template<class TPMGL(K), class TPMGL(V)> ::x10::util::Set< ::x10::util::Map__Entry<TPMGL(K), TPMGL(V)>*>*
  x10::util::HashMap<TPMGL(K), TPMGL(V)>::entries() {
    ::x10::util::HashMap__EntrySet<TPMGL(K), TPMGL(V)>* alloc__140104 =
       (new (::x10aux::alloc_z< ::x10::util::HashMap__EntrySet<TPMGL(K), TPMGL(V)> >()) ::x10::util::HashMap__EntrySet<TPMGL(K), TPMGL(V)>());
    (alloc__140104)->::x10::util::HashMap__EntrySet<TPMGL(K), TPMGL(V)>::_constructor(
      this);
    return reinterpret_cast< ::x10::util::Set< ::x10::util::Map__Entry<TPMGL(K), TPMGL(V)>*>*>(alloc__140104);
...
template<class TPMGL(K), class TPMGL(V)> void x10::util::HashMap<TPMGL(K), TPMGL(V)>::_constructor(
    ...
    {
        x10_long i__140114;
        for (i__140114 = ((x10_long)1ll); ((i__140114) <= (numEntries));
             i__140114 = ((i__140114) + (((x10_long)1ll))))
        {
            
            //#line 308 "x10/util/HashMap.x10"
            TPMGL(K) key__140111 = ::x10aux::class_cast<TPMGL(K)>(::x10aux::nullCheck(ds)->x10::io::Deserializer::readAny());
            
            //#line 309 "x10/util/HashMap.x10"
            TPMGL(V) value__140112 = ::x10aux::class_cast<TPMGL(V)>(::x10aux::nullCheck(ds)->x10::io::Deserializer::readAny());
            
            //#line 310 "x10/util/HashMap.x10"
            this->x10::util::template HashMap<TPMGL(K), TPMGL(V)>::putInternal(
              key__140111, value__140112, true);
        }
    }
