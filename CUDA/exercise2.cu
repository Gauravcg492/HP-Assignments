                        ...
                        const int fw)
{
  ...
  septc<<<gridSize, blockSize>>>(diprgb,
                                            nr,
                                            nc,
                                            dr,
                                            dg,
  ...
  blur_g<<<gridSize, blockSize>>>(dr,
                                         d_r_b,
                                         nr,
                                         nc,
                                         dfilter,
                                         fw);
  blur_g<<<gridSize, blockSize>>>(dg,
                                         d_g_b,
                                         nr,
                                         nc,
                                         dfilter,
                                         fw);
  blur_g<<<gridSize, blockSize>>>(db,
                                         d_b_b,
                                         nr,
                                         nc,
                                         dfilter,
  ...
  chanrecomb<<<gridSize, blockSize>>>(d_r_b,
                                             d_g_b,
                                             d_b_b,
                                             doprgb,
                                             nr,
